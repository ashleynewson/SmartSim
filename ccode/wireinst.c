...
static void _vala_array_add87 (Path*** array, int* length, int* size, Path* value);
...
static void _vala_array_add88 (WireInstRegisteredComponent** array, int* length, int* size, const WireInstRegisteredComponent* value);
...
static void _vala_array_add91 (Path*** array, int* length, int* size, Path* value);
static void _vala_array_add92 (WireInstMarker** array, int* length, int* size, const WireInstMarker* value);
...
static void _vala_array_add94 (WireInstMarker** array, int* length, int* size, const WireInstMarker* value);
static void _vala_array_add95 (WireInst*** array, int* length, int* size, WireInst* value);
...
static void _vala_array_add98 (WireInstMarker** array, int* length, int* size, const WireInstMarker* value);
...
void wire_inst_import_path (WireInst* self, Path* path) {
	...
	_vala_array_add87 (&newPaths, &newPaths_length1, &_newPaths_size_, _tmp4_);
	_tmp5_ = newPaths;
...
void wire_inst_register_component (WireInst* self, ComponentInst* newComponentInst, gint x, gint y) {
	...
	_vala_array_add88 (&newRegisteredComponents, &newRegisteredComponents_length1, &_newRegisteredComponents_size_, &_tmp28_);
		...
		for (registeredComponent_it = 0; registeredComponent_it < _tmp1__length1; registeredComponent_it = registeredComponent_it + 1) {
			...
			registeredComponent = registeredComponent_collection[registeredComponent_it];
			{
				...
				if (_tmp3_ != _tmp4_) {
					...
					_vala_array_add89 (&newRegisteredComponents, &newRegisteredComponents_length1, &_newRegisteredComponents_size_, &_tmp6_);
				}
			}
		}
	}
		...
		for (registeredComponent_it = 0; registeredComponent_it < _tmp1__length1; registeredComponent_it = registeredComponent_it + 1) {
			...
			registeredComponent = registeredComponent_collection[registeredComponent_it];
			{
				...
				if (_tmp16_) {
					...
					_vala_array_add90 (&newRegisteredComponents, &newRegisteredComponents_length1, &_newRegisteredComponents_size_, &_tmp18_);
				}
			}
		}
	}
		...
		for (path_it = 0; path_it < _tmp7__length1; path_it = path_it + 1) {
			...
			path = _tmp8_;
			{
				...
				if (!_tmp10_) {
					...
					_vala_array_add91 (&newPaths, &newPaths_length1, &_newPaths_size_, _tmp13_);
				} else {
					FILE* _tmp14_;
					_tmp14_ = stdout;
	...
	_tmp16__length1 = _tmp15_->markers_length1;
	{
		...
		for (marker_it = 0; marker_it < _tmp16__length1; marker_it = marker_it + 1) {
			...
			marker = marker_collection[marker_it];
			{
				...
				_tmp18_ = marker;
				_vala_array_add92 (&newMarkers, &newMarkers_length1, &_newMarkers_size_, &_tmp18_);
			}
		}
	}
	...
	_tmp20__length1 = _tmp19_->registeredComponents_length1;
	{
		...
		for (registeredComponent_it = 0; registeredComponent_it < _tmp20__length1; registeredComponent_it = registeredComponent_it + 1) {
			...
			registeredComponent = registeredComponent_collection[registeredComponent_it];
			{
				...
				_vala_array_add93 (&newRegisteredComponents, &newRegisteredComponents_length1, &_newRegisteredComponents_size_, &_tmp25_);
			}
		}
	}
	_tmp26_ = newPaths;
		...
		for (marker_it = 0; marker_it < _tmp3__length1; marker_it = marker_it + 1) {
			...
			marker = marker_collection[marker_it];
			{
				...
				if (_tmp11_) {
					...
					_tmp14_ = marker;
					_vala_array_add94 (&availableMarkers, &availableMarkers_length1, &_availableMarkers_size_, &_tmp14_);
				}
			}
		}
	}
		...
		for (path_it = 0; path_it < _tmp19__length1; path_it = path_it + 1) {
			...
			path = _tmp20_;
			{
				...
				if (_tmp26_ != 0) {
					...
					_vala_array_add95 (&wireInsts, &wireInsts_length1, &_wireInsts_size_, _tmp32_);
					...
					_vala_array_add96 (&availablePaths, &availablePaths_length1, &_availablePaths_size_, _tmp35_);
				}
				_path_unref0 (path);
			}
		}
						...
						for (marker_it = 0; marker_it < _tmp40__length1; marker_it = marker_it + 1) {
							...
							marker = marker_collection[marker_it];
							{
								...
								if (_tmp48_) {
										...
										for (path_it = 0; path_it < _tmp50__length1; path_it = path_it + 1) {
											...
											path = _tmp51_;
											{
												...
												if (_tmp57_ != 0) {
													...
													_vala_array_add97 (&newAvailablePaths, &newAvailablePaths_length1, &_newAvailablePaths_size_, _tmp62_);
												}
												_path_unref0 (path);
											}
										}
									...
									_tmp71_ = marker;
									_vala_array_add98 (&newAvailableMarkers, &newAvailableMarkers_length1, &_newAvailableMarkers_size_, &_tmp71_);
								}
							}
						}
					}
...
void wire_inst_mark (WireInst* self, gint x, gint y) {
	...
	_tmp5_ = marker;
	_vala_array_add99 (&newMarkers, &newMarkers_length1, &_newMarkers_size_, &_tmp5_);
	_tmp6_ = newMarkers;
