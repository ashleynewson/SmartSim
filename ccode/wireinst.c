/* wireinst.c generated by valac 0.16.0, the Vala compiler
...
static Path** _vala_array_dup18 (Path** self, int length);
static void _vala_array_add44 (Path*** array, int* length, int* size, Path* value);
static Path** _vala_array_dup19 (Path** self, int length);
void wire_inst_register_component (WireInst* self, ComponentInst* newComponentInst, gint x, gint y);
static WireInstRegisteredComponent* _vala_array_dup20 (WireInstRegisteredComponent* self, int length);
gint path_find (Path* self, gint x, gint y);
static void _vala_array_add45 (WireInstRegisteredComponent** array, int* length, int* size, const WireInstRegisteredComponent* value);
static WireInstRegisteredComponent* _vala_array_dup21 (WireInstRegisteredComponent* self, int length);
void wire_inst_unregister_component (WireInst* self, ComponentInst* oldComponentInst);
static void _vala_array_add46 (WireInstRegisteredComponent** array, int* length, int* size, const WireInstRegisteredComponent* value);
static WireInstRegisteredComponent* _vala_array_dup22 (WireInstRegisteredComponent* self, int length);
void wire_inst_unregister_component_xy (WireInst* self, ComponentInst* oldComponentInst, gint x, gint y);
static void _vala_array_add47 (WireInstRegisteredComponent** array, int* length, int* size, const WireInstRegisteredComponent* value);
static WireInstRegisteredComponent* _vala_array_dup23 (WireInstRegisteredComponent* self, int length);
...
static Path** _vala_array_dup24 (Path** self, int length);
static WireInstMarker* _vala_array_dup25 (WireInstMarker* self, int length);
static WireInstRegisteredComponent* _vala_array_dup26 (WireInstRegisteredComponent* self, int length);
gboolean wire_inst_try_merge_paths (WireInst* self, Path* checkPath);
static void _vala_array_add48 (Path*** array, int* length, int* size, Path* value);
static void _vala_array_add49 (WireInstMarker** array, int* length, int* size, const WireInstMarker* value);
void component_inst_change_wire (ComponentInst* self, WireInst* replaceWhat, WireInst* replaceWith);
static void _vala_array_add50 (WireInstRegisteredComponent** array, int* length, int* size, const WireInstRegisteredComponent* value);
static Path** _vala_array_dup27 (Path** self, int length);
static WireInstMarker* _vala_array_dup28 (WireInstMarker* self, int length);
static WireInstRegisteredComponent* _vala_array_dup29 (WireInstRegisteredComponent* self, int length);
WireInst** wire_inst_unmerge (WireInst* self, gint x, gint y, int* result_length1);
static void _vala_array_add51 (WireInstMarker** array, int* length, int* size, const WireInstMarker* value);
static void _vala_array_add52 (WireInst*** array, int* length, int* size, WireInst* value);
static void _vala_array_add53 (Path*** array, int* length, int* size, Path* value);
Path* wire_inst_find (WireInst* self, gint x, gint y);
static void _vala_array_add54 (Path*** array, int* length, int* size, Path* value);
static Path** _vala_array_dup30 (Path** self, int length);
static void _vala_array_add55 (WireInstMarker** array, int* length, int* size, const WireInstMarker* value);
static WireInstMarker* _vala_array_dup31 (WireInstMarker* self, int length);
gboolean component_inst_try_connect (ComponentInst* self, gint x, gint y, WireInst* wireInst);
static WireInstMarker* _vala_array_dup32 (WireInstMarker* self, int length);
static void _vala_array_add56 (WireInstMarker** array, int* length, int* size, const WireInstMarker* value);
static WireInstMarker* _vala_array_dup33 (WireInstMarker* self, int length);
...
void wire_inst_import_path (WireInst* self, Path* path) {
	...
	_vala_array_add44 (&newPaths, &newPaths_length1, &_newPaths_size_, _tmp4_);
	_tmp5_ = newPaths;
	_tmp5__length1 = newPaths_length1;
	_tmp6_ = (_tmp5_ != NULL) ? _vala_array_dup19 (_tmp5_, _tmp5__length1) : ((gpointer) _tmp5_);
...
void wire_inst_register_component (WireInst* self, ComponentInst* newComponentInst, gint x, gint y) {
	...
	_tmp15_ = (_tmp14_ != NULL) ? _vala_array_dup20 (_tmp14_, _tmp14__length1) : ((gpointer) _tmp14_);
	...
	_vala_array_add45 (&newRegisteredComponents, &newRegisteredComponents_length1, &_newRegisteredComponents_size_, &_tmp28_);
	_tmp29_ = newRegisteredComponents;
	_tmp29__length1 = newRegisteredComponents_length1;
	_tmp30_ = (_tmp29_ != NULL) ? _vala_array_dup21 (_tmp29_, _tmp29__length1) : ((gpointer) _tmp29_);
...
void wire_inst_unregister_component (WireInst* self, ComponentInst* oldComponentInst) {
		...
		for (registeredComponent_it = 0; registeredComponent_it < _tmp1__length1; registeredComponent_it = registeredComponent_it + 1) {
			...
			registeredComponent = registeredComponent_collection[registeredComponent_it];
			{
				...
				if (_tmp3_ != _tmp4_) {
					...
					_vala_array_add46 (&newRegisteredComponents, &newRegisteredComponents_length1, &_newRegisteredComponents_size_, &_tmp6_);
				}
			}
		}
	}
	...
	_tmp8_ = (_tmp7_ != NULL) ? _vala_array_dup22 (_tmp7_, _tmp7__length1) : ((gpointer) _tmp7_);
...
void wire_inst_unregister_component_xy (WireInst* self, ComponentInst* oldComponentInst, gint x, gint y) {
		...
		for (registeredComponent_it = 0; registeredComponent_it < _tmp1__length1; registeredComponent_it = registeredComponent_it + 1) {
			...
			registeredComponent = registeredComponent_collection[registeredComponent_it];
			{
				...
				if (_tmp16_) {
					...
					_vala_array_add47 (&newRegisteredComponents, &newRegisteredComponents_length1, &_newRegisteredComponents_size_, &_tmp18_);
				}
			}
		}
	}
	...
	_tmp20_ = (_tmp19_ != NULL) ? _vala_array_dup23 (_tmp19_, _tmp19__length1) : ((gpointer) _tmp19_);
...
void wire_inst_merge (WireInst* self, WireInst* sourceWireInst) {
	...
	_tmp0_ = self->paths;
	_tmp0__length1 = self->paths_length1;
	_tmp1_ = (_tmp0_ != NULL) ? _vala_array_dup24 (_tmp0_, _tmp0__length1) : ((gpointer) _tmp0_);
	_tmp1__length1 = _tmp0__length1;
	newPaths = _tmp1_;
	newPaths_length1 = _tmp1__length1;
	_newPaths_size_ = newPaths_length1;
	...
	_tmp3_ = (_tmp2_ != NULL) ? _vala_array_dup25 (_tmp2_, _tmp2__length1) : ((gpointer) _tmp2_);
	...
	_tmp5_ = (_tmp4_ != NULL) ? _vala_array_dup26 (_tmp4_, _tmp4__length1) : ((gpointer) _tmp4_);
		...
		for (path_it = 0; path_it < _tmp7__length1; path_it = path_it + 1) {
			...
			path = _tmp8_;
			{
				...
				if (!_tmp10_) {
					...
					_vala_array_add48 (&newPaths, &newPaths_length1, &_newPaths_size_, _tmp13_);
				} else {
					FILE* _tmp14_;
					_tmp14_ = stdout;
	...
	_tmp16__length1 = _tmp15_->markers_length1;
	{
		...
		for (marker_it = 0; marker_it < _tmp16__length1; marker_it = marker_it + 1) {
			...
			marker = marker_collection[marker_it];
			{
				...
				_tmp18_ = marker;
				_vala_array_add49 (&newMarkers, &newMarkers_length1, &_newMarkers_size_, &_tmp18_);
			}
		}
	}
	...
	_tmp20__length1 = _tmp19_->registeredComponents_length1;
	{
		...
		for (registeredComponent_it = 0; registeredComponent_it < _tmp20__length1; registeredComponent_it = registeredComponent_it + 1) {
			...
			registeredComponent = registeredComponent_collection[registeredComponent_it];
			{
				...
				_vala_array_add50 (&newRegisteredComponents, &newRegisteredComponents_length1, &_newRegisteredComponents_size_, &_tmp25_);
			}
		}
	}
	_tmp26_ = newPaths;
	_tmp26__length1 = newPaths_length1;
	_tmp27_ = (_tmp26_ != NULL) ? _vala_array_dup27 (_tmp26_, _tmp26__length1) : ((gpointer) _tmp26_);
	...
	_tmp29_ = (_tmp28_ != NULL) ? _vala_array_dup28 (_tmp28_, _tmp28__length1) : ((gpointer) _tmp28_);
	...
	_tmp31_ = (_tmp30_ != NULL) ? _vala_array_dup29 (_tmp30_, _tmp30__length1) : ((gpointer) _tmp30_);
		...
		for (marker_it = 0; marker_it < _tmp3__length1; marker_it = marker_it + 1) {
			...
			marker = marker_collection[marker_it];
			{
				...
				if (_tmp11_) {
					...
					_tmp14_ = marker;
					_vala_array_add51 (&availableMarkers, &availableMarkers_length1, &_availableMarkers_size_, &_tmp14_);
				}
			}
		}
	}
		...
		for (path_it = 0; path_it < _tmp19__length1; path_it = path_it + 1) {
			...
			path = _tmp20_;
			{
				...
				if (_tmp26_ != 0) {
					...
					_vala_array_add52 (&wireInsts, &wireInsts_length1, &_wireInsts_size_, _tmp32_);
					...
					_vala_array_add53 (&availablePaths, &availablePaths_length1, &_availablePaths_size_, _tmp35_);
				}
				_path_unref0 (path);
			}
		}
		...
		_tmp37__length1 = wireInsts_length1;
		{
			...
			for (wireInst_it = 0; wireInst_it < _tmp37__length1; wireInst_it = wireInst_it + 1) {
				...
				wireInst = _tmp38_;
				{
						...
						for (marker_it = 0; marker_it < _tmp40__length1; marker_it = marker_it + 1) {
							...
							marker = marker_collection[marker_it];
							{
								...
								if (_tmp48_) {
										...
										for (path_it = 0; path_it < _tmp50__length1; path_it = path_it + 1) {
											...
											path = _tmp51_;
											{
												...
												if (_tmp57_ != 0) {
													...
													_vala_array_add54 (&newAvailablePaths, &newAvailablePaths_length1, &_newAvailablePaths_size_, _tmp62_);
												}
												_path_unref0 (path);
											}
										}
									...
									_tmp69_ = (_tmp68_ != NULL) ? _vala_array_dup30 (_tmp68_, _tmp68__length1) : ((gpointer) _tmp68_);
									...
									_tmp71_ = marker;
									_vala_array_add55 (&newAvailableMarkers, &newAvailableMarkers_length1, &_newAvailableMarkers_size_, &_tmp71_);
								}
							}
						}
					}
					...
					_tmp73_ = (_tmp72_ != NULL) ? _vala_array_dup31 (_tmp72_, _tmp72__length1) : ((gpointer) _tmp72_);
...
void wire_inst_mark (WireInst* self, gint x, gint y) {
	...
	_tmp5_ = marker;
	_vala_array_add56 (&newMarkers, &newMarkers_length1, &_newMarkers_size_, &_tmp5_);
	_tmp6_ = newMarkers;
	_tmp6__length1 = newMarkers_length1;
	_tmp7_ = (_tmp6_ != NULL) ? _vala_array_dup33 (_tmp6_, _tmp6__length1) : ((gpointer) _tmp6_);
