...
static void _vala_array_add81 (GtkBox*** array, int* length, int* size, GtkBox* value);
static void _vala_array_add82 (GtkLabel*** array, int* length, int* size, GtkLabel* value);
static void _vala_array_add83 (GtkLabel*** array, int* length, int* size, GtkLabel* value);
GtkWidget* property_item_create_widget (PropertyItem* self);
static void _vala_array_add84 (GtkWidget*** array, int* length, int* size, GtkWidget* value);
	...
	gtk_box_pack_start (_tmp23_, (GtkWidget*) _tmp24_, FALSE, TRUE, (guint) 1);
	{
		...
		i = 0;
		{
			...
			while (TRUE) {
				...
				_vala_array_add81 (&self->priv->propertyVBoxes, &self->priv->propertyVBoxes_length1, &self->priv->_propertyVBoxes_size_, _tmp48_);
				_tmp49_ = name;
				...
				_vala_array_add82 (&self->priv->nameLabels, &self->priv->nameLabels_length1, &self->priv->_nameLabels_size_, _tmp53_);
				_tmp54_ = description;
				...
				_vala_array_add83 (&self->priv->descriptionLabels, &self->priv->descriptionLabels_length1, &self->priv->_descriptionLabels_size_, _tmp59_);
				...
				_vala_array_add84 (&self->priv->propertyWidgets, &self->priv->propertyWidgets_length1, &self->priv->_propertyWidgets_size_, _tmp69_);
