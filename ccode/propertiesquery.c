...
static void _vala_array_add86 (GtkBox*** array, int* length, int* size, GtkBox* value);
static void _vala_array_add87 (GtkLabel*** array, int* length, int* size, GtkLabel* value);
...
static void _vala_array_add89 (GtkWidget*** array, int* length, int* size, GtkWidget* value);
	...
	gtk_box_pack_start (_tmp23_, (GtkWidget*) _tmp24_, FALSE, TRUE, (guint) 1);
	{
		...
		i = 0;
		{
			...
			while (TRUE) {
				...
				_vala_array_add86 (&self->priv->propertyVBoxes, &self->priv->propertyVBoxes_length1, &self->priv->_propertyVBoxes_size_, _tmp48_);
				_tmp49_ = name;
				...
				_vala_array_add87 (&self->priv->nameLabels, &self->priv->nameLabels_length1, &self->priv->_nameLabels_size_, _tmp53_);
				_tmp54_ = description;
				...
				_vala_array_add88 (&self->priv->descriptionLabels, &self->priv->descriptionLabels_length1, &self->priv->_descriptionLabels_size_, _tmp59_);
				...
				_vala_array_add89 (&self->priv->propertyWidgets, &self->priv->propertyWidgets_length1, &self->priv->_propertyWidgets_size_, _tmp69_);
