...
static void _vala_array_add49 (GtkRadioToolButton*** array, int* length, int* size, GtkRadioToolButton* value);
static void _vala_array_add50 (GtkImage*** array, int* length, int* size, GtkImage* value);
...
static void _vala_array_add51 (GtkMenuItem*** array, int* length, int* size, GtkMenuItem* value);
	...
	self->priv->_standardComponentDefs_size_ = self->priv->standardComponentDefs_length1;
	{
		...
		i = 0;
		{
			...
			while (TRUE) {
				...
				_vala_array_add49 (&self->priv->toolStandards, &self->priv->toolStandards_length1, &self->priv->_toolStandards_size_, _tmp422_);
				...
				_vala_array_add50 (&self->priv->toolStandardImages, &self->priv->toolStandardImages_length1, &self->priv->_toolStandardImages_size_, _tmp425_);
		...
		self->priv->_menuWindowsComponents_size_ = self->priv->menuWindowsComponents_length1;
		{
			...
			i = 0;
			{
				...
				while (TRUE) {
					...
					_vala_array_add51 (&self->priv->toolCustomsMenuComponents, &self->priv->toolCustomsMenuComponents_length1, &self->priv->_toolCustomsMenuComponents_size_, _tmp34_);
					...
					_vala_array_add52 (&self->priv->menuWindowsComponents, &self->priv->menuWindowsComponents_length1, &self->priv->_menuWindowsComponents_size_, _tmp43_);
		...
		self->priv->_menuFileRemoveplugincomponentComponents_size_ = self->priv->menuFileRemoveplugincomponentComponents_length1;
		{
			...
			i = 0;
			{
				...
				while (TRUE) {
					...
					_vala_array_add53 (&self->priv->toolPluginsMenuComponents, &self->priv->toolPluginsMenuComponents_length1, &self->priv->_toolPluginsMenuComponents_size_, _tmp29_);
					...
					_vala_array_add54 (&self->priv->menuFileRemoveplugincomponentComponents, &self->priv->menuFileRemoveplugincomponentComponents_length1, &self->priv->_menuFileRemoveplugincomponentComponents_size_, _tmp38_);
