/* customiser.c generated by valac 0.18.1, the Vala compiler
...
static gboolean customiser_mouse_up (Customiser* self, GdkEventButton* event) {
	...
	switch (_tmp92_) {
		...
		{
			PinDef* _tmp104_;
			_tmp104_ = self->priv->selectedPin;
			if (_tmp104_ != NULL) {
				...
				if (_tmp110_) {
					...
					if (_tmp111_ < _tmp112_) {
						...
						gint _tmp116_;
						gint _tmp117_;
						_tmp113_ = self->priv->selectedPin;
						_tmp114_ = leftBound;
						_tmp115_ = yBoardEnd;
						_tmp116_ = leftBound;
						_tmp117_ = xBoardEnd;
						pin_def_set_position (_tmp113_, _tmp114_, _tmp115_, _tmp116_ - _tmp117_, DIRECTION_LEFT);
					}
					_tmp118_ = xBoardEnd;
					_tmp119_ = rightBound;
					if (_tmp118_ > _tmp119_) {
						...
						gint _tmp123_;
						gint _tmp124_;
						_tmp120_ = self->priv->selectedPin;
						_tmp121_ = rightBound;
						_tmp122_ = yBoardEnd;
						_tmp123_ = xBoardEnd;
						_tmp124_ = rightBound;
						pin_def_set_position (_tmp120_, _tmp121_, _tmp122_, _tmp123_ - _tmp124_, DIRECTION_RIGHT);
					}
				}
				_tmp126_ = leftBound;
				_tmp127_ = xBoardEnd;
				...
				if (_tmp130_) {
					...
					if (_tmp131_ < _tmp132_) {
						...
						_tmp136_ = upBound;
						_tmp137_ = yBoardEnd;
						pin_def_set_position (_tmp133_, _tmp134_, _tmp135_, _tmp136_ - _tmp137_, DIRECTION_UP);
					}
					_tmp138_ = yBoardEnd;
					_tmp139_ = downBound;
					if (_tmp138_ > _tmp139_) {
						...
						gint _tmp143_;
						gint _tmp144_;
						_tmp140_ = self->priv->selectedPin;
						_tmp141_ = xBoardEnd;
						_tmp142_ = downBound;
						_tmp143_ = yBoardEnd;
						_tmp144_ = downBound;
						pin_def_set_position (_tmp140_, _tmp141_, _tmp142_, _tmp143_ - _tmp144_, DIRECTION_DOWN);
					}
				}
			}
			break;
