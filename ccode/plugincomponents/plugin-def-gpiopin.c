/* plugin-def-gpiopin.c generated by valac 0.16.1, the Vala compiler
...
static void gpio_pin_plugin_component_def_real_add_properties (ComponentDef* base, PropertySet* queryProperty, PropertySet* configurationProperty) {
	...
	PropertyItem* gpioNumber;
	PropertyItem* _tmp2_;
	PropertySet* _tmp11_;
	PropertyItem* _tmp12_ = NULL;
	PropertyItem* direction;
	PropertyItem* _tmp13_;
	PropertySet* _tmp25_;
	PropertyItem* _tmp26_ = NULL;
	PropertyItem* activeState;
	PropertyItem* _tmp27_;
	...
	if (_tmp2_ != NULL) {
		...
		_tmp4_ = gpioNumber;
		_tmp5_ = property_item_int_new_copy (PROPERTY_ITEM_INT (_tmp4_));
		_tmp6_ = _tmp5_;
	...
	if (_tmp13_ != NULL) {
		...
		_tmp15_ = direction;
		_tmp16_ = property_item_selection_new_copy (PROPERTY_ITEM_SELECTION (_tmp15_));
		_tmp17_ = _tmp16_;
	...
	if (_tmp27_ != NULL) {
		PropertySet* _tmp28_;
		PropertyItem* _tmp29_;
		PropertyItemSelection* _tmp30_;
		PropertyItemSelection* _tmp31_;
		_tmp28_ = queryProperty;
		_tmp29_ = activeState;
		_tmp30_ = property_item_selection_new_copy (PROPERTY_ITEM_SELECTION (_tmp29_));
		_tmp31_ = _tmp30_;
		...
		PropertyItemSelection* _tmp34_;
		PropertyItemSelection* _tmp35_;
		PropertySet* _tmp36_;
		PropertyItemSelection* _tmp37_;
...
static void gpio_pin_plugin_component_def_real_get_properties (ComponentDef* base, PropertySet* queryProperty, PropertySet** configurationProperty) {
	...
	_tmp6_ = PROPERTY_ITEM_INT (_tmp5_);
	...
	_tmp11_ = PROPERTY_ITEM_SELECTION (_tmp10_);
	...
	_tmp16_ = PROPERTY_ITEM_SELECTION (_tmp15_);
...
static void gpio_pin_plugin_component_def_real_load_properties (ComponentDef* base, xmlNode* xmlnode, PropertySet** configurationProperty) {
	...
	_g_free0 (_tmp4_);
	{
		...
		xmlattr = _tmp7_;
		{
			...
			while (TRUE) {
				...
				if (_tmp17_ == ((0 != _tmp16_label0) ? _tmp16_label0 : (_tmp16_label0 = g_quark_from_static_string ("number")))) {
					switch (0) {
						default:
						{
							xmlAttr* _tmp18_;
				...
				} else if (_tmp17_ == ((0 != _tmp16_label1) ? _tmp16_label1 : (_tmp16_label1 = g_quark_from_static_string ("iodirection")))) {
					switch (0) {
						default:
						{
							xmlAttr* _tmp22_;
				...
				} else if (_tmp17_ == ((0 != _tmp16_label2) ? _tmp16_label2 : (_tmp16_label2 = g_quark_from_static_string ("active")))) {
					switch (0) {
						default:
						{
							xmlAttr* _tmp26_;
	...
	_tmp31_ = gpioNumber;
	_tmp32_ = G_MAXINT;
	_tmp33_ = property_item_int_new ("GPIO Pin Number", "The pin number in the GPIO system.", _tmp31_, 0, _tmp32_);
	_tmp34_ = _tmp33_;
	property_set_add_item (_tmp30_, (PropertyItem*) _tmp34_);
	_property_item_unref0 (_tmp34_);
	{
		PropertyItemSelection* _tmp35_;
		PropertyItemSelection* selection;
		const gchar* _tmp36_;
		PropertySet* _tmp37_;
		_tmp35_ = property_item_selection_new ("Direction", "Whether the port represents an output or input.");
		selection = _tmp35_;
		...
		_tmp36_ = direction;
		property_item_selection_set_option (selection, _tmp36_);
		_tmp37_ = _vala_configurationProperty;
		property_set_add_item (_tmp37_, (PropertyItem*) selection);
		_property_item_unref0 (selection);
	}
	{
		...
		const gchar* _tmp39_;
		PropertySet* _tmp40_;
		_tmp38_ = property_item_selection_new ("Active State", "Whether a high or low voltage represents 1 (true).");
		selection = _tmp38_;
		...
		_tmp39_ = activeState;
		property_item_selection_set_option (selection, _tmp39_);
		_tmp40_ = _vala_configurationProperty;
		property_set_add_item (_tmp40_, (PropertyItem*) selection);
		_property_item_unref0 (selection);
	}
	_g_free0 (activeState);
	_g_free0 (direction);
...
static void gpio_pin_plugin_component_def_real_save_properties (ComponentDef* base, xmlTextWriter* xmlWriter, PropertySet* configurationProperty) {
	...
	g_return_if_fail (configurationProperty != NULL);
	{
		...
		gint _tmp2_;
		_tmp0_ = configurationProperty;
		_tmp1_ = property_item_int_get_data_throw (_tmp0_, "GPIO Pin Number", &_inner_error_);
		_tmp2_ = _tmp1_;
		if (_inner_error_ != NULL) {
	...
	}
	{
		...
		_tmp4_ = property_item_selection_get_data_throw (_tmp3_, "Direction", &_inner_error_);
		_tmp5_ = _tmp4_;
		if (_inner_error_ != NULL) {
	...
	}
	{
		...
		_tmp8_ = property_item_selection_get_data_throw (_tmp7_, "Active State", &_inner_error_);
		_tmp9_ = _tmp8_;
		if (_inner_error_ != NULL) {
	...
	_tmp14_ = _tmp13_;
	xmlTextWriterWriteAttribute (_tmp11_, "number", _tmp14_);
	_g_free0 (_tmp14_);
	_tmp15_ = xmlWriter;
	_tmp16_ = direction;
	xmlTextWriterWriteAttribute (_tmp15_, "iodirection", _tmp16_);
	_tmp17_ = xmlWriter;
	_tmp18_ = activeState;
	xmlTextWriterWriteAttribute (_tmp17_, "active", _tmp18_);
	_g_free0 (activeState);
	_g_free0 (direction);
}
...
static void gpio_pin_plugin_component_def_real_compile_component (ComponentDef* base, CompiledCircuit* compiledCircuit, ComponentInst* componentInst, Connection** connections, int connections_length1, ComponentInst** ancestry, int ancestry_length1) {
	...
	}
	{
		...
		_tmp15_ = property_item_int_get_data_throw (_tmp14_, "GPIO Pin Number", &_inner_error_);
		_tmp16_ = _tmp15_;
		if (_inner_error_ != NULL) {
	...
	}
	{
		...
		_tmp19_ = property_item_selection_get_data_throw (_tmp18_, "Direction", &_inner_error_);
		_tmp20_ = _tmp19_;
		if (_inner_error_ != NULL) {
	...
	}
	{
		...
		_tmp24_ = _tmp23_->configuration;
		_tmp25_ = property_item_selection_get_data_throw (_tmp24_, "Active State", &_inner_error_);
		_tmp26_ = _tmp25_;
		if (_inner_error_ != NULL) {
			goto __catch78_g_error;
		}
		_tmp27_ = _tmp26_;
		_tmp28_ = g_strcmp0 (_tmp27_, "low") == 0;
		_g_free0 (_tmp27_);
		if (_tmp28_) {
			_tmp22_ = TRUE;
		} else {
	...
	}
	{
		...
		GpioPinPluginComponentState* _tmp36_;
		ComponentState* componentState;
		CompiledCircuit* _tmp37_;
		_tmp30_ = accessWire;
		_tmp31_ = gpioNumber;
		_tmp32_ = direction;
		_tmp33_ = activeLow;
		_tmp34_ = ancestry;
		_tmp34__length1 = ancestry_length1;
		_tmp35_ = componentInst;
		_tmp36_ = gpio_pin_plugin_component_state_new (_tmp30_, _tmp31_, _tmp32_, _tmp33_, _tmp34_, _tmp34__length1, _tmp35_, &_inner_error_);
		componentState = (ComponentState*) _tmp36_;
		if (_inner_error_ != NULL) {
			if (_inner_error_->domain == COMPONENT_STATE_ERROR) {
				goto __catch79_component_state_error;
			}
			_g_free0 (direction);
			_connection_unref0 (accessWire);
		...
		_tmp37_ = compiledCircuit;
		compiled_circuit_add_component (_tmp37_, componentState);
		_component_state_unref0 (componentState);
	}
	goto __finally79;
	__catch79_component_state_error:
	{
		GError* _error_ = NULL;
		...
		compiled_circuit_appendError (_tmp38_, _tmp40_);
		_tmp41_ = componentInst;
		_tmp41_->errorMark = TRUE;
...
static void gpio_pin_plugin_component_def_finalize (ComponentDef* obj) {
	...
	self = GPIO_PIN_PLUGIN_COMPONENT_DEF (obj);
...
PluginComponentDef* plugin_component_get_def (const gchar* infoFilename) {
	...
	{
		const gchar* _tmp0_;
		GpioPinPluginComponentDef* _tmp1_;
		PluginComponentDef* componentDef;
		_tmp0_ = infoFilename;
