...
static void _vala_array_add20 (gint** array, int* length, int* size, gint value);
				...
				if (_tmp11_ == ((0 != _tmp10_label0) ? _tmp10_label0 : (_tmp10_label0 = g_quark_from_static_string (".")))) {
					...
					switch (0) {
						default:
						{
							...
							if (_tmp12__length1 == 0) {
								...
								_tmp14_ = g_strdup ("..");
								_vala_array_add17 (&reducedParts, &reducedParts_length1, &_reducedParts_size_, _tmp14_);
							} else {
								gchar** _tmp15_;
								gint _tmp15__length1;
								gchar** _tmp16_;
								...
								if (g_strcmp0 (_tmp17_, "..") == 0) {
									...
									_tmp19_ = g_strdup ("..");
									_vala_array_add18 (&reducedParts, &reducedParts_length1, &_reducedParts_size_, _tmp19_);
								} else {
									gint _tmp20_;
					...
					switch (0) {
						default:
						{
							...
							_vala_array_add19 (&reducedParts, &reducedParts_length1, &_reducedParts_size_, _tmp23_);
							break;
						}
					}
				}
...
static gint* core_version_to_numbers (const gchar* version, int* result_length1) {
				...
				switch (_tmp7_) {
					default:
					{
						...
						if (g_strcmp0 (_tmp8_, "") != 0) {
							...
							_vala_array_add20 (&numbers, &numbers_length1, &_numbers_size_, _tmp11_);
							_tmp12_ = g_strdup ("");
							_g_free0 (number);
							number = _tmp12_;
						}
	...
	if (g_strcmp0 (_tmp16_, "") != 0) {
		...
		_vala_array_add21 (&numbers, &numbers_length1, &_numbers_size_, _tmp19_);
		_tmp20_ = g_strdup ("");
		_g_free0 (number);
		number = _tmp20_;
	}
