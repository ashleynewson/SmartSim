...
gint core_main (gchar** args, int args_length1) {
	gint result = 0;
	gchar** _tmp0_ = NULL;
	gchar** projectsToOpen;
	gint projectsToOpen_length1;
	gint _projectsToOpen_size_;
	FILE* _tmp1_;
	FILE* _tmp2_;
	FILE* _tmp3_;
	FILE* _tmp4_;
	...
	core_fullLicenseText = _tmp5_;
	{
		...
		i = 1;
		{
			...
			while (TRUE) {
				...
				if (_tmp18_ == ((0 != _tmp17_label0) ? _tmp17_label0 : (_tmp17_label0 = g_quark_from_static_string ("--version")))) {
					switch (0) {
						default:
						{
							result = 0;
				...
				} else if (_tmp18_ == ((0 != _tmp17_label1) ? _tmp17_label1 : (_tmp17_label1 = g_quark_from_static_string ("--license")))) {
					switch (0) {
						default:
						{
							FILE* _tmp19_;
					...
					switch (0) {
						default:
						{
							...
							gboolean _tmp25_;
							_tmp22_ = arg;
							_tmp23_ = string_substring (_tmp22_, (glong) 0, (glong) 2);
							_tmp24_ = _tmp23_;
							...
							if (_tmp25_) {
								...
								_tmp26_ = stderr;
								_tmp27_ = arg;
								fprintf (_tmp26_, "Unrecognised command \"%s\".\n", _tmp27_);
							} else {
								gchar** _tmp28_;
								gint _tmp28__length1;
								const gchar* _tmp29_;
								gchar* _tmp30_;
								_tmp28_ = projectsToOpen;
								_tmp28__length1 = projectsToOpen_length1;
								_tmp29_ = arg;
								_tmp30_ = g_strdup (_tmp29_);
								_vala_array_add1 (&projectsToOpen, &projectsToOpen_length1, &_projectsToOpen_size_, _tmp30_);
							}
							break;
						}
					}
	...
	_tmp31_ = stdout;
	fprintf (_tmp31_, "Loading System...\n");
	gtk_init (&args_length1, &args);
	_tmp32_ = stdout;
	fprintf (_tmp32_, "Loading Place-holder Graphic\n");
	{
		Graphic* _tmp33_;
		Graphic* _tmp34_;
...
static void core_load_standard_defs (void) {
	...
	_standardComponentDefs_size_ = standardComponentDefs_length1;
	{
		...
		_vala_array_add2 (&standardComponentDefs, &standardComponentDefs_length1, &_standardComponentDefs_size_, (ComponentDef*) _tmp2_);
		...
		_vala_array_add3 (&standardComponentDefs, &standardComponentDefs_length1, &_standardComponentDefs_size_, (ComponentDef*) _tmp5_);
		...
		_vala_array_add4 (&standardComponentDefs, &standardComponentDefs_length1, &_standardComponentDefs_size_, (ComponentDef*) _tmp8_);
		...
		_vala_array_add5 (&standardComponentDefs, &standardComponentDefs_length1, &_standardComponentDefs_size_, (ComponentDef*) _tmp11_);
		...
		_vala_array_add6 (&standardComponentDefs, &standardComponentDefs_length1, &_standardComponentDefs_size_, (ComponentDef*) _tmp14_);
		...
		_vala_array_add7 (&standardComponentDefs, &standardComponentDefs_length1, &_standardComponentDefs_size_, (ComponentDef*) _tmp17_);
		...
		_vala_array_add8 (&standardComponentDefs, &standardComponentDefs_length1, &_standardComponentDefs_size_, (ComponentDef*) _tmp20_);
		...
		_vala_array_add9 (&standardComponentDefs, &standardComponentDefs_length1, &_standardComponentDefs_size_, (ComponentDef*) _tmp23_);
		...
		_vala_array_add10 (&standardComponentDefs, &standardComponentDefs_length1, &_standardComponentDefs_size_, (ComponentDef*) _tmp26_);
		...
		_vala_array_add11 (&standardComponentDefs, &standardComponentDefs_length1, &_standardComponentDefs_size_, (ComponentDef*) _tmp29_);
		...
		_vala_array_add12 (&standardComponentDefs, &standardComponentDefs_length1, &_standardComponentDefs_size_, (ComponentDef*) _tmp32_);
		...
		_vala_array_add13 (&standardComponentDefs, &standardComponentDefs_length1, &_standardComponentDefs_size_, (ComponentDef*) _tmp35_);
		...
		_vala_array_add14 (&standardComponentDefs, &standardComponentDefs_length1, &_standardComponentDefs_size_, (ComponentDef*) _tmp38_);
		...
		_vala_array_add15 (&standardComponentDefs, &standardComponentDefs_length1, &_standardComponentDefs_size_, (ComponentDef*) _tmp41_);
	}
	goto __finally1;
...
gchar* core_reduce_filename (const gchar* rawFilename) {
	...
	gchar** _tmp4_ = NULL;
	gchar** rawParts;
	gint rawParts_length1;
	gint _rawParts_size_;
	gchar** _tmp5_ = NULL;
	gchar** reducedParts;
	gint reducedParts_length1;
	gint _reducedParts_size_;
	gchar** _tmp6_;
	gint _tmp6__length1;
	gchar** _tmp24_;
	gint _tmp24__length1;
