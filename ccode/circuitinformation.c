/* circuitinformation.c generated by valac 0.18.1, the Vala compiler
...
static void _vala_array_add22 (CircuitInformationComponentCount** array, int* length, int* size, const CircuitInformationComponentCount* value);
...
void circuit_information_count_component (CircuitInformation* self, ComponentDef* componentDef) {
	...
	if (_tmp13_ == _tmp14__length1) {
		...
		_vala_array_add22 (&self->priv->componentCounts, &self->priv->componentCounts_length1, &self->priv->_componentCounts_size_, &_tmp19_);
		circuit_information_component_count_destroy (&componentCount);
	}
}
