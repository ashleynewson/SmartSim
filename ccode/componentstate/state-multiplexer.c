/* state-multiplexer.c generated by valac 0.20.1, the Vala compiler
...
static Connection** _vala_array_dup28 (Connection** self, int length);
void connection_set_affects (Connection* self, ComponentState* componentState);
static Connection** _vala_array_dup29 (Connection** self, int length);
static ComponentInst** _vala_array_dup30 (ComponentInst** self, int length);
...
MultiplexerComponentState* multiplexer_component_state_construct (GType object_type, Connection** selectWires, int selectWires_length1, Connection** dataWires, int dataWires_length1, Connection* outputWire, ComponentInst** ancestry, int ancestry_length1, ComponentInst* componentInst) {
	...
	_tmp6_ = (_tmp5_ != NULL) ? _vala_array_dup29 (_tmp5_, _tmp5__length1) : ((gpointer) _tmp5_);
	...
	_tmp13_ = (_tmp12_ != NULL) ? _vala_array_dup30 (_tmp12_, _tmp12__length1) : ((gpointer) _tmp12_);
