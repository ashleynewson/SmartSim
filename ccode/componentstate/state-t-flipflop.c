/* state-t-flipflop.c generated by valac 0.16.0, the Vala compiler
...
static ComponentInst** _vala_array_dup86 (ComponentInst** self, int length);
...
TFlipflopComponentState* tflipflop_component_state_construct (GType object_type, Connection* toggleWire, Connection* clockWire, Connection* outputWire, Connection* outputNotWire, ComponentInst** ancestry, int ancestry_length1, ComponentInst* componentInst) {
	...
	_tmp10_ = (_tmp9_ != NULL) ? _vala_array_dup86 (_tmp9_, _tmp9__length1) : ((gpointer) _tmp9_);
...
static void tflipflop_component_state_real_update (ComponentState* base) {
	...
	_tmp14_ = self->priv->clockWire;
	_tmp15_ = connection_get_signalState (_tmp14_);
	_tmp16_ = _tmp15_;
	self->priv->previousClockSignal = _tmp16_;
	_tmp17_ = self->priv->outputWire;
	_tmp18_ = self->priv->output;
	connection_set_signalState (_tmp17_, _tmp18_);
	_tmp19_ = self->priv->outputNotWire;
	_tmp20_ = self->priv->output;
	connection_set_signalState (_tmp19_, !_tmp20_);
}
...
static void tflipflop_component_state_finalize (ComponentState* obj) {
	TFlipflopComponentState * self;
	self = TFLIPFLOP_COMPONENT_STATE (obj);
	_connection_unref0 (self->priv->toggleWire);
	_connection_unref0 (self->priv->clockWire);
	_connection_unref0 (self->priv->outputWire);
	_connection_unref0 (self->priv->outputNotWire);
