/* state-basic-ss-display.c generated by valac 0.16.0, the Vala compiler
...
static ComponentInst** _vala_array_dup72 (ComponentInst** self, int length);
...
BasicSsDisplayComponentState* basic_ss_display_component_state_construct (GType object_type, Connection* input1Wire, Connection* input2Wire, Connection* input4Wire, Connection* input8Wire, Connection* inputPWire, gboolean displayPoint, ComponentInst** ancestry, int ancestry_length1, ComponentInst* componentInst) {
	...
	_tmp17_ = (_tmp16_ != NULL) ? _vala_array_dup72 (_tmp16_, _tmp16__length1) : ((gpointer) _tmp16_);
...
static void basic_ss_display_component_state_real_update (ComponentState* base) {
	...
	_tmp4_ = _tmp0_;
	newInput = (gint8) _tmp4_;
	_tmp6_ = self->priv->input2Wire;
	...
	_tmp9_ = newInput;
	_tmp10_ = _tmp5_;
	newInput = (gint8) (_tmp9_ + _tmp10_);
	_tmp12_ = self->priv->input4Wire;
	_tmp13_ = connection_get_signalState (_tmp12_);
	_tmp14_ = _tmp13_;
	if (_tmp14_) {
		_tmp11_ = 4;
	} else {
	...
	_tmp15_ = newInput;
	_tmp16_ = _tmp11_;
	newInput = (gint8) (_tmp15_ + _tmp16_);
	_tmp18_ = self->priv->input8Wire;
	_tmp19_ = connection_get_signalState (_tmp18_);
	_tmp20_ = _tmp19_;
	if (_tmp20_) {
		_tmp17_ = 8;
	} else {
	...
	_tmp21_ = newInput;
	_tmp22_ = _tmp17_;
	newInput = (gint8) (_tmp21_ + _tmp22_);
	_tmp23_ = ((ComponentState*) self)->display;
	if (_tmp23_) {
		gint8 _tmp24_;
		gint8 _tmp25_;
		_tmp24_ = self->priv->input;
		_tmp25_ = newInput;
		if (_tmp24_ != _tmp25_) {
			CompiledCircuit* _tmp26_;
			UpdateQueue* _tmp27_;
			gint _tmp28_;
			_tmp26_ = ((ComponentState*) self)->compiledCircuit;
			_tmp27_ = _tmp26_->renderComponentStates;
			_tmp28_ = ((ComponentState*) self)->renderQueueID;
			update_queue_add_element (_tmp27_, _tmp28_);
		}
	}
	_tmp29_ = newInput;
	...
	_tmp31_ = self->priv->inputPWire;
	_tmp32_ = connection_get_signalState (_tmp31_);
	_tmp33_ = _tmp32_;
	self->priv->pointLight = _tmp33_;
}
...
static void basic_ss_display_component_state_finalize (ComponentState* obj) {
	BasicSsDisplayComponentState * self;
	self = BASIC_SS_DISPLAY_COMPONENT_STATE (obj);
	_connection_unref0 (self->priv->input1Wire);
	_connection_unref0 (self->priv->input2Wire);
	_connection_unref0 (self->priv->input4Wire);
	_connection_unref0 (self->priv->input8Wire);
