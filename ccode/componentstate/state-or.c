/* state-or.c generated by valac 0.16.0, the Vala compiler
...
static Connection** _vala_array_dup82 (Connection** self, int length);
void connection_set_affects (Connection* self, ComponentState* componentState);
static ComponentInst** _vala_array_dup83 (ComponentInst** self, int length);
...
OrComponentState* or_component_state_construct (GType object_type, Connection** inputWires, int inputWires_length1, Connection* outputWire, ComponentInst** ancestry, int ancestry_length1, ComponentInst* componentInst) {
	...
	_tmp1_ = (_tmp0_ != NULL) ? _vala_array_dup82 (_tmp0_, _tmp0__length1) : ((gpointer) _tmp0_);
	...
	_tmp8_ = (_tmp7_ != NULL) ? _vala_array_dup83 (_tmp7_, _tmp7__length1) : ((gpointer) _tmp7_);
