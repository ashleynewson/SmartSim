...
static PathLine* _vala_array_dup34 (PathLine* self, int length);
static PathLine* _vala_array_dup35 (PathLine* self, int length);
static PathLine* _vala_array_dup36 (PathLine* self, int length);
static PathLine* _vala_array_dup37 (PathLine* self, int length);
static PathLine* _vala_array_dup38 (PathLine* self, int length);
static void _vala_array_add58 (PathLine** array, int* length, int* size, const PathLine* value);
static PathLine* _vala_array_dup39 (PathLine* self, int length);
gint path_append (Path* self, gint x, gint y, gfloat diagonalThreshold);
static PathLine* _vala_array_dup40 (PathLine* self, int length);
static void _vala_array_add59 (PathLine** array, int* length, int* size, const PathLine* value);
static PathLine* _vala_array_dup41 (PathLine* self, int length);
...
void path_merge (Path* self, Path* extraPath, gboolean prepend, gboolean reverse) {
	...
	if (_tmp0_) {
		...
		_extraLines_size_ = extraLines_length1;
		{
			...
			i = _tmp3__length1 - 1;
			{
				...
				while (TRUE) {
					...
					_vala_array_add57 (&extraLines, &extraLines_length1, &_extraLines_size_, &_tmp34_);
				}
			}
		}
	} else {
		...
		_tmp37_ = (_tmp36_ != NULL) ? _vala_array_dup34 (_tmp36_, _tmp36__length1) : ((gpointer) _tmp36_);
	...
	if (_tmp38_) {
		...
		_tmp40_ = (_tmp39_ != NULL) ? _vala_array_dup35 (_tmp39_, _tmp39__length1) : ((gpointer) _tmp39_);
		...
		_tmp42_ = (_tmp41_ != NULL) ? _vala_array_dup36 (_tmp41_, _tmp41__length1) : ((gpointer) _tmp41_);
		...
		_tmp44_ = (_tmp43_ != NULL) ? _vala_array_dup37 (_tmp43_, _tmp43__length1) : ((gpointer) _tmp43_);
		...
		_tmp46_ = (_tmp45_ != NULL) ? _vala_array_dup38 (_tmp45_, _tmp45__length1) : ((gpointer) _tmp45_);
	...
	}
	{
		...
		i = 0;
		{
			...
			while (TRUE) {
				...
				_vala_array_add58 (&newLines, &newLines_length1, &_newLines_size_, &_tmp83_);
			}
		}
	}
	_tmp84_ = newLines;
	_tmp84__length1 = newLines_length1;
	_tmp85_ = (_tmp84_ != NULL) ? _vala_array_dup39 (_tmp84_, _tmp84__length1) : ((gpointer) _tmp84_);
...
gint path_append (Path* self, gint x, gint y, gfloat diagonalThreshold) {
	...
	_tmp27_ = (_tmp26_ != NULL) ? _vala_array_dup40 (_tmp26_, _tmp26__length1) : ((gpointer) _tmp26_);
	...
	if (_tmp33_) {
		...
		if (_tmp103_) {
			...
			_tmp107_ = line;
			_vala_array_add59 (&newLines, &newLines_length1, &_newLines_size_, &_tmp107_);
		}
	}
	_tmp108_ = newLines;
	...
	_tmp125_ = (_tmp124_ != NULL) ? _vala_array_dup41 (_tmp124_, _tmp124__length1) : ((gpointer) _tmp124_);
