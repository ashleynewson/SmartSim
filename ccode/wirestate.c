/* wirestate.c generated by valac 0.16.0, the Vala compiler
...
static ComponentInst** _vala_array_dup43 (ComponentInst** self, int length);
...
static void _vala_array_add72 (WireStateStateHistory** array, int* length, int* size, const WireStateStateHistory* value);
...
static void _vala_array_add73 (Connection*** array, int* length, int* size, Connection* value);
void wire_state_add_affected (WireState* self, ComponentState* componentState);
static void _vala_array_add74 (ComponentState*** array, int* length, int* size, ComponentState* value);
void wire_state_start_recording (WireState* self, gint unknownTime);
static void _vala_array_add75 (WireStateStateHistory** array, int* length, int* size, const WireStateStateHistory* value);
static void _vala_array_add76 (WireStateStateHistory** array, int* length, int* size, const WireStateStateHistory* value);
...
WireState* wire_state_construct (GType object_type, WireInst* wireInst, ComponentInst** ancestry, int ancestry_length1) {
	...
	_tmp3_ = (_tmp2_ != NULL) ? _vala_array_dup43 (_tmp2_, _tmp2__length1) : ((gpointer) _tmp2_);
...
void wire_state_record (WireState* self) {
	...
	if (_tmp4_ == _tmp8_) {
		...
		_tmp14_ = newState;
		_vala_array_add72 (&self->priv->stateHistory, &self->priv->stateHistory_length1, &self->priv->_stateHistory_size_, &_tmp14_);
	}
}
...
void wire_state_add_interface (WireState* self, Connection* connection) {
	...
	if (!_tmp1_) {
		...
		_vala_array_add73 (&self->priv->interfaces, &self->priv->interfaces_length1, &self->priv->_interfaces_size_, _tmp4_);
	}
}
...
void wire_state_add_affected (WireState* self, ComponentState* componentState) {
	...
	_vala_array_add74 (&self->priv->affectedComponents, &self->priv->affectedComponents_length1, &self->priv->_affectedComponents_size_, _tmp2_);
}
...
void wire_state_start_recording (WireState* self, gint unknownTime) {
	...
	_tmp5__length1 = self->priv->stateHistory_length1;
	_tmp6_ = unknownState;
	_vala_array_add75 (&self->priv->stateHistory, &self->priv->stateHistory_length1, &self->priv->_stateHistory_size_, &_tmp6_);
	_tmp7_ = self->priv->stateHistory;
	_tmp7__length1 = self->priv->stateHistory_length1;
	_tmp8_ = initialState;
	_vala_array_add76 (&self->priv->stateHistory, &self->priv->stateHistory_length1, &self->priv->_stateHistory_size_, &_tmp8_);
