...
void component_def_load_from_file (ComponentDef* self, const gchar* infoFilename, GError** error) {
								...
								xmldata = _tmp153_;
								{
									...
									while (TRUE) {
										...
										self->graphicReferenceFilename = _tmp163_;
										{
											...
											_tmp167_ = g_path_get_dirname (_tmp166_);
											_tmp168_ = _tmp167_;
											_tmp169_ = core_absolute_filename (_tmp165_, _tmp168_);
											_tmp170_ = _tmp169_;
											_tmp171_ = graphic_new_from_file (_tmp170_, &_inner_error_);
											_tmp172_ = _tmp171_;
											_g_free0 (_tmp170_);
											_g_free0 (_tmp168_);
											_tmp173_ = _tmp172_;
										...
										__catch3_g_error:
										{
											...
											_inner_error_ = NULL;
											{
												...
												Graphic* _tmp180_;
												_tmp174_ = xmldata;
												_tmp175_ = _tmp174_->content;
												_tmp176_ = g_strconcat (PACKAGE_DATADIR "components/graphics/", _tmp175_, NULL);
												_tmp177_ = _tmp176_;
												_tmp178_ = graphic_new_from_file (_tmp177_, &_inner_error_);
												_tmp179_ = _tmp178_;
												_g_free0 (_tmp177_);
												_tmp180_ = _tmp179_;
												if (_inner_error_ != NULL) {
											...
											__catch4_graphic_load_error:
											{
												...
												_tmp181_ = stdout;
												_tmp182_ = xmldata;
												_tmp183_ = _tmp182_->content;
												_tmp184_ = g_strconcat ("Cannot load graphic \"", _tmp183_, NULL);
												_tmp185_ = _tmp184_;
												_tmp186_ = g_strconcat (_tmp185_, "\"\n", NULL);
												_tmp187_ = _tmp186_;
												fprintf (_tmp181_, "%s", _tmp187_);
												_g_free0 (_tmp187_);
												_g_free0 (_tmp185_);
						...
						{
							{
								...
								xmldata = _tmp189_;
								{
									...
									while (TRUE) {
										...
										if (_tmp196_ != XML_ELEMENT_NODE) {
											continue;
										}
										_tmp197_ = xmldata;
										_tmp198_ = _tmp197_->content;
						...
						{
							{
								...
								xmlattr = _tmp201_;
								{
									...
									while (TRUE) {
										...
										GQuark _tmp211_ = 0U;
										static GQuark _tmp210_label0 = 0;
										static GQuark _tmp210_label1 = 0;
										static GQuark _tmp210_label2 = 0;
										static GQuark _tmp210_label3 = 0;
										static GQuark _tmp210_label4 = 0;
										_tmp203_ = _tmp202_;
										if (!_tmp203_) {
											xmlAttr* _tmp204_;
											xmlAttr* _tmp205_;
											_tmp204_ = xmlattr;
											_tmp205_ = _tmp204_->next;
											xmlattr = _tmp205_;
										}
										_tmp202_ = FALSE;
										_tmp206_ = xmlattr;
										...
										_tmp209_ = _tmp208_;
										_tmp211_ = (NULL == _tmp209_) ? 0 : g_quark_from_string (_tmp209_);
										if (_tmp211_ == ((0 != _tmp210_label0) ? _tmp210_label0 : (_tmp210_label0 = g_quark_from_static_string ("right")))) {
											switch (0) {
												default:
												{
													xmlAttr* _tmp212_;
													...
													gint _tmp215_ = 0;
													_tmp212_ = xmlattr;
													_tmp213_ = _tmp212_->children;
													_tmp214_ = _tmp213_->content;
													_tmp215_ = atoi (_tmp214_);
													self->rightBound = _tmp215_;
													break;
												}
											}
										} else if (_tmp211_ == ((0 != _tmp210_label1) ? _tmp210_label1 : (_tmp210_label1 = g_quark_from_static_string ("down")))) {
											switch (0) {
												default:
												{
													xmlAttr* _tmp216_;
													...
													gint _tmp219_ = 0;
													_tmp216_ = xmlattr;
													_tmp217_ = _tmp216_->children;
													_tmp218_ = _tmp217_->content;
													_tmp219_ = atoi (_tmp218_);
													self->downBound = _tmp219_;
													break;
												}
											}
										} else if (_tmp211_ == ((0 != _tmp210_label2) ? _tmp210_label2 : (_tmp210_label2 = g_quark_from_static_string ("left")))) {
											switch (0) {
												default:
												{
													xmlAttr* _tmp220_;
													...
													gint _tmp223_ = 0;
													_tmp220_ = xmlattr;
													_tmp221_ = _tmp220_->children;
													_tmp222_ = _tmp221_->content;
													_tmp223_ = atoi (_tmp222_);
													self->leftBound = _tmp223_;
													break;
												}
											}
										} else if (_tmp211_ == ((0 != _tmp210_label3) ? _tmp210_label3 : (_tmp210_label3 = g_quark_from_static_string ("up")))) {
											switch (0) {
												default:
												{
													xmlAttr* _tmp224_;
													...
													gint _tmp227_ = 0;
													_tmp224_ = xmlattr;
													_tmp225_ = _tmp224_->children;
													_tmp226_ = _tmp225_->content;
													_tmp227_ = atoi (_tmp226_);
													self->upBound = _tmp227_;
													break;
												}
											}
										} else if (_tmp211_ == ((0 != _tmp210_label4) ? _tmp210_label4 : (_tmp210_label4 = g_quark_from_static_string ("drawbox")))) {
											switch (0) {
												default:
												{
													xmlAttr* _tmp228_;
													...
													_tmp228_ = xmlattr;
													_tmp229_ = _tmp228_->children;
													_tmp230_ = _tmp229_->content;
													_tmp231_ = bool_parse (_tmp230_);
													self->drawBox = _tmp231_;
													break;
												}
											}
										}
						...
						{
							{
								...
								xmlattr = _tmp233_;
								{
									...
									while (TRUE) {
										...
										static GQuark _tmp242_label3 = 0;
										_tmp235_ = _tmp234_;
										if (!_tmp235_) {
											xmlAttr* _tmp236_;
											xmlAttr* _tmp237_;
											_tmp236_ = xmlattr;
											_tmp237_ = _tmp236_->next;
											xmlattr = _tmp237_;
										}
										_tmp234_ = FALSE;
										_tmp238_ = xmlattr;
										...
										if (_tmp243_ == ((0 != _tmp242_label0) ? _tmp242_label0 : (_tmp242_label0 = g_quark_from_static_string ("a")))) {
											switch (0) {
												default:
												{
													xmlAttr* _tmp244_;
													...
													gint _tmp248_;
													_tmp244_ = xmlattr;
													_tmp245_ = _tmp244_->children;
													_tmp246_ = _tmp245_->content;
													_tmp247_ = atoi (_tmp246_);
													self->backgroundAlpha = _tmp247_;
													_tmp248_ = self->backgroundAlpha;
													self->backgroundAlphaF = ((gdouble) _tmp248_) / 255.0;
													break;
												}
											}
										} else if (_tmp243_ == ((0 != _tmp242_label1) ? _tmp242_label1 : (_tmp242_label1 = g_quark_from_static_string ("r")))) {
											switch (0) {
												default:
												{
													xmlAttr* _tmp249_;
													...
													gint _tmp253_;
													_tmp249_ = xmlattr;
													_tmp250_ = _tmp249_->children;
													_tmp251_ = _tmp250_->content;
													_tmp252_ = atoi (_tmp251_);
													self->backgroundRed = _tmp252_;
													_tmp253_ = self->backgroundRed;
													self->backgroundRedF = ((gdouble) _tmp253_) / 255.0;
													break;
												}
											}
										} else if (_tmp243_ == ((0 != _tmp242_label2) ? _tmp242_label2 : (_tmp242_label2 = g_quark_from_static_string ("g")))) {
											switch (0) {
												default:
												{
													xmlAttr* _tmp254_;
													...
													gint _tmp258_;
													_tmp254_ = xmlattr;
													_tmp255_ = _tmp254_->children;
													_tmp256_ = _tmp255_->content;
													_tmp257_ = atoi (_tmp256_);
													self->backgroundGreen = _tmp257_;
													_tmp258_ = self->backgroundGreen;
													self->backgroundGreenF = ((gdouble) _tmp258_) / 255.0;
													break;
												}
											}
										} else if (_tmp243_ == ((0 != _tmp242_label3) ? _tmp242_label3 : (_tmp242_label3 = g_quark_from_static_string ("b")))) {
											switch (0) {
												default:
												{
													xmlAttr* _tmp259_;
													...
													gint _tmp263_;
													_tmp259_ = xmlattr;
													_tmp260_ = _tmp259_->children;
													_tmp261_ = _tmp260_->content;
													_tmp262_ = atoi (_tmp261_);
													self->backgroundBlue = _tmp262_;
													_tmp263_ = self->backgroundBlue;
													self->backgroundBlueF = ((gdouble) _tmp263_) / 255.0;
													break;
												}
											}
										}
					...
					{
						{
							...
							PinDef* _tmp268_;
							_tmp264_ = xmlnode;
							_tmp265_ = pin_def_new_load (_tmp264_);
							pinDef = _tmp265_;
							_tmp266_ = pinDefs;
							_tmp266__length1 = pinDefs_length1;
							_tmp267_ = pinDef;
							_tmp268_ = _pin_def_ref0 (_tmp267_);
							_vala_array_add32 (&pinDefs, &pinDefs_length1, &_pinDefs_size_, _tmp268_);
	...
	xmlFreeDoc (_tmp269_);
	_tmp270_ = pinDefs;
	_tmp270__length1 = pinDefs_length1;
	_tmp271_ = (_tmp270_ != NULL) ? _vala_array_dup5 (_tmp270_, _tmp270__length1) : ((gpointer) _tmp270_);
	_tmp271__length1 = _tmp270__length1;
	self->pinDefs = (_vala_array_free (self->pinDefs, self->pinDefs_length1, (GDestroyNotify) pin_def_unref), NULL);
	self->pinDefs = _tmp271_;
	self->pinDefs_length1 = _tmp271__length1;
	pinDefs = (_vala_array_free (pinDefs, pinDefs_length1, (GDestroyNotify) pin_def_unref), NULL);
	return;
}
