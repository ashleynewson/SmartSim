/* timingdiagram.c generated by valac 0.16.0, the Vala compiler
...
static gboolean _timing_diagram_hide_diagram_gtk_widget_delete_event (GtkWidget* _sender, GdkEvent* event, gpointer self);
...
static void __lambda22_ (TimingDiagram* self);
static void ___lambda22__gtk_menu_item_activate (GtkMenuItem* _sender, gpointer self);
static void __lambda23_ (TimingDiagram* self);
...
static void __lambda24_ (TimingDiagram* self, GtkCheckMenuItem* menuItem);
static void ___lambda24__gtk_check_menu_item_toggled (GtkCheckMenuItem* _sender, gpointer self);
static void __lambda25_ (TimingDiagram* self, GtkCheckMenuItem* menuItem);
...
static void ___lambda27__gtk_tool_button_clicked (GtkToolButton* _sender, gpointer self);
static void __lambda28_ (TimingDiagram* self);
static void ___lambda28__gtk_tool_button_clicked (GtkToolButton* _sender, gpointer self);
static void __lambda29_ (TimingDiagram* self);
static void ___lambda29__gtk_tool_button_clicked (GtkToolButton* _sender, gpointer self);
...
static gboolean __lambda32_ (TimingDiagram* self);
static gboolean ___lambda32__gtk_widget_expose_event (GtkWidget* _sender, GdkEventExpose* event, gpointer self);
static gboolean __lambda33_ (TimingDiagram* self);
static gboolean ___lambda33__gtk_widget_configure_event (GtkWidget* _sender, GdkEventConfigure* event, gpointer self);
...
static void _vala_array_add78 (WireState*** array, int* length, int* size, WireState* value);
...
static void _vala_array_add81 (WireState*** array, int* length, int* size, WireState* value);
static void _vala_array_add82 (gchar*** array, int* length, int* size, gchar* value);
void wire_state_stop_recording (WireState* self);
static WireState** _vala_array_dup44 (WireState** self, int length);
static gchar** _vala_array_dup45 (gchar** self, int length);
static void timing_diagram_move_wire (TimingDiagram* self, gint fromNumber, gint toNumber);
static void _vala_array_add83 (WireState*** array, int* length, int* size, WireState* value);
static void _vala_array_add84 (gchar*** array, int* length, int* size, gchar* value);
static void _vala_array_add85 (WireState*** array, int* length, int* size, WireState* value);
static void _vala_array_add86 (gchar*** array, int* length, int* size, gchar* value);
static void _vala_array_add87 (WireState*** array, int* length, int* size, WireState* value);
static void _vala_array_add88 (gchar*** array, int* length, int* size, gchar* value);
static WireState** _vala_array_dup46 (WireState** self, int length);
static gchar** _vala_array_dup47 (gchar** self, int length);
...
static void __lambda25_ (TimingDiagram* self, GtkCheckMenuItem* menuItem) {
	...
	timing_diagram_render (self, TRUE);
}


static void ___lambda25__gtk_check_menu_item_toggled (GtkCheckMenuItem* _sender, gpointer self) {
	__lambda25_ (self, _sender);
}
...
void timing_diagram_populate (TimingDiagram* self) {
	...
	GtkMenuItem* _tmp71_;
	GtkMenu* _tmp72_;
	GtkCheckMenuItem* _tmp73_;
	GtkCheckMenuItem* _tmp74_;
	GtkMenu* _tmp75_;
	GtkCheckMenuItem* _tmp76_;
	GtkCheckMenuItem* _tmp77_;
	GtkCheckMenuItem* _tmp78_;
	GtkSeparatorMenuItem* _tmp79_;
	GtkMenuItem* _tmp80_;
	GtkMenu* _tmp81_;
	GtkMenuItem* _tmp82_;
	GtkCheckMenuItem* _tmp83_;
	GtkCheckMenuItem* _tmp84_;
	GtkMenu* _tmp85_;
	GtkCheckMenuItem* _tmp86_;
	GtkCheckMenuItem* _tmp87_;
	...
	GtkSeparatorToolItem* _tmp127_;
	GtkToolbar* _tmp128_;
	GtkSeparatorToolItem* _tmp129_;
	GtkImage* _tmp130_;
	GtkImage* _tmp131_;
	...
	GtkImage* _tmp137_;
	GtkToolbar* _tmp138_;
	GtkRadioToolButton* _tmp139_;
	GtkRadioToolButton* _tmp140_;
	GtkRadioToolButton* _tmp141_;
	GtkImage* _tmp142_;
	GtkImage* _tmp143_;
	GtkRadioToolButton* _tmp144_;
	GtkRadioToolButton* _tmp145_;
	GtkRadioToolButton* _tmp146_;
	GtkRadioToolButton* _tmp147_;
	GtkRadioToolButton* _tmp148_;
	GtkImage* _tmp149_;
	GtkToolbar* _tmp150_;
	GtkRadioToolButton* _tmp151_;
	GtkRadioToolButton* _tmp152_;
	GtkRadioToolButton* _tmp153_;
	GtkImage* _tmp154_;
	GtkImage* _tmp155_;
	GtkRadioToolButton* _tmp156_;
	GtkRadioToolButton* _tmp157_;
	GtkRadioToolButton* _tmp158_;
	GtkRadioToolButton* _tmp159_;
	GtkRadioToolButton* _tmp160_;
	GtkImage* _tmp161_;
	GtkToolbar* _tmp162_;
	GtkRadioToolButton* _tmp163_;
	GtkRadioToolButton* _tmp164_;
	GtkRadioToolButton* _tmp165_;
	GtkEventBox* _tmp166_;
	GtkEventBox* _tmp167_;
	GtkVBox* _tmp168_;
	GtkEventBox* _tmp169_;
	GtkEventBox* _tmp170_;
	GtkEventBox* _tmp171_;
	GtkEventBox* _tmp172_;
	GtkEventBox* _tmp173_;
	GtkDrawingArea* _tmp174_;
	GtkDrawingArea* _tmp175_;
	GtkEventBox* _tmp176_;
	GtkDrawingArea* _tmp177_;
	GtkDrawingArea* _tmp178_;
	GtkDrawingArea* _tmp179_;
	...
	_tmp20_ = (GtkMenuItem*) gtk_menu_item_new_with_label ("Export");
	_tmp21_ = g_object_ref_sink (_tmp20_);
	_g_object_unref0 (self->priv->menuFileExport);
	self->priv->menuFileExport = _tmp21_;
	_tmp22_ = self->priv->menuFileMenu;
	_tmp23_ = self->priv->menuFileExport;
	...
	self->priv->menuFileExportMenu = _tmp25_;
	_tmp26_ = self->priv->menuFileExport;
	_tmp27_ = self->priv->menuFileExportMenu;
	gtk_menu_item_set_submenu (_tmp26_, (GtkWidget*) _tmp27_);
	_tmp28_ = (GtkMenuItem*) gtk_menu_item_new_with_label ("Diagram Image as PNG Image");
	_tmp29_ = g_object_ref_sink (_tmp28_);
	_g_object_unref0 (self->priv->menuFileExportPng);
	self->priv->menuFileExportPng = _tmp29_;
	_tmp30_ = self->priv->menuFileExportMenu;
	_tmp31_ = self->priv->menuFileExportPng;
	gtk_menu_shell_append ((GtkMenuShell*) _tmp30_, (GtkWidget*) _tmp31_);
	_tmp32_ = self->priv->menuFileExportPng;
	g_signal_connect_object (_tmp32_, "activate", (GCallback) _timing_diagram_export_png_gtk_menu_item_activate, self, 0);
	_tmp33_ = (GtkMenuItem*) gtk_menu_item_new_with_label ("Diagram Image as PDF Document");
	_tmp34_ = g_object_ref_sink (_tmp33_);
	_g_object_unref0 (self->priv->menuFileExportPdf);
	self->priv->menuFileExportPdf = _tmp34_;
	_tmp35_ = self->priv->menuFileExportMenu;
	_tmp36_ = self->priv->menuFileExportPdf;
	gtk_menu_shell_append ((GtkMenuShell*) _tmp35_, (GtkWidget*) _tmp36_);
	_tmp37_ = self->priv->menuFileExportPdf;
	g_signal_connect_object (_tmp37_, "activate", (GCallback) _timing_diagram_export_pdf_gtk_menu_item_activate, self, 0);
	_tmp38_ = (GtkMenuItem*) gtk_menu_item_new_with_label ("Diagram Image as SVG Image");
	_tmp39_ = g_object_ref_sink (_tmp38_);
	_g_object_unref0 (self->priv->menuFileExportSvg);
	self->priv->menuFileExportSvg = _tmp39_;
	_tmp40_ = self->priv->menuFileExportMenu;
	_tmp41_ = self->priv->menuFileExportSvg;
	gtk_menu_shell_append ((GtkMenuShell*) _tmp40_, (GtkWidget*) _tmp41_);
	_tmp42_ = self->priv->menuFileExportSvg;
	g_signal_connect_object (_tmp42_, "activate", (GCallback) _timing_diagram_export_svg_gtk_menu_item_activate, self, 0);
	_tmp43_ = (GtkSeparatorMenuItem*) gtk_separator_menu_item_new ();
	_tmp44_ = (GtkMenuItem*) g_object_ref_sink (_tmp43_);
	_g_object_unref0 (self->priv->menuFileSeparator1);
	self->priv->menuFileSeparator1 = _tmp44_;
	_tmp45_ = self->priv->menuFileMenu;
	_tmp46_ = self->priv->menuFileSeparator1;
	gtk_menu_shell_append ((GtkMenuShell*) _tmp45_, (GtkWidget*) _tmp46_);
	_tmp47_ = (GtkMenuItem*) gtk_menu_item_new_with_label ("Close Timing Diagram");
	_tmp48_ = g_object_ref_sink (_tmp47_);
	_g_object_unref0 (self->priv->menuFileExit);
	self->priv->menuFileExit = _tmp48_;
	_tmp49_ = self->priv->menuFileMenu;
	_tmp50_ = self->priv->menuFileExit;
	gtk_menu_shell_append ((GtkMenuShell*) _tmp49_, (GtkWidget*) _tmp50_);
	_tmp51_ = self->priv->menuFileExit;
	g_signal_connect_object (_tmp51_, "activate", (GCallback) ___lambda22__gtk_menu_item_activate, self, 0);
	_tmp52_ = (GtkMenuItem*) gtk_menu_item_new_with_label ("Recording");
	_tmp53_ = g_object_ref_sink (_tmp52_);
	_g_object_unref0 (self->priv->menuRecording);
	self->priv->menuRecording = _tmp53_;
	_tmp54_ = self->priv->menubar;
	_tmp55_ = self->priv->menuRecording;
	gtk_menu_shell_append ((GtkMenuShell*) _tmp54_, (GtkWidget*) _tmp55_);
	_tmp56_ = (GtkMenu*) gtk_menu_new ();
	_tmp57_ = g_object_ref_sink (_tmp56_);
	_g_object_unref0 (self->priv->menuRecordingMenu);
	self->priv->menuRecordingMenu = _tmp57_;
	_tmp58_ = self->priv->menuRecording;
	_tmp59_ = self->priv->menuRecordingMenu;
	gtk_menu_item_set_submenu (_tmp58_, (GtkWidget*) _tmp59_);
	_tmp60_ = (GtkMenuItem*) gtk_menu_item_new_with_label ("Reset");
	_tmp61_ = g_object_ref_sink (_tmp60_);
	_g_object_unref0 (self->priv->menuRecordingReset);
	self->priv->menuRecordingReset = _tmp61_;
	_tmp62_ = self->priv->menuRecordingMenu;
	_tmp63_ = self->priv->menuRecordingReset;
	gtk_menu_shell_append ((GtkMenuShell*) _tmp62_, (GtkWidget*) _tmp63_);
	_tmp64_ = self->priv->menuRecordingReset;
	g_signal_connect_object (_tmp64_, "activate", (GCallback) ___lambda23__gtk_menu_item_activate, self, 0);
	_tmp65_ = (GtkMenuItem*) gtk_menu_item_new_with_label ("View");
	_tmp66_ = g_object_ref_sink (_tmp65_);
	_g_object_unref0 (self->priv->menuView);
	self->priv->menuView = _tmp66_;
	_tmp67_ = self->priv->menubar;
	_tmp68_ = self->priv->menuView;
	gtk_menu_shell_append ((GtkMenuShell*) _tmp67_, (GtkWidget*) _tmp68_);
	_tmp69_ = (GtkMenu*) gtk_menu_new ();
	_tmp70_ = g_object_ref_sink (_tmp69_);
	_g_object_unref0 (self->priv->menuViewMenu);
	self->priv->menuViewMenu = _tmp70_;
	_tmp71_ = self->priv->menuView;
	_tmp72_ = self->priv->menuViewMenu;
	gtk_menu_item_set_submenu (_tmp71_, (GtkWidget*) _tmp72_);
	_tmp73_ = (GtkCheckMenuItem*) gtk_check_menu_item_new_with_label ("Always On Top");
	_tmp74_ = g_object_ref_sink (_tmp73_);
	_g_object_unref0 (self->priv->menuViewAlwaysontop);
	self->priv->menuViewAlwaysontop = _tmp74_;
	_tmp75_ = self->priv->menuViewMenu;
	_tmp76_ = self->priv->menuViewAlwaysontop;
	gtk_menu_shell_append ((GtkMenuShell*) _tmp75_, (GtkWidget*) ((GtkMenuItem*) _tmp76_));
	_tmp77_ = self->priv->menuViewAlwaysontop;
	gtk_check_menu_item_set_active (_tmp77_, TRUE);
	_tmp78_ = self->priv->menuViewAlwaysontop;
	g_signal_connect_object (_tmp78_, "toggled", (GCallback) ___lambda24__gtk_check_menu_item_toggled, self, 0);
	_tmp79_ = (GtkSeparatorMenuItem*) gtk_separator_menu_item_new ();
	_tmp80_ = (GtkMenuItem*) g_object_ref_sink (_tmp79_);
	_g_object_unref0 (self->priv->menuViewSeparator1);
	self->priv->menuViewSeparator1 = _tmp80_;
	_tmp81_ = self->priv->menuViewMenu;
	_tmp82_ = self->priv->menuViewSeparator1;
	gtk_menu_shell_append ((GtkMenuShell*) _tmp81_, (GtkWidget*) _tmp82_);
	_tmp83_ = (GtkCheckMenuItem*) gtk_check_menu_item_new_with_label ("Show Grid");
	_tmp84_ = g_object_ref_sink (_tmp83_);
	_g_object_unref0 (self->priv->menuViewShowgrid);
	self->priv->menuViewShowgrid = _tmp84_;
	_tmp85_ = self->priv->menuViewMenu;
	_tmp86_ = self->priv->menuViewShowgrid;
	gtk_menu_shell_append ((GtkMenuShell*) _tmp85_, (GtkWidget*) ((GtkMenuItem*) _tmp86_));
	_tmp87_ = self->priv->menuViewShowgrid;
	gtk_check_menu_item_set_active (_tmp87_, TRUE);
	_tmp88_ = self->priv->menuViewShowgrid;
	g_signal_connect_object (_tmp88_, "toggled", (GCallback) ___lambda25__gtk_check_menu_item_toggled, self, 0);
	_tmp89_ = (GtkSeparatorMenuItem*) gtk_separator_menu_item_new ();
	_tmp90_ = (GtkMenuItem*) g_object_ref_sink (_tmp89_);
	_g_object_unref0 (self->priv->menuViewSeparator2);
	self->priv->menuViewSeparator2 = _tmp90_;
	_tmp91_ = self->priv->menuViewMenu;
	_tmp92_ = self->priv->menuViewSeparator2;
	gtk_menu_shell_append ((GtkMenuShell*) _tmp91_, (GtkWidget*) _tmp92_);
	_tmp93_ = (GtkMenuItem*) gtk_menu_item_new_with_label ("Reset View");
	_tmp94_ = g_object_ref_sink (_tmp93_);
	_g_object_unref0 (self->priv->menuViewReset);
	self->priv->menuViewReset = _tmp94_;
	_tmp95_ = self->priv->menuViewMenu;
	_tmp96_ = self->priv->menuViewReset;
	gtk_menu_shell_append ((GtkMenuShell*) _tmp95_, (GtkWidget*) _tmp96_);
	_tmp97_ = self->priv->menuViewReset;
	g_signal_connect_object (_tmp97_, "activate", (GCallback) ___lambda26__gtk_menu_item_activate, self, 0);
	_tmp98_ = (GtkToolbar*) gtk_toolbar_new ();
	_tmp99_ = g_object_ref_sink (_tmp98_);
	_g_object_unref0 (self->priv->toolbar);
	self->priv->toolbar = _tmp99_;
	_tmp100_ = self->priv->toolbar;
	g_object_set (_tmp100_, "toolbar-style", GTK_TOOLBAR_ICONS, NULL);
	_tmp101_ = self->priv->vBox;
	_tmp102_ = self->priv->toolbar;
	gtk_box_pack_start ((GtkBox*) _tmp101_, (GtkWidget*) _tmp102_, FALSE, TRUE, (guint) 0);
	_tmp103_ = (GtkImage*) gtk_image_new_from_file (PACKAGE_DATADIR "images/toolbar/scroll.png");
	_tmp104_ = g_object_ref_sink (_tmp103_);
	_g_object_unref0 (self->priv->toolScrollImage);
	self->priv->toolScrollImage = _tmp104_;
	_tmp105_ = (GtkRadioToolButton*) gtk_radio_tool_button_new (NULL);
	_tmp106_ = g_object_ref_sink (_tmp105_);
	_g_object_unref0 (self->priv->toolScroll);
	self->priv->toolScroll = _tmp106_;
	_tmp107_ = self->priv->toolScroll;
	gtk_tool_button_set_label ((GtkToolButton*) _tmp107_, "Scroll");
	_tmp108_ = self->priv->toolScroll;
	_tmp109_ = self->priv->toolScrollImage;
	gtk_tool_button_set_icon_widget ((GtkToolButton*) _tmp108_, (GtkWidget*) _tmp109_);
	_tmp110_ = self->priv->toolbar;
	_tmp111_ = self->priv->toolScroll;
	gtk_toolbar_insert (_tmp110_, (GtkToolItem*) _tmp111_, -1);
	_tmp112_ = self->priv->toolScroll;
	gtk_tool_item_set_tooltip_text ((GtkToolItem*) _tmp112_, "Scroll: Move your view of the timing diagram with click and drag.");
	_tmp113_ = self->priv->toolScroll;
	g_signal_connect_object ((GtkToolButton*) _tmp113_, "clicked", (GCallback) ___lambda27__gtk_tool_button_clicked, self, 0);
	_tmp114_ = (GtkImage*) gtk_image_new_from_file (PACKAGE_DATADIR "images/toolbar/zoom.png");
	_tmp115_ = g_object_ref_sink (_tmp114_);
	_g_object_unref0 (self->priv->toolZoomImage);
	self->priv->toolZoomImage = _tmp115_;
	_tmp116_ = self->priv->toolScroll;
	_tmp117_ = (GtkRadioToolButton*) gtk_radio_tool_button_new_from_widget (_tmp116_);
	_tmp118_ = g_object_ref_sink (_tmp117_);
	_g_object_unref0 (self->priv->toolZoom);
	self->priv->toolZoom = _tmp118_;
	_tmp119_ = self->priv->toolZoom;
	gtk_tool_button_set_label ((GtkToolButton*) _tmp119_, "Zoom");
	_tmp120_ = self->priv->toolZoom;
	_tmp121_ = self->priv->toolZoomImage;
	gtk_tool_button_set_icon_widget ((GtkToolButton*) _tmp120_, (GtkWidget*) _tmp121_);
	_tmp122_ = self->priv->toolbar;
	_tmp123_ = self->priv->toolZoom;
	gtk_toolbar_insert (_tmp122_, (GtkToolItem*) _tmp123_, -1);
	_tmp124_ = self->priv->toolZoom;
	gtk_tool_item_set_tooltip_text ((GtkToolItem*) _tmp124_, "Zoom: Drag downward to stretch vertically, rightward to stretch horizo" \
"ntally.");
	_tmp125_ = self->priv->toolZoom;
	g_signal_connect_object ((GtkToolButton*) _tmp125_, "clicked", (GCallback) ___lambda28__gtk_tool_button_clicked, self, 0);
	_tmp126_ = (GtkSeparatorToolItem*) gtk_separator_tool_item_new ();
	_tmp127_ = g_object_ref_sink (_tmp126_);
	_g_object_unref0 (self->priv->toolSeparator1);
	self->priv->toolSeparator1 = _tmp127_;
	_tmp128_ = self->priv->toolbar;
	_tmp129_ = self->priv->toolSeparator1;
	gtk_toolbar_insert (_tmp128_, (GtkToolItem*) _tmp129_, -1);
	_tmp130_ = (GtkImage*) gtk_image_new_from_file (PACKAGE_DATADIR "images/toolbar/move.png");
	_tmp131_ = g_object_ref_sink (_tmp130_);
	_g_object_unref0 (self->priv->toolMoveImage);
	self->priv->toolMoveImage = _tmp131_;
	_tmp132_ = self->priv->toolScroll;
	_tmp133_ = (GtkRadioToolButton*) gtk_radio_tool_button_new_from_widget (_tmp132_);
	_tmp134_ = g_object_ref_sink (_tmp133_);
	_g_object_unref0 (self->priv->toolMove);
	self->priv->toolMove = _tmp134_;
	_tmp135_ = self->priv->toolMove;
	gtk_tool_button_set_label ((GtkToolButton*) _tmp135_, "Move");
	_tmp136_ = self->priv->toolMove;
	_tmp137_ = self->priv->toolMoveImage;
	gtk_tool_button_set_icon_widget ((GtkToolButton*) _tmp136_, (GtkWidget*) _tmp137_);
	_tmp138_ = self->priv->toolbar;
	_tmp139_ = self->priv->toolMove;
	gtk_toolbar_insert (_tmp138_, (GtkToolItem*) _tmp139_, -1);
	_tmp140_ = self->priv->toolMove;
	gtk_tool_item_set_tooltip_text ((GtkToolItem*) _tmp140_, "Move: Click and drag a trace to reorder it.");
	_tmp141_ = self->priv->toolMove;
	g_signal_connect_object ((GtkToolButton*) _tmp141_, "clicked", (GCallback) ___lambda29__gtk_tool_button_clicked, self, 0);
	_tmp142_ = (GtkImage*) gtk_image_new_from_file (PACKAGE_DATADIR "images/toolbar/delete.png");
	_tmp143_ = g_object_ref_sink (_tmp142_);
	_g_object_unref0 (self->priv->toolDeleteImage);
	self->priv->toolDeleteImage = _tmp143_;
	_tmp144_ = self->priv->toolScroll;
	_tmp145_ = (GtkRadioToolButton*) gtk_radio_tool_button_new_from_widget (_tmp144_);
	_tmp146_ = g_object_ref_sink (_tmp145_);
	_g_object_unref0 (self->priv->toolDelete);
	self->priv->toolDelete = _tmp146_;
	_tmp147_ = self->priv->toolDelete;
	gtk_tool_button_set_label ((GtkToolButton*) _tmp147_, "Delete");
	_tmp148_ = self->priv->toolDelete;
	_tmp149_ = self->priv->toolDeleteImage;
	gtk_tool_button_set_icon_widget ((GtkToolButton*) _tmp148_, (GtkWidget*) _tmp149_);
	_tmp150_ = self->priv->toolbar;
	_tmp151_ = self->priv->toolDelete;
	gtk_toolbar_insert (_tmp150_, (GtkToolItem*) _tmp151_, -1);
	_tmp152_ = self->priv->toolDelete;
	gtk_tool_item_set_tooltip_text ((GtkToolItem*) _tmp152_, "Delete: Click on a trace to delete it.");
	_tmp153_ = self->priv->toolDelete;
	g_signal_connect_object ((GtkToolButton*) _tmp153_, "clicked", (GCallback) ___lambda30__gtk_tool_button_clicked, self, 0);
	_tmp154_ = (GtkImage*) gtk_image_new_from_file (PACKAGE_DATADIR "images/toolbar/adjust.png");
	_tmp155_ = g_object_ref_sink (_tmp154_);
	_g_object_unref0 (self->priv->toolAdjustImage);
	self->priv->toolAdjustImage = _tmp155_;
	_tmp156_ = self->priv->toolScroll;
	_tmp157_ = (GtkRadioToolButton*) gtk_radio_tool_button_new_from_widget (_tmp156_);
	_tmp158_ = g_object_ref_sink (_tmp157_);
	_g_object_unref0 (self->priv->toolAdjust);
	self->priv->toolAdjust = _tmp158_;
	_tmp159_ = self->priv->toolAdjust;
	gtk_tool_button_set_label ((GtkToolButton*) _tmp159_, "Adjust");
	_tmp160_ = self->priv->toolAdjust;
	_tmp161_ = self->priv->toolAdjustImage;
	gtk_tool_button_set_icon_widget ((GtkToolButton*) _tmp160_, (GtkWidget*) _tmp161_);
	_tmp162_ = self->priv->toolbar;
	_tmp163_ = self->priv->toolAdjust;
	gtk_toolbar_insert (_tmp162_, (GtkToolItem*) _tmp163_, -1);
	_tmp164_ = self->priv->toolAdjust;
	gtk_tool_item_set_tooltip_text ((GtkToolItem*) _tmp164_, "Adjust: Click on a trace to change its properties.");
	_tmp165_ = self->priv->toolAdjust;
	g_signal_connect_object ((GtkToolButton*) _tmp165_, "clicked", (GCallback) ___lambda31__gtk_tool_button_clicked, self, 0);
	_tmp166_ = (GtkEventBox*) gtk_event_box_new ();
	_tmp167_ = g_object_ref_sink (_tmp166_);
	_g_object_unref0 (self->priv->controller);
	self->priv->controller = _tmp167_;
	_tmp168_ = self->priv->vBox;
	_tmp169_ = self->priv->controller;
	gtk_box_pack_start ((GtkBox*) _tmp168_, (GtkWidget*) _tmp169_, TRUE, TRUE, (guint) 0);
	_tmp170_ = self->priv->controller;
	g_signal_connect_object ((GtkWidget*) _tmp170_, "button-press-event", (GCallback) _timing_diagram_mouse_down_gtk_widget_button_press_event, self, 0);
	_tmp171_ = self->priv->controller;
	gtk_widget_set_events ((GtkWidget*) _tmp171_, (gint) GDK_POINTER_MOTION_MASK);
	_tmp172_ = self->priv->controller;
	g_signal_connect_object ((GtkWidget*) _tmp172_, "motion-notify-event", (GCallback) _timing_diagram_mouse_move_gtk_widget_motion_notify_event, self, 0);
	_tmp173_ = self->priv->controller;
	g_signal_connect_object ((GtkWidget*) _tmp173_, "button-release-event", (GCallback) _timing_diagram_mouse_up_gtk_widget_button_release_event, self, 0);
	_tmp174_ = (GtkDrawingArea*) gtk_drawing_area_new ();
	_tmp175_ = g_object_ref_sink (_tmp174_);
	_g_object_unref0 (self->priv->display);
	self->priv->display = _tmp175_;
	_tmp176_ = self->priv->controller;
	_tmp177_ = self->priv->display;
	gtk_container_add ((GtkContainer*) _tmp176_, (GtkWidget*) _tmp177_);
	_tmp178_ = self->priv->display;
	g_signal_connect_object ((GtkWidget*) _tmp178_, "expose-event", (GCallback) ___lambda32__gtk_widget_expose_event, self, 0);
	_tmp179_ = self->priv->display;
	g_signal_connect_object ((GtkWidget*) _tmp179_, "configure-event", (GCallback) ___lambda33__gtk_widget_configure_event, self, 0);
...
void timing_diagram_add_wire (TimingDiagram* self, WireState* newWireState) {
	...
	if (_tmp11_ == ((gint) GTK_RESPONSE_APPLY)) {
		...
		_vala_array_add78 (&self->priv->wireStates, &self->priv->wireStates_length1, &self->priv->_wireStates_size_, _tmp17_);
		_tmp18_ = label;
		if (g_strcmp0 (_tmp18_, "") == 0) {
			...
			_vala_array_add79 (&self->priv->labels, &self->priv->labels_length1, &self->priv->_labels_size_, _tmp23_);
			_g_free0 (_tmp22_);
		} else {
			gchar** _tmp24_;
			...
			_vala_array_add80 (&self->priv->labels, &self->priv->labels_length1, &self->priv->_labels_size_, _tmp26_);
		}
...
static void timing_diagram_forget_wire (TimingDiagram* self, gint wireNumber) {
		...
		i = 0;
		{
			...
			while (TRUE) {
				...
				if (_tmp7_ != _tmp8_) {
					...
					_vala_array_add81 (&newWireStates, &newWireStates_length1, &_newWireStates_size_, _tmp13_);
					_tmp14_ = newLabels;
					...
					_vala_array_add82 (&newLabels, &newLabels_length1, &_newLabels_size_, _tmp18_);
				} else {
					WireState** _tmp19_;
					gint _tmp19__length1;
					gint _tmp20_;
	...
	_tmp23_ = (_tmp22_ != NULL) ? _vala_array_dup44 (_tmp22_, _tmp22__length1) : ((gpointer) _tmp22_);
...
static void timing_diagram_move_wire (TimingDiagram* self, gint fromNumber, gint toNumber) {
	...
	if (_tmp11_) {
			...
			i = 0;
			{
				...
				while (TRUE) {
					...
					if (_tmp27_ == _tmp28_) {
						...
						_vala_array_add83 (&newWireStates, &newWireStates_length1, &_newWireStates_size_, _tmp31_);
						_tmp32_ = newLabels;
						_tmp32__length1 = newLabels_length1;
						_tmp33_ = movingLabel;
						_tmp34_ = g_strdup (_tmp33_);
						_vala_array_add84 (&newLabels, &newLabels_length1, &_newLabels_size_, _tmp34_);
						_tmp35_ = insertCount;
					...
					if (_tmp36_ != _tmp37_) {
						...
						_vala_array_add85 (&newWireStates, &newWireStates_length1, &_newWireStates_size_, _tmp42_);
						_tmp43_ = newLabels;
						...
						_vala_array_add86 (&newLabels, &newLabels_length1, &_newLabels_size_, _tmp47_);
						_tmp48_ = insertCount;
		...
		if (_tmp49_ == _tmp50_) {
			...
			_vala_array_add87 (&newWireStates, &newWireStates_length1, &_newWireStates_size_, _tmp53_);
			_tmp54_ = newLabels;
			_tmp54__length1 = newLabels_length1;
			_tmp55_ = movingLabel;
			_tmp56_ = g_strdup (_tmp55_);
			_vala_array_add88 (&newLabels, &newLabels_length1, &_newLabels_size_, _tmp56_);
			_tmp57_ = insertCount;
			insertCount = _tmp57_ + 1;
		}
		_tmp58_ = newWireStates;
		_tmp58__length1 = newWireStates_length1;
		_tmp59_ = (_tmp58_ != NULL) ? _vala_array_dup46 (_tmp58_, _tmp58__length1) : ((gpointer) _tmp58_);
		...
		_tmp61_ = (_tmp60_ != NULL) ? _vala_array_dup47 (_tmp60_, _tmp60__length1) : ((gpointer) _tmp60_);
...
static gboolean timing_diagram_mouse_move (TimingDiagram* self, GdkEventMotion* event) {
	...
	timing_diagram_render (self, FALSE);
	result = FALSE;
	return result;
}
...
gboolean timing_diagram_render (TimingDiagram* self, gboolean fullRefresh) {
	...
	_tmp9_ = ((GtkWidget*) _tmp8_)->window;
	_tmp10_ = gdk_cairo_create ((GdkDrawable*) _tmp9_);
	displayContext = _tmp10_;
	_tmp11_ = self->priv->largestLengthCache;
	if (_tmp11_ == 0) {
		fullRefresh = TRUE;
	}
	_tmp13_ = fullRefresh;
	if (_tmp13_) {
		...
		_tmp14_ = self->priv->offScreenSurface;
	...
	if (_tmp15_) {
		...
		_tmp20_ = cairo_surface_get_content (_tmp19_);
		_tmp21_ = width;
		_tmp22_ = height;
		_tmp23_ = cairo_surface_create_similar (_tmp17_, _tmp20_, _tmp21_, _tmp22_);
		offScreenSurface = _tmp23_;
		_tmp24_ = offScreenSurface;
		_tmp25_ = cairo_create (_tmp24_);
		context = _tmp25_;
		_tmp26_ = context;
		cairo_set_source_rgb (_tmp26_, (gdouble) 1, (gdouble) 1, (gdouble) 1);
		_tmp27_ = context;
		cairo_paint (_tmp27_);
		_tmp28_ = self->priv->diagramCache;
		if (_tmp28_ == NULL) {
			cairo_t* _tmp29_;
			...
			_tmp31_ = width;
			_tmp32_ = height;
			_tmp33_ = cairo_surface_create_similar (_tmp30_, CAIRO_CONTENT_COLOR_ALPHA, _tmp31_, _tmp32_);
			_cairo_surface_destroy0 (self->priv->diagramCache);
			self->priv->diagramCache = _tmp33_;
			_tmp34_ = self->priv->diagramCache;
			_tmp35_ = cairo_create (_tmp34_);
			cacheContext = _tmp35_;
			_tmp36_ = cacheContext;
			cairo_set_operator (_tmp36_, CAIRO_OPERATOR_SOURCE);
			_tmp37_ = cacheContext;
			cairo_set_source_rgba (_tmp37_, (gdouble) 0, (gdouble) 0, (gdouble) 0, (gdouble) 0);
			...
			_tmp41_ = width;
			timing_diagram_render_labels (self, _tmp40_, TRUE, _tmp41_, &_tmp42_);
			largestLength = _tmp42_;
			_tmp43_ = cacheContext;
			_tmp44_ = width;
			_tmp45_ = height;
			_tmp46_ = largestLength;
			timing_diagram_render_ruler (self, _tmp43_, TRUE, _tmp44_, _tmp45_, _tmp46_);
			_tmp47_ = largestLength;
			self->priv->largestLengthCache = _tmp47_;
			_cairo_destroy0 (cacheContext);
		} else {
			gint _tmp48_;
			_tmp48_ = self->priv->largestLengthCache;
			largestLength = _tmp48_;
		}
		_tmp49_ = context;
		_tmp50_ = width;
		_tmp51_ = largestLength;
		timing_diagram_render_graphs (self, _tmp49_, TRUE, _tmp50_, _tmp51_);
		_tmp52_ = context;
		_tmp53_ = height;
		_tmp54_ = largestLength;
		timing_diagram_render_bar (self, _tmp52_, _tmp53_, _tmp54_);
		_tmp55_ = context;
		_tmp56_ = self->priv->diagramCache;
		cairo_set_source_surface (_tmp55_, _tmp56_, (gdouble) 0, (gdouble) 0);
		_tmp57_ = context;
		cairo_paint (_tmp57_);
		_tmp58_ = displayContext;
		_tmp59_ = offScreenSurface;
		...
		cairo_t* _tmp97_;
		_tmp61_ = self->priv->offScreenSurface;
		_tmp62_ = cairo_create (_tmp61_);
		context = _tmp62_;
		_tmp63_ = context;
		cairo_set_source_rgb (_tmp63_, (gdouble) 1, (gdouble) 1, (gdouble) 1);
		_tmp64_ = context;
		cairo_paint (_tmp64_);
		_tmp65_ = self->priv->diagramCache;
		if (_tmp65_ == NULL) {
			cairo_t* _tmp66_;
			...
			gint _tmp84_;
			_tmp66_ = context;
			_tmp67_ = cairo_get_target (_tmp66_);
			_tmp68_ = width;
			_tmp69_ = height;
			_tmp70_ = cairo_surface_create_similar (_tmp67_, CAIRO_CONTENT_COLOR_ALPHA, _tmp68_, _tmp69_);
			_cairo_surface_destroy0 (self->priv->diagramCache);
			self->priv->diagramCache = _tmp70_;
			_tmp71_ = self->priv->diagramCache;
			_tmp72_ = cairo_create (_tmp71_);
			cacheContext = _tmp72_;
			_tmp73_ = cacheContext;
			cairo_set_operator (_tmp73_, CAIRO_OPERATOR_SOURCE);
			_tmp74_ = cacheContext;
			cairo_set_source_rgba (_tmp74_, (gdouble) 0, (gdouble) 0, (gdouble) 0, (gdouble) 0);
			_tmp75_ = cacheContext;
			cairo_paint (_tmp75_);
			_tmp76_ = cacheContext;
			cairo_set_operator (_tmp76_, CAIRO_OPERATOR_OVER);
			_tmp77_ = cacheContext;
			_tmp78_ = width;
			timing_diagram_render_labels (self, _tmp77_, FALSE, _tmp78_, &_tmp79_);
			largestLength = _tmp79_;
			_tmp80_ = cacheContext;
			_tmp81_ = width;
			_tmp82_ = height;
			_tmp83_ = largestLength;
			timing_diagram_render_ruler (self, _tmp80_, FALSE, _tmp81_, _tmp82_, _tmp83_);
			_tmp84_ = largestLength;
			self->priv->largestLengthCache = _tmp84_;
			_cairo_destroy0 (cacheContext);
		} else {
			gint _tmp85_;
			_tmp85_ = self->priv->largestLengthCache;
			largestLength = _tmp85_;
		}
		_tmp86_ = context;
		_tmp87_ = width;
		_tmp88_ = largestLength;
		timing_diagram_render_graphs (self, _tmp86_, FALSE, _tmp87_, _tmp88_);
		_tmp89_ = context;
		_tmp90_ = height;
		_tmp91_ = largestLength;
		timing_diagram_render_bar (self, _tmp89_, _tmp90_, _tmp91_);
		_tmp92_ = context;
		_tmp93_ = self->priv->diagramCache;
		cairo_set_source_surface (_tmp92_, _tmp93_, (gdouble) 0, (gdouble) 0);
		_tmp94_ = context;
		cairo_paint (_tmp94_);
		_tmp95_ = displayContext;
		_tmp96_ = self->priv->offScreenSurface;
