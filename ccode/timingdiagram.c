		...
		i = 0;
		{
			...
			while (TRUE) {
				...
				if (_tmp7_ != _tmp8_) {
					...
					_vala_array_add117 (&newWireStates, &newWireStates_length1, &_newWireStates_size_, _tmp13_);
					_tmp14_ = newLabels;
					...
					_vala_array_add118 (&newLabels, &newLabels_length1, &_newLabels_size_, _tmp18_);
				} else {
					WireState** _tmp19_;
					gint _tmp19__length1;
					gint _tmp20_;
...
static void timing_diagram_move_wire (TimingDiagram* self, gint fromNumber, gint toNumber) {
	...
	if (_tmp11_) {
			...
			i = 0;
			{
				...
				while (TRUE) {
					...
					if (_tmp27_ == _tmp28_) {
						...
						_vala_array_add119 (&newWireStates, &newWireStates_length1, &_newWireStates_size_, _tmp31_);
						_tmp32_ = newLabels;
						_tmp32__length1 = newLabels_length1;
						_tmp33_ = movingLabel;
						_tmp34_ = g_strdup (_tmp33_);
						_vala_array_add120 (&newLabels, &newLabels_length1, &_newLabels_size_, _tmp34_);
						_tmp35_ = insertCount;
					...
					if (_tmp36_ != _tmp37_) {
						...
						_vala_array_add121 (&newWireStates, &newWireStates_length1, &_newWireStates_size_, _tmp42_);
						_tmp43_ = newLabels;
						...
						_vala_array_add122 (&newLabels, &newLabels_length1, &_newLabels_size_, _tmp47_);
						_tmp48_ = insertCount;
		...
		if (_tmp49_ == _tmp50_) {
			...
			_vala_array_add123 (&newWireStates, &newWireStates_length1, &_newWireStates_size_, _tmp53_);
			_tmp54_ = newLabels;
			_tmp54__length1 = newLabels_length1;
			_tmp55_ = movingLabel;
			_tmp56_ = g_strdup (_tmp55_);
			_vala_array_add124 (&newLabels, &newLabels_length1, &_newLabels_size_, _tmp56_);
			_tmp57_ = insertCount;
