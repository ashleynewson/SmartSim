/* project.c generated by valac 0.16.0, the Vala compiler
...
static void _vala_array_add25 (Project*** array, int* length, int* size, Project* value);
void project_unregister (Project* project);
static void _vala_array_add26 (Project*** array, int* length, int* size, Project* value);
static Project** _vala_array_dup7 (Project** self, int length);
void project_clean_up (void);
gboolean designer_window_project_has_windows (Project* project);
static void _vala_array_add27 (Project*** array, int* length, int* size, Project* value);
gint project_destroy_all_windows (Project* self);
static Project** _vala_array_dup8 (Project** self, int length);
...
static CustomComponentDef** _vala_array_dup9 (CustomComponentDef** self, int length);
static void _vala_array_add28 (CustomComponentDef*** array, int* length, int* size, CustomComponentDef* value);
static CustomComponentDef** _vala_array_dup10 (CustomComponentDef** self, int length);
...
static CustomComponentDef** _vala_array_dup11 (CustomComponentDef** self, int length);
static void _vala_array_add29 (CustomComponentDef*** array, int* length, int* size, CustomComponentDef* value);
static CustomComponentDef** _vala_array_dup12 (CustomComponentDef** self, int length);
...
static void _vala_array_add30 (CustomComponentDef*** array, int* length, int* size, CustomComponentDef* value);
...
static void _vala_array_add31 (CustomComponentDef*** array, int* length, int* size, CustomComponentDef* value);
static void _vala_array_add32 (CustomComponentDef*** array, int* length, int* size, CustomComponentDef* value);
void custom_component_def_remove_immediate_dependency (CustomComponentDef* self, CustomComponentDef* removeComponent);
static void _vala_array_add33 (CustomComponentDef*** array, int* length, int* size, CustomComponentDef* value);
static CustomComponentDef** _vala_array_dup13 (CustomComponentDef** self, int length);
...
CustomComponentDef** project_component_users (Project* self, CustomComponentDef* usedComponent, int* result_length1);
static void _vala_array_add34 (CustomComponentDef*** array, int* length, int* size, CustomComponentDef* value);
static CustomComponentDef** _vala_array_dup14 (CustomComponentDef** self, int length);
static void _vala_array_add35 (CustomComponentDef*** array, int* length, int* size, CustomComponentDef* value);
...
static void _vala_array_add38 (Designer*** array, int* length, int* size, Designer* value);
void project_unregister_designer (Project* self, Designer* designer);
static void _vala_array_add39 (Designer*** array, int* length, int* size, Designer* value);
static Designer** _vala_array_dup15 (Designer** self, int length);
...
void project_register (Project* project) {
	...
	_vala_array_add25 (&project_projects, &project_projects_length1, &_project_projects_size_, _tmp3_);
	_tmp4_ = project;
...
void project_unregister (Project* project) {
		...
		i = 0;
		{
			...
			while (TRUE) {
				...
				if (_tmp8_ != _tmp9_) {
					...
					_vala_array_add26 (&tempArray, &tempArray_length1, &_tempArray_size_, _tmp18_);
					_tmp19_ = newID;
					newID = _tmp19_ + 1;
				}
			}
	...
	_tmp21_ = (_tmp20_ != NULL) ? _vala_array_dup7 (_tmp20_, _tmp20__length1) : ((gpointer) _tmp20_);
...
void project_clean_up (void) {
		...
		for (project_it = 0; project_it < _tmp1__length1; project_it = project_it + 1) {
			...
			project = _tmp2_;
			{
				...
				if (_tmp4_) {
					...
					_vala_array_add27 (&newProjects, &newProjects_length1, &_newProjects_size_, _tmp7_);
					_tmp8_ = project;
					_tmp9_ = newID;
					_tmp8_->myID = _tmp9_;
					_tmp10_ = newID;
	...
	_tmp16_ = (_tmp15_ != NULL) ? _vala_array_dup8 (_tmp15_, _tmp15__length1) : ((gpointer) _tmp15_);
...
CustomComponentDef* project_new_component (Project* self) {
	...
	_tmp13_ = (_tmp12_ != NULL) ? _vala_array_dup9 (_tmp12_, _tmp12__length1) : ((gpointer) _tmp12_);
	...
	_vala_array_add28 (&newCustomComponentDefs, &newCustomComponentDefs_length1, &_newCustomComponentDefs_size_, _tmp16_);
	_tmp17_ = newCustomComponentDefs;
	_tmp17__length1 = newCustomComponentDefs_length1;
	_tmp18_ = (_tmp17_ != NULL) ? _vala_array_dup10 (_tmp17_, _tmp17__length1) : ((gpointer) _tmp17_);
...
CustomComponentDef* project_load_component (Project* self, const gchar* fileName) {
	...
	g_return_val_if_fail (fileName != NULL, NULL);
	{
		...
		if (_inner_error_ != NULL) {
			if (_inner_error_->domain == COMPONENT_DEF_LOAD_ERROR) {
				goto __catch5_component_def_load_error;
			}
			if (_inner_error_->domain == CUSTOM_COMPONENT_DEF_LOAD_ERROR) {
				goto __catch5_custom_component_def_load_error;
			}
		...
		_tmp4_ = (_tmp3_ != NULL) ? _vala_array_dup11 (_tmp3_, _tmp3__length1) : ((gpointer) _tmp3_);
		...
		_vala_array_add29 (&newCustomComponentDefs, &newCustomComponentDefs_length1, &_newCustomComponentDefs_size_, _tmp7_);
	...
	goto __finally5;
	__catch5_component_def_load_error:
	{
		GError* _error_ = NULL;
		GError* _tmp10_;
		const gchar* _tmp11_;
	...
	goto __finally5;
	__catch5_custom_component_def_load_error:
	{
		GError* _error_ = NULL;
		GError* _tmp14_;
		const gchar* _tmp15_;
...
"ircuit.");
	...
	if (_tmp7_) {
		...
		_tmp15_ = _tmp14_;
		basic_dialog_error (NULL, _tmp15_);
		_g_free0 (_tmp15_);
		_g_free0 (_tmp13_);
	...
	if (_tmp18_) {
		...
		_tmp26_ = _tmp25_;
		basic_dialog_error (NULL, _tmp26_);
		_g_free0 (_tmp26_);
		_g_free0 (_tmp24_);
		project_update_error_modes (self, FALSE);
	}
	...
	_tmp34_ = _tmp27_;
	if (_tmp34_) {
		basic_dialog_error (NULL, "Circuit has passed validation without any errors or warnings.");
		project_update_error_modes (self, FALSE);
	}
...
"ircuit.");
	...
	simulatorWindow = _tmp41_;
	_tmp42_ = stdout;
	fprintf (_tmp42_, "Running Circuit...\n");
	self->running = TRUE;
	_tmp43_ = startNow;
	if (*_tmp43_) {
		SimulatorWindow* _tmp44_;
		_tmp44_ = simulatorWindow;
		simulator_window_run (_tmp44_);
	}
	result = compiledCircuit;
...
void project_save_component_list (Project* self, xmlTextWriter* xmlWriter) {
	...
	_tmp2__length1 = self->customComponentDefs_length1;
	{
		...
		for (customComponentDef_it = 0; customComponentDef_it < _tmp2__length1; customComponentDef_it = customComponentDef_it + 1) {
			...
			customComponentDef = _tmp3_;
			{
				...
				CustomComponentDef* _tmp7_;
				_tmp4_ = customComponentDef;
				custom_component_def_update_immediate_dependencies (_tmp4_);
				_tmp5_ = unsavedComponents;
				_tmp5__length1 = unsavedComponents_length1;
				_tmp6_ = customComponentDef;
				_tmp7_ = _component_def_ref0 (_tmp6_);
				_vala_array_add30 (&unsavedComponents, &unsavedComponents_length1, &_unsavedComponents_size_, _tmp7_);
				_component_def_unref0 (customComponentDef);
			}
		}
	}
	...
	while (TRUE) {
			...
			for (customComponentDef_it = 0; customComponentDef_it < _tmp10__length1; customComponentDef_it = customComponentDef_it + 1) {
				...
				customComponentDef = _tmp11_;
				{
					...
					if (_tmp13__length1 == 0) {
						...
						_tmp16_ = _component_def_ref0 (_tmp15_);
						_vala_array_add31 (&saveLoadOrder, &saveLoadOrder_length1, &_saveLoadOrder_size_, _tmp16_);
						_tmp17_ = justAdded;
						_tmp17__length1 = justAdded_length1;
						_tmp18_ = customComponentDef;
						_tmp19_ = _component_def_ref0 (_tmp18_);
						_vala_array_add32 (&justAdded, &justAdded_length1, &_justAdded_size_, _tmp19_);
						stillWorking = TRUE;
					}
					_component_def_unref0 (customComponentDef);
				}
			...
			for (customComponentDef_it = 0; customComponentDef_it < _tmp21__length1; customComponentDef_it = customComponentDef_it + 1) {
				...
				customComponentDef = _tmp22_;
				{
					...
					_tmp23__length1 = justAdded_length1;
					{
						...
						for (removeComponent_it = 0; removeComponent_it < _tmp23__length1; removeComponent_it = removeComponent_it + 1) {
							...
							removeComponent = _tmp24_;
							{
								...
								custom_component_def_remove_immediate_dependency (_tmp25_, _tmp26_);
					...
					if (!_vala_custom_component_def_array_contains (_tmp28_, _tmp28__length1, _tmp27_)) {
						...
						_vala_array_add33 (&newUnsavedComponents, &newUnsavedComponents_length1, &_newUnsavedComponents_size_, _tmp31_);
					}
					_component_def_unref0 (customComponentDef);
				}
			}
		...
		_tmp33_ = (_tmp32_ != NULL) ? _vala_array_dup13 (_tmp32_, _tmp32__length1) : ((gpointer) _tmp32_);
	...
	_tmp34_ = saveLoadOrder;
	_tmp34__length1 = saveLoadOrder_length1;
	{
		CustomComponentDef** customComponentDef_collection = NULL;
		gint customComponentDef_collection_length1 = 0;
		gint _customComponentDef_collection_size_ = 0;
		gint customComponentDef_it = 0;
		customComponentDef_collection = _tmp34_;
		customComponentDef_collection_length1 = _tmp34__length1;
		for (customComponentDef_it = 0; customComponentDef_it < _tmp34__length1; customComponentDef_it = customComponentDef_it + 1) {
			CustomComponentDef* _tmp35_;
			CustomComponentDef* customComponentDef = NULL;
			_tmp35_ = _component_def_ref0 (customComponentDef_collection[customComponentDef_it]);
			customComponentDef = _tmp35_;
			{
				...
				xmlTextWriter* _tmp52_;
				_tmp36_ = xmlWriter;
				xmlTextWriterStartElement (_tmp36_, "component");
				_tmp37_ = customComponentDef;
				_tmp38_ = self->rootComponent;
				if (_tmp37_ == _tmp38_) {
					xmlTextWriter* _tmp39_;
					_tmp39_ = xmlWriter;
					xmlTextWriterWriteAttribute (_tmp39_, "root", "true");
				}
				_tmp40_ = stdout;
				_tmp41_ = customComponentDef;
				_tmp42_ = ((ComponentDef*) _tmp41_)->filename;
				_tmp43_ = customComponentDef;
				_tmp44_ = ((ComponentDef*) _tmp43_)->filename;
				_tmp45_ = project_relative_filename (self, _tmp44_);
				_tmp46_ = _tmp45_;
				fprintf (_tmp40_, "Relative path of file \"%s\" is \"%s\"\n", _tmp42_, _tmp46_);
				_g_free0 (_tmp46_);
				_tmp47_ = xmlWriter;
				_tmp48_ = customComponentDef;
				_tmp49_ = ((ComponentDef*) _tmp48_)->filename;
				_tmp50_ = project_relative_filename (self, _tmp49_);
				_tmp51_ = _tmp50_;
				xmlTextWriterWriteString (_tmp47_, _tmp51_);
				_g_free0 (_tmp51_);
				_tmp52_ = xmlWriter;
				xmlTextWriterEndElement (_tmp52_);
				_component_def_unref0 (customComponentDef);
			}
		}
	}
...
gint project_remove_component (Project* self, CustomComponentDef* removeComponent) {
	...
	_tmp2_ = project_component_users (self, _tmp0_, &_tmp1_);
	...
	if (_tmp3__length1 > 0) {
		...
		_tmp15_ = usersString;
		_tmp16_ = (GtkMessageDialog*) gtk_message_dialog_new (NULL, GTK_DIALOG_MODAL, GTK_MESSAGE_ERROR, GTK_BUTTONS_OK, "You cannot remove this component from your project because it is used " \
"within one or more other components:\n" \
"%s", _tmp15_);
		_tmp17_ = g_object_ref_sink (_tmp16_);
		messageDialog = _tmp17_;
		_tmp18_ = messageDialog;
		gtk_dialog_run ((GtkDialog*) _tmp18_);
		_tmp19_ = messageDialog;
		gtk_object_destroy ((GtkObject*) _tmp19_);
		_tmp20_ = usersString;
		_tmp21_ = g_strconcat ("You cannot remove this component from your project because it is used " \
"within one or more other components:", _tmp20_, NULL);
		_tmp22_ = _tmp21_;
		basic_dialog_information (NULL, _tmp22_);
		_g_free0 (_tmp22_);
		result = 2;
	...
	_tmp23_ = g_new0 (CustomComponentDef*, 0 + 1);
	newCustomComponentDefs = _tmp23_;
	newCustomComponentDefs_length1 = 0;
	_newCustomComponentDefs_size_ = newCustomComponentDefs_length1;
	_tmp24_ = self->customComponentDefs;
	_tmp24__length1 = self->customComponentDefs_length1;
	{
		CustomComponentDef** customComponentDef_collection = NULL;
		gint customComponentDef_collection_length1 = 0;
		gint _customComponentDef_collection_size_ = 0;
		gint customComponentDef_it = 0;
		customComponentDef_collection = _tmp24_;
		customComponentDef_collection_length1 = _tmp24__length1;
		for (customComponentDef_it = 0; customComponentDef_it < _tmp24__length1; customComponentDef_it = customComponentDef_it + 1) {
			CustomComponentDef* _tmp25_;
			CustomComponentDef* customComponentDef = NULL;
			_tmp25_ = _component_def_ref0 (customComponentDef_collection[customComponentDef_it]);
			customComponentDef = _tmp25_;
			{
				CustomComponentDef* _tmp26_;
				CustomComponentDef* _tmp27_;
				_tmp26_ = customComponentDef;
				_tmp27_ = removeComponent;
				if (_tmp26_ == _tmp27_) {
					_result_ = 0;
				} else {
					CustomComponentDef** _tmp28_;
					...
					CustomComponentDef* _tmp29_;
					CustomComponentDef* _tmp30_;
					_tmp28_ = newCustomComponentDefs;
					_tmp28__length1 = newCustomComponentDefs_length1;
					_tmp29_ = customComponentDef;
					_tmp30_ = _component_def_ref0 (_tmp29_);
					_vala_array_add34 (&newCustomComponentDefs, &newCustomComponentDefs_length1, &_newCustomComponentDefs_size_, _tmp30_);
				}
				_component_def_unref0 (customComponentDef);
			}
		}
	}
	_tmp31_ = newCustomComponentDefs;
	_tmp31__length1 = newCustomComponentDefs_length1;
	_tmp32_ = (_tmp31_ != NULL) ? _vala_array_dup14 (_tmp31_, _tmp31__length1) : ((gpointer) _tmp31_);
	_tmp32__length1 = _tmp31__length1;
	self->customComponentDefs = (_vala_array_free (self->customComponentDefs, self->customComponentDefs_length1, (GDestroyNotify) component_def_unref), NULL);
	self->customComponentDefs = _tmp32_;
	self->customComponentDefs_length1 = _tmp32__length1;
	_tmp33_ = removeComponent;
	_tmp34_ = self->rootComponent;
	if (_tmp33_ == _tmp34_) {
		_component_def_unref0 (self->rootComponent);
	...
	_tmp1__length1 = self->customComponentDefs_length1;
	{
		...
		for (customComponentDef_it = 0; customComponentDef_it < _tmp1__length1; customComponentDef_it = customComponentDef_it + 1) {
			...
			customComponentDef = _tmp2_;
			{
				...
				gint _tmp6__length1;
				_tmp3_ = customComponentDef;
				custom_component_def_update_immediate_dependencies (_tmp3_);
				...
				if (_vala_custom_component_def_array_contains (_tmp6_, _tmp6__length1, _tmp4_)) {
					CustomComponentDef** _tmp7_;
					gint _tmp7__length1;
					CustomComponentDef* _tmp8_;
					CustomComponentDef* _tmp9_;
					...
					_vala_array_add35 (&userList, &userList_length1, &_userList_size_, _tmp9_);
				}
				_component_def_unref0 (customComponentDef);
			}
		}
...
gchar* project_relative_filename (Project* self, const gchar* rawTargetFilename) {
	...
	while (TRUE) {
		...
		if (_tmp15_ == (-1)) {
			...
			_vala_array_add36 (&projectDirectories, &projectDirectories_length1, &_projectDirectories_size_, _tmp20_);
		}
	}
	startIndex = 0;
	endIndex = 0;
	while (TRUE) {
		...
		if (_tmp25_ == (-1)) {
			...
			_vala_array_add37 (&targetDirectories, &targetDirectories_length1, &_targetDirectories_size_, _tmp30_);
		}
	}
	{
		gboolean _tmp31_;
...
void project_register_designer (Project* self, Designer* designer) {
	...
	_vala_array_add38 (&self->priv->designers, &self->priv->designers_length1, &self->priv->_designers_size_, _tmp3_);
	_tmp4_ = designer;
	_tmp4_->myID = position;
	_tmp5_ = stdout;
...
void project_unregister_designer (Project* self, Designer* designer) {
		...
		i = 0;
		{
			...
			while (TRUE) {
				...
				if (_tmp8_ != _tmp9_) {
					...
					_vala_array_add39 (&tempArray, &tempArray_length1, &_tempArray_size_, _tmp18_);
					_tmp19_ = newID;
					newID = _tmp19_ + 1;
				}
			}
	...
	_tmp20_ = tempArray;
	_tmp20__length1 = tempArray_length1;
	_tmp21_ = (_tmp20_ != NULL) ? _vala_array_dup15 (_tmp20_, _tmp20__length1) : ((gpointer) _tmp20_);
	_tmp21__length1 = _tmp20__length1;
