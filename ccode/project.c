...
static void _vala_array_add67 (Project*** array, int* length, int* size, Project* value);
...
static void _vala_array_add72 (PluginComponentDef*** array, int* length, int* size, PluginComponentDef* value);
static void _vala_array_add73 (PluginComponentManager*** array, int* length, int* size, PluginComponentManager* value);
...
static void _vala_array_add81 (PluginComponentDef*** array, int* length, int* size, PluginComponentDef* value);
static void _vala_array_add82 (PluginComponentManager*** array, int* length, int* size, PluginComponentManager* value);
...
static void _vala_array_add83 (CustomComponentDef*** array, int* length, int* size, CustomComponentDef* value);
...
static void _vala_array_add84 (Designer*** array, int* length, int* size, Designer* value);
...
void project_register (Project* project) {
	...
	_vala_array_add67 (&project_projects, &project_projects_length1, &_project_projects_size_, _tmp3_);
	_tmp4_ = project;
		...
		i = 0;
		{
			...
			while (TRUE) {
				...
				if (_tmp8_ != _tmp9_) {
					...
					_vala_array_add68 (&tempArray, &tempArray_length1, &_tempArray_size_, _tmp18_);
					_tmp19_ = newID;
					newID = _tmp19_ + 1;
				}
			}
		...
		for (project_it = 0; project_it < _tmp1__length1; project_it = project_it + 1) {
			...
			project = _tmp2_;
			{
				...
				if (_tmp4_) {
					...
					_vala_array_add69 (&newProjects, &newProjects_length1, &_newProjects_size_, _tmp7_);
					_tmp8_ = project;
					_tmp9_ = newID;
					_tmp8_->myID = _tmp9_;
					_tmp10_ = newID;
...
CustomComponentDef* project_new_component (Project* self) {
	...
	_vala_array_add70 (&newCustomComponentDefs, &newCustomComponentDefs_length1, &_newCustomComponentDefs_size_, _tmp16_);
...
CustomComponentDef* project_load_component (Project* self, const gchar* fileName) {
	...
	g_return_val_if_fail (fileName != NULL, NULL);
	{
		...
		_vala_array_add71 (&newCustomComponentDefs, &newCustomComponentDefs_length1, &_newCustomComponentDefs_size_, _tmp7_);
...
PluginComponentDef* project_load_plugin_component (Project* self, const gchar* filename, const gchar* altFilename) {
	...
	if (_tmp18_ != NULL) {
		...
		_vala_array_add72 (&newPluginComponentDefs, &newPluginComponentDefs_length1, &_newPluginComponentDefs_size_, _tmp28_);
		...
		_vala_array_add73 (&newPluginComponentManagers, &newPluginComponentManagers_length1, &_newPluginComponentManagers_size_, _tmp31_);
	...
	}
	{
		...
		_vala_array_add74 (&newPluginComponentDefs, &newPluginComponentDefs_length1, &_newPluginComponentDefs_size_, _tmp48_);
		...
		_vala_array_add75 (&newPluginComponentManagers, &newPluginComponentManagers_length1, &_newPluginComponentManagers_size_, _tmp51_);
	...
	_tmp2__length1 = self->customComponentDefs_length1;
	{
		...
		for (customComponentDef_it = 0; customComponentDef_it < _tmp2__length1; customComponentDef_it = customComponentDef_it + 1) {
			...
			customComponentDef = _tmp3_;
			{
				...
				_tmp7_ = _component_def_ref0 (_tmp6_);
				_vala_array_add76 (&unsavedComponents, &unsavedComponents_length1, &_unsavedComponents_size_, _tmp7_);
				_component_def_unref0 (customComponentDef);
			}
		}
	}
			...
			for (customComponentDef_it = 0; customComponentDef_it < _tmp10__length1; customComponentDef_it = customComponentDef_it + 1) {
				...
				customComponentDef = _tmp11_;
				{
					...
					if (_tmp13__length1 == 0) {
						...
						_tmp16_ = _component_def_ref0 (_tmp15_);
						_vala_array_add77 (&saveLoadOrder, &saveLoadOrder_length1, &_saveLoadOrder_size_, _tmp16_);
						_tmp17_ = justAdded;
						_tmp17__length1 = justAdded_length1;
						_tmp18_ = customComponentDef;
						_tmp19_ = _component_def_ref0 (_tmp18_);
						_vala_array_add78 (&justAdded, &justAdded_length1, &_justAdded_size_, _tmp19_);
						stillWorking = TRUE;
					}
					_component_def_unref0 (customComponentDef);
				}
			...
			for (customComponentDef_it = 0; customComponentDef_it < _tmp21__length1; customComponentDef_it = customComponentDef_it + 1) {
				...
				customComponentDef = _tmp22_;
				{
					...
					if (!_vala_custom_component_def_array_contains (_tmp28_, _tmp28__length1, _tmp27_)) {
						...
						_vala_array_add79 (&newUnsavedComponents, &newUnsavedComponents_length1, &_newUnsavedComponents_size_, _tmp31_);
					}
					_component_def_unref0 (customComponentDef);
				}
			}
	...
	_tmp34__length1 = self->pluginComponentManagers_length1;
	{
		...
		for (pluginComponentManager_it = 0; pluginComponentManager_it < _tmp34__length1; pluginComponentManager_it = pluginComponentManager_it + 1) {
			...
			pluginComponentManager = _tmp35_;
			{
				...
				_tmp48_ = _tmp47_;
				xmlTextWriterWriteString (_tmp44_, _tmp48_);
				_g_free0 (_tmp48_);
				_tmp49_ = xmlWriter;
	...
	_tmp50__length1 = saveLoadOrder_length1;
	{
		...
		for (customComponentDef_it = 0; customComponentDef_it < _tmp50__length1; customComponentDef_it = customComponentDef_it + 1) {
			...
			customComponentDef = _tmp51_;
			{
				...
				const gchar* _tmp58_;
				CustomComponentDef* _tmp59_;
				const gchar* _tmp60_;
				gchar* _tmp61_ = NULL;
				gchar* _tmp62_;
				xmlTextWriter* _tmp63_;
				CustomComponentDef* _tmp64_;
				const gchar* _tmp65_;
				gchar* _tmp66_ = NULL;
				gchar* _tmp67_;
				xmlTextWriter* _tmp68_;
				_tmp52_ = xmlWriter;
				xmlTextWriterStartElement (_tmp52_, "component");
				_tmp53_ = customComponentDef;
				_tmp54_ = self->rootComponent;
				if (_tmp53_ == _tmp54_) {
					xmlTextWriter* _tmp55_;
					_tmp55_ = xmlWriter;
					xmlTextWriterWriteAttribute (_tmp55_, "root", "true");
				}
				_tmp56_ = stdout;
				...
				_tmp67_ = _tmp66_;
				xmlTextWriterWriteString (_tmp63_, _tmp67_);
				_g_free0 (_tmp67_);
				_tmp68_ = xmlWriter;
		...
		for (customComponentDef_it = 0; customComponentDef_it < _tmp19__length1; customComponentDef_it = customComponentDef_it + 1) {
			...
			customComponentDef = _tmp20_;
			{
				...
				if (_tmp21_ == _tmp22_) {
					...
					_vala_array_add80 (&newCustomComponentDefs, &newCustomComponentDefs_length1, &_newCustomComponentDefs_size_, _tmp25_);
				}
				_component_def_unref0 (customComponentDef);
			}
		}
		...
		for (pluginComponentDef_it = 0; pluginComponentDef_it < _tmp19__length1; pluginComponentDef_it = pluginComponentDef_it + 1) {
			...
			pluginComponentDef = _tmp20_;
			{
				...
				if (_tmp21_ == _tmp22_) {
					...
					_tmp25_ = _component_def_ref0 (_tmp24_);
					_vala_array_add81 (&newPluginComponentDefs, &newPluginComponentDefs_length1, &_newPluginComponentDefs_size_, _tmp25_);
				}
		...
		for (pluginComponentManager_it = 0; pluginComponentManager_it < _tmp27__length1; pluginComponentManager_it = pluginComponentManager_it + 1) {
			...
			pluginComponentManager = _tmp28_;
			{
				...
				if (_tmp30_ == _tmp31_) {
					...
					_vala_array_add82 (&newPluginComponentManagers, &newPluginComponentManagers_length1, &_newPluginComponentManagers_size_, _tmp34_);
				}
				_plugin_component_manager_unref0 (pluginComponentManager);
			}
		}
		...
		for (customComponentDef_it = 0; customComponentDef_it < _tmp1__length1; customComponentDef_it = customComponentDef_it + 1) {
			...
			customComponentDef = _tmp2_;
			{
				...
				if (_vala_component_def_array_contains (_tmp6_, _tmp6__length1, _tmp4_)) {
					...
					_vala_array_add83 (&userList, &userList_length1, &_userList_size_, _tmp9_);
				}
				_component_def_unref0 (customComponentDef);
			}
		}
...
void project_register_designer (Project* self, Designer* designer) {
	...
	_vala_array_add84 (&self->priv->designers, &self->priv->designers_length1, &self->priv->_designers_size_, _tmp3_);
	_tmp4_ = designer;
	_tmp4_->myID = position;
	_tmp5_ = stdout;
		...
		i = 0;
		{
			...
			while (TRUE) {
				...
				if (_tmp8_ != _tmp9_) {
					...
					_vala_array_add85 (&tempArray, &tempArray_length1, &_tempArray_size_, _tmp18_);
					_tmp19_ = newID;
					newID = _tmp19_ + 1;
				}
			}
