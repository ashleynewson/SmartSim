/* project.c generated by valac 0.18.1, the Vala compiler
...
static void _vala_array_add59 (Project*** array, int* length, int* size, Project* value);
...
static void _vala_array_add62 (CustomComponentDef*** array, int* length, int* size, CustomComponentDef* value);
...
static void _vala_array_add64 (PluginComponentDef*** array, int* length, int* size, PluginComponentDef* value);
static void _vala_array_add65 (PluginComponentManager*** array, int* length, int* size, PluginComponentManager* value);
...
static void _vala_array_add66 (PluginComponentDef*** array, int* length, int* size, PluginComponentDef* value);
...
static void _vala_array_add76 (gchar*** array, int* length, int* size, gchar* value);
static void _vala_array_add77 (gchar*** array, int* length, int* size, gchar* value);
static void _vala_array_add78 (Designer*** array, int* length, int* size, Designer* value);
...
void project_register (Project* project) {
	...
	_vala_array_add59 (&project_projects, &project_projects_length1, &_project_projects_size_, _tmp3_);
	_tmp4_ = project;
		...
		i = 0;
		{
			...
			while (TRUE) {
				...
				if (_tmp8_ != _tmp9_) {
					...
					_vala_array_add60 (&tempArray, &tempArray_length1, &_tempArray_size_, _tmp18_);
					_tmp19_ = newID;
					newID = _tmp19_ + 1;
				}
			}
		...
		for (project_it = 0; project_it < _tmp1__length1; project_it = project_it + 1) {
			...
			project = _tmp2_;
			{
				...
				if (_tmp4_) {
					...
					_vala_array_add61 (&newProjects, &newProjects_length1, &_newProjects_size_, _tmp7_);
					_tmp8_ = project;
					_tmp9_ = newID;
					_tmp8_->myID = _tmp9_;
					_tmp10_ = newID;
...
CustomComponentDef* project_new_component (Project* self) {
	...
	_vala_array_add62 (&newCustomComponentDefs, &newCustomComponentDefs_length1, &_newCustomComponentDefs_size_, _tmp16_);
...
CustomComponentDef* project_load_component (Project* self, const gchar* fileName) {
	...
	g_return_val_if_fail (fileName != NULL, NULL);
	{
		...
		_vala_array_add63 (&newCustomComponentDefs, &newCustomComponentDefs_length1, &_newCustomComponentDefs_size_, _tmp7_);
...
PluginComponentDef* project_load_plugin_component (Project* self, const gchar* filename, const gchar* altFilename) {
	...
	_tmp18_ = stdout;
	_tmp19_ = newManager;
	fprintf (_tmp18_, "CHECK %p\n", (void*) _tmp19_);
	_tmp20_ = newManager;
	if (_tmp20_ != NULL) {
		PluginComponentManager* _tmp21_;
		...
		PluginComponentManager** _tmp26_;
		...
		PluginComponentDef* _tmp29_;
		PluginComponentDef* _tmp30_;
		PluginComponentManager** _tmp31_;
		gint _tmp31__length1;
		PluginComponentManager* _tmp32_;
		PluginComponentManager* _tmp33_;
		PluginComponentDef** _tmp34_;
		gint _tmp34__length1;
		PluginComponentDef** _tmp35_;
		gint _tmp35__length1;
		PluginComponentManager** _tmp36_;
		gint _tmp36__length1;
		PluginComponentManager** _tmp37_;
		gint _tmp37__length1;
		_tmp21_ = newManager;
		_tmp22_ = _tmp21_->pluginComponentDef;
		_tmp23_ = _component_def_ref0 (_tmp22_);
		_component_def_unref0 (newComponent);
		newComponent = _tmp23_;
		_tmp24_ = self->pluginComponentDefs;
		_tmp24__length1 = self->pluginComponentDefs_length1;
		_tmp25_ = (_tmp24_ != NULL) ? _vala_array_dup60 (_tmp24_, _tmp24__length1) : ((gpointer) _tmp24_);
		_tmp25__length1 = _tmp24__length1;
		newPluginComponentDefs = _tmp25_;
		newPluginComponentDefs_length1 = _tmp25__length1;
		_newPluginComponentDefs_size_ = newPluginComponentDefs_length1;
		_tmp26_ = self->pluginComponentManagers;
		_tmp26__length1 = self->pluginComponentManagers_length1;
		_tmp27_ = (_tmp26_ != NULL) ? _vala_array_dup61 (_tmp26_, _tmp26__length1) : ((gpointer) _tmp26_);
		_tmp27__length1 = _tmp26__length1;
		newPluginComponentManagers = _tmp27_;
		newPluginComponentManagers_length1 = _tmp27__length1;
		_newPluginComponentManagers_size_ = newPluginComponentManagers_length1;
		_tmp28_ = newPluginComponentDefs;
		_tmp28__length1 = newPluginComponentDefs_length1;
		_tmp29_ = newComponent;
		_tmp30_ = _component_def_ref0 (_tmp29_);
		_vala_array_add64 (&newPluginComponentDefs, &newPluginComponentDefs_length1, &_newPluginComponentDefs_size_, _tmp30_);
		_tmp31_ = newPluginComponentManagers;
		_tmp31__length1 = newPluginComponentManagers_length1;
		_tmp32_ = newManager;
		_tmp33_ = _plugin_component_manager_ref0 (_tmp32_);
		_vala_array_add65 (&newPluginComponentManagers, &newPluginComponentManagers_length1, &_newPluginComponentManagers_size_, _tmp33_);
		_tmp34_ = newPluginComponentDefs;
		_tmp34__length1 = newPluginComponentDefs_length1;
		_tmp35_ = (_tmp34_ != NULL) ? _vala_array_dup62 (_tmp34_, _tmp34__length1) : ((gpointer) _tmp34_);
		...
		self->pluginComponentDefs = _tmp35_;
		self->pluginComponentDefs_length1 = _tmp35__length1;
		_tmp36_ = newPluginComponentManagers;
		_tmp36__length1 = newPluginComponentManagers_length1;
		_tmp37_ = (_tmp36_ != NULL) ? _vala_array_dup63 (_tmp36_, _tmp36__length1) : ((gpointer) _tmp36_);
		...
		self->pluginComponentManagers = _tmp37_;
		self->pluginComponentManagers_length1 = _tmp37__length1;
		project_update_plugin_menus (self);
		result = newComponent;
	...
	}
	{
		...
		PluginComponentManager* _tmp40_;
		PluginComponentManager* _tmp41_;
		PluginComponentDef* _tmp42_;
		PluginComponentDef* _tmp43_;
		PluginComponentDef** _tmp44_;
		gint _tmp44__length1;
		PluginComponentDef** _tmp45_;
		gint _tmp45__length1;
		PluginComponentDef** newPluginComponentDefs;
		gint newPluginComponentDefs_length1;
		gint _newPluginComponentDefs_size_;
		PluginComponentManager** _tmp46_;
		gint _tmp46__length1;
		PluginComponentManager** _tmp47_;
		...
		PluginComponentDef* _tmp49_;
		PluginComponentDef* _tmp50_;
		PluginComponentManager** _tmp51_;
		gint _tmp51__length1;
		PluginComponentManager* _tmp52_;
		PluginComponentManager* _tmp53_;
		PluginComponentDef** _tmp54_;
		gint _tmp54__length1;
		PluginComponentDef** _tmp55_;
		gint _tmp55__length1;
		PluginComponentManager** _tmp56_;
		gint _tmp56__length1;
		PluginComponentManager** _tmp57_;
		gint _tmp57__length1;
		_tmp38_ = filename;
		_tmp39_ = plugin_component_manager_new_from_file (_tmp38_, self, &_inner_error_);
		_tmp40_ = _tmp39_;
		if (_inner_error_ != NULL) {
			if (_inner_error_->domain == COMPONENT_DEF_LOAD_ERROR) {
		...
		newManager = _tmp40_;
		_tmp41_ = newManager;
		_tmp42_ = _tmp41_->pluginComponentDef;
		_tmp43_ = _component_def_ref0 (_tmp42_);
		_component_def_unref0 (newComponent);
		newComponent = _tmp43_;
		_tmp44_ = self->pluginComponentDefs;
		_tmp44__length1 = self->pluginComponentDefs_length1;
		_tmp45_ = (_tmp44_ != NULL) ? _vala_array_dup64 (_tmp44_, _tmp44__length1) : ((gpointer) _tmp44_);
		_tmp45__length1 = _tmp44__length1;
		newPluginComponentDefs = _tmp45_;
		newPluginComponentDefs_length1 = _tmp45__length1;
		_newPluginComponentDefs_size_ = newPluginComponentDefs_length1;
		_tmp46_ = self->pluginComponentManagers;
		_tmp46__length1 = self->pluginComponentManagers_length1;
		_tmp47_ = (_tmp46_ != NULL) ? _vala_array_dup65 (_tmp46_, _tmp46__length1) : ((gpointer) _tmp46_);
		_tmp47__length1 = _tmp46__length1;
		newPluginComponentManagers = _tmp47_;
		newPluginComponentManagers_length1 = _tmp47__length1;
		_newPluginComponentManagers_size_ = newPluginComponentManagers_length1;
		_tmp48_ = newPluginComponentDefs;
		_tmp48__length1 = newPluginComponentDefs_length1;
		_tmp49_ = newComponent;
		_tmp50_ = _component_def_ref0 (_tmp49_);
		_vala_array_add66 (&newPluginComponentDefs, &newPluginComponentDefs_length1, &_newPluginComponentDefs_size_, _tmp50_);
		_tmp51_ = newPluginComponentManagers;
		_tmp51__length1 = newPluginComponentManagers_length1;
		_tmp52_ = newManager;
		_tmp53_ = _plugin_component_manager_ref0 (_tmp52_);
		_vala_array_add67 (&newPluginComponentManagers, &newPluginComponentManagers_length1, &_newPluginComponentManagers_size_, _tmp53_);
		_tmp54_ = newPluginComponentDefs;
		_tmp54__length1 = newPluginComponentDefs_length1;
		_tmp55_ = (_tmp54_ != NULL) ? _vala_array_dup66 (_tmp54_, _tmp54__length1) : ((gpointer) _tmp54_);
		_tmp55__length1 = _tmp54__length1;
		self->pluginComponentDefs = (_vala_array_free (self->pluginComponentDefs, self->pluginComponentDefs_length1, (GDestroyNotify) component_def_unref), NULL);
		self->pluginComponentDefs = _tmp55_;
		self->pluginComponentDefs_length1 = _tmp55__length1;
		_tmp56_ = newPluginComponentManagers;
		_tmp56__length1 = newPluginComponentManagers_length1;
		_tmp57_ = (_tmp56_ != NULL) ? _vala_array_dup67 (_tmp56_, _tmp56__length1) : ((gpointer) _tmp56_);
		_tmp57__length1 = _tmp56__length1;
		self->pluginComponentManagers = (_vala_array_free (self->pluginComponentManagers, self->pluginComponentManagers_length1, (GDestroyNotify) plugin_component_manager_unref), NULL);
		self->pluginComponentManagers = _tmp57_;
		self->pluginComponentManagers_length1 = _tmp57__length1;
		project_update_plugin_menus (self);
		newPluginComponentManagers = (_vala_array_free (newPluginComponentManagers, newPluginComponentManagers_length1, (GDestroyNotify) plugin_component_manager_unref), NULL);
		newPluginComponentDefs = (_vala_array_free (newPluginComponentDefs, newPluginComponentDefs_length1, (GDestroyNotify) component_def_unref), NULL);
	}
	...
	__catch55_component_def_load_error:
	{
		...
		_inner_error_ = NULL;
		_tmp59_ = _error_;
		if (g_error_matches (_tmp59_, COMPONENT_DEF_LOAD_ERROR, COMPONENT_DEF_LOAD_ERROR_FILE)) {
			const gchar* _tmp60_;
			_tmp60_ = altFilename;
		...
		if (_tmp61_) {
			const gchar* _tmp62_;
			PluginComponentDef* _tmp63_ = NULL;
			PluginComponentDef* _tmp64_;
			_tmp62_ = altFilename;
			_tmp63_ = project_load_plugin_component (self, _tmp62_, NULL);
			_component_def_unref0 (newComponent);
			newComponent = _tmp63_;
			_tmp64_ = newComponent;
			if (_tmp64_ == NULL) {
				GError* _tmp65_;
				const gchar* _tmp66_;
				gchar* _tmp67_;
				...
				_tmp67_ = g_strconcat ("Could not load local plugin component: \n", _tmp66_, NULL);
				_tmp68_ = _tmp67_;
				basic_dialog_error (NULL, _tmp68_);
				_g_free0 (_tmp68_);
			}
		} else {
			GError* _tmp69_;
			...
			_tmp71_ = g_strconcat ("Could not load shared plugin component: \n", _tmp70_, NULL);
			_tmp72_ = _tmp71_;
			basic_dialog_error (NULL, _tmp72_);
			_g_free0 (_tmp72_);
		}
		_g_error_free0 (_error_);
	}
	...
	__catch55_plugin_component_def_load_error:
	{
		...
		if (_tmp73_ == NULL) {
			...
			_tmp76_ = g_strconcat ("Could not load shared plugin component: \n", _tmp75_, NULL);
			_tmp77_ = _tmp76_;
			basic_dialog_error (NULL, _tmp77_);
			_g_free0 (_tmp77_);
		} else {
			GError* _tmp78_;
			const gchar* _tmp79_;
			...
			_tmp80_ = g_strconcat ("Could not load local plugin component: \n", _tmp79_, NULL);
			_tmp81_ = _tmp80_;
			basic_dialog_error (NULL, _tmp81_);
			_g_free0 (_tmp81_);
		}
		_g_error_free0 (_error_);
	}
		...
		for (designer_it = 0; designer_it < _tmp0__length1; designer_it = designer_it + 1) {
			...
			designer = _tmp1_;
			{
				...
				if (_tmp3_ != NULL) {
					...
					_tmp4_ = designer;
					_tmp5_ = _tmp4_->window;
					designer_window_update_custom_menu (_tmp5_);
				}
				_designer_unref0 (designer);
			}
		}
		...
		for (designer_it = 0; designer_it < _tmp0__length1; designer_it = designer_it + 1) {
			...
			designer = _tmp1_;
			{
				...
				if (_tmp3_ != NULL) {
					...
					_tmp4_ = designer;
					_tmp5_ = _tmp4_->window;
					designer_window_update_plugin_menu (_tmp5_);
				}
				_designer_unref0 (designer);
			}
		}
	...
	_tmp2__length1 = self->customComponentDefs_length1;
	{
		...
		for (customComponentDef_it = 0; customComponentDef_it < _tmp2__length1; customComponentDef_it = customComponentDef_it + 1) {
			...
			customComponentDef = _tmp3_;
			{
				...
				_tmp7_ = _component_def_ref0 (_tmp6_);
				_vala_array_add68 (&unsavedComponents, &unsavedComponents_length1, &_unsavedComponents_size_, _tmp7_);
				_component_def_unref0 (customComponentDef);
			}
		}
	}
			...
			for (customComponentDef_it = 0; customComponentDef_it < _tmp10__length1; customComponentDef_it = customComponentDef_it + 1) {
				...
				customComponentDef = _tmp11_;
				{
					...
					if (_tmp13__length1 == 0) {
						...
						_tmp16_ = _component_def_ref0 (_tmp15_);
						_vala_array_add69 (&saveLoadOrder, &saveLoadOrder_length1, &_saveLoadOrder_size_, _tmp16_);
						_tmp17_ = justAdded;
						_tmp17__length1 = justAdded_length1;
						_tmp18_ = customComponentDef;
						_tmp19_ = _component_def_ref0 (_tmp18_);
						_vala_array_add70 (&justAdded, &justAdded_length1, &_justAdded_size_, _tmp19_);
						stillWorking = TRUE;
					}
					_component_def_unref0 (customComponentDef);
				}
			...
			for (customComponentDef_it = 0; customComponentDef_it < _tmp21__length1; customComponentDef_it = customComponentDef_it + 1) {
				...
				customComponentDef = _tmp22_;
				{
					...
					if (!_vala_custom_component_def_array_contains (_tmp28_, _tmp28__length1, _tmp27_)) {
						...
						_vala_array_add71 (&newUnsavedComponents, &newUnsavedComponents_length1, &_newUnsavedComponents_size_, _tmp31_);
					}
					_component_def_unref0 (customComponentDef);
				}
			}
		...
		for (customComponentDef_it = 0; customComponentDef_it < _tmp19__length1; customComponentDef_it = customComponentDef_it + 1) {
			...
			customComponentDef = _tmp20_;
			{
				...
				if (_tmp21_ == _tmp22_) {
					...
					_vala_array_add72 (&newCustomComponentDefs, &newCustomComponentDefs_length1, &_newCustomComponentDefs_size_, _tmp25_);
				}
				_component_def_unref0 (customComponentDef);
			}
		}
		...
		for (pluginComponentDef_it = 0; pluginComponentDef_it < _tmp19__length1; pluginComponentDef_it = pluginComponentDef_it + 1) {
			...
			pluginComponentDef = _tmp20_;
			{
				...
				if (_tmp21_ == _tmp22_) {
					...
					_tmp25_ = _component_def_ref0 (_tmp24_);
					_vala_array_add73 (&newPluginComponentDefs, &newPluginComponentDefs_length1, &_newPluginComponentDefs_size_, _tmp25_);
				}
		...
		for (pluginComponentManager_it = 0; pluginComponentManager_it < _tmp27__length1; pluginComponentManager_it = pluginComponentManager_it + 1) {
			...
			pluginComponentManager = _tmp28_;
			{
				...
				if (_tmp30_ == _tmp31_) {
					...
					_vala_array_add74 (&newPluginComponentManagers, &newPluginComponentManagers_length1, &_newPluginComponentManagers_size_, _tmp34_);
				}
				_plugin_component_manager_unref0 (pluginComponentManager);
			}
		}
		...
		for (customComponentDef_it = 0; customComponentDef_it < _tmp1__length1; customComponentDef_it = customComponentDef_it + 1) {
			...
			customComponentDef = _tmp2_;
			{
				...
				if (_vala_component_def_array_contains (_tmp6_, _tmp6__length1, _tmp4_)) {
					...
					_vala_array_add75 (&userList, &userList_length1, &_userList_size_, _tmp9_);
				}
				_component_def_unref0 (customComponentDef);
			}
		}
...
gchar* project_relative_filename (Project* self, const gchar* rawTargetFilename) {
	...
	while (TRUE) {
		...
		if (_tmp15_ == (-1)) {
			...
			_vala_array_add76 (&projectDirectories, &projectDirectories_length1, &_projectDirectories_size_, _tmp20_);
		}
	}
	startIndex = 0;
	endIndex = 0;
	while (TRUE) {
		...
		if (_tmp25_ == (-1)) {
			...
			_vala_array_add77 (&targetDirectories, &targetDirectories_length1, &_targetDirectories_size_, _tmp30_);
		}
	}
	{
		gboolean _tmp31_;
...
void project_register_designer (Project* self, Designer* designer) {
	...
	_vala_array_add78 (&self->priv->designers, &self->priv->designers_length1, &self->priv->_designers_size_, _tmp3_);
	_tmp4_ = designer;
	_tmp4_->myID = position;
	_tmp5_ = stdout;
		...
		i = 0;
		{
			...
			while (TRUE) {
				...
				if (_tmp8_ != _tmp9_) {
					...
					_vala_array_add79 (&tempArray, &tempArray_length1, &_tempArray_size_, _tmp18_);
					_tmp19_ = newID;
					newID = _tmp19_ + 1;
				}
			}
