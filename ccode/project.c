		...
		i = 0;
		{
			...
			while (TRUE) {
				...
				if (_tmp8_ != _tmp9_) {
					...
					_vala_array_add69 (&tempArray, &tempArray_length1, &_tempArray_size_, _tmp18_);
					_tmp19_ = newID;
					newID = _tmp19_ + 1;
				}
			}
...
CustomComponentDef* project_load_component (Project* self, const gchar* fileName) {
	...
	g_return_val_if_fail (fileName != NULL, NULL);
	{
		...
		_vala_array_add72 (&newCustomComponentDefs, &newCustomComponentDefs_length1, &_newCustomComponentDefs_size_, _tmp7_);
...
PluginComponentDef* project_load_plugin_component (Project* self, const gchar* filename, const gchar* altFilename) {
	...
	if (_tmp18_ != NULL) {
		...
		_vala_array_add73 (&newPluginComponentDefs, &newPluginComponentDefs_length1, &_newPluginComponentDefs_size_, _tmp28_);
		...
		_vala_array_add74 (&newPluginComponentManagers, &newPluginComponentManagers_length1, &_newPluginComponentManagers_size_, _tmp31_);
		...
		i = 0;
		{
			...
			while (TRUE) {
				...
				if (_tmp8_ != _tmp9_) {
					...
					_vala_array_add86 (&tempArray, &tempArray_length1, &_tempArray_size_, _tmp18_);
					_tmp19_ = newID;
					newID = _tmp19_ + 1;
				}
			}
