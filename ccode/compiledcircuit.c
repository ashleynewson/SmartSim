/* compiledcircuit.c generated by valac 0.16.0, the Vala compiler
...
static void _vala_array_add64 (ComponentState*** array, int* length, int* size, ComponentState* value);
...
static void _vala_array_add65 (WireState*** array, int* length, int* size, WireState* value);
void compiled_circuit_add_component (CompiledCircuit* self, ComponentState* componentState);
static void _vala_array_add66 (ComponentState*** array, int* length, int* size, ComponentState* value);
...
static void _vala_array_add67 (WireState*** array, int* length, int* size, WireState* value);
void compiled_circuit_remove_watch (CompiledCircuit* self, WireState* wireState);
static void _vala_array_add68 (WireState*** array, int* length, int* size, WireState* value);
static WireState** _vala_array_dup42 (WireState** self, int length);
...
static void _vala_array_add69 (ComponentInst*** array, int* length, int* size, ComponentInst* value);
static gint compiled_circuit_check_ancestry (CompiledCircuit* self, ComponentInst** ancestry, int ancestry_length1);
static void _vala_array_add70 (ComponentState*** array, int* length, int* size, ComponentState* value);
static void _vala_array_add71 (WireState*** array, int* length, int* size, WireState* value);
		...
		for (componentState_it = 0; componentState_it < _tmp6__length1; componentState_it = componentState_it + 1) {
			...
			componentState = _tmp7_;
			{
				...
				if (_tmp10_) {
					...
					_vala_array_add64 (&permanentComponentStates, &permanentComponentStates_length1, &_permanentComponentStates_size_, _tmp13_);
				}
...
WireState* compiled_circuit_compile_wire (CompiledCircuit* self, WireInst* wireInst, Connection** connections, int connections_length1, ComponentInst** ancestry, int ancestry_length1) {
	...
	_vala_array_add65 (&self->priv->wireStates, &self->priv->wireStates_length1, &self->priv->_wireStates_size_, _tmp52_);
	result = wireState;
	return result;
}
...
void compiled_circuit_add_component (CompiledCircuit* self, ComponentState* componentState) {
	...
	_vala_array_add66 (&self->priv->componentStates, &self->priv->componentStates_length1, &self->priv->_componentStates_size_, _tmp5_);
}
...
void compiled_circuit_add_watch (CompiledCircuit* self, WireState* wireState) {
	...
	if (!_vala_wire_state_array_contains (_tmp1_, _tmp1__length1, _tmp0_)) {
		...
		_vala_array_add67 (&self->priv->watchedWireStates, &self->priv->watchedWireStates_length1, &self->priv->_watchedWireStates_size_, _tmp4_);
	}
}
...
void compiled_circuit_remove_watch (CompiledCircuit* self, WireState* wireState) {
		...
		for (watchedWireState_it = 0; watchedWireState_it < _tmp1__length1; watchedWireState_it = watchedWireState_it + 1) {
			...
			watchedWireState = _tmp2_;
			{
				...
				if (_tmp3_ != _tmp4_) {
					...
					_vala_array_add68 (&newWatchedWireStates, &newWatchedWireStates_length1, &_newWatchedWireStates_size_, _tmp7_);
				}
	...
	_tmp9_ = (_tmp8_ != NULL) ? _vala_array_dup42 (_tmp8_, _tmp8__length1) : ((gpointer) _tmp8_);
...
gint compiled_circuit_expand_component (CompiledCircuit* self, gint x, gint y) {
	...
	if (_tmp4_ != NULL) {
		...
		if (IS_CUSTOM_COMPONENT_DEF (_tmp6_)) {
			...
			_vala_array_add69 (&self->priv->viewedAncestry, &self->priv->viewedAncestry_length1, &self->priv->_viewedAncestry_size_, _tmp9_);
			compiled_circuit_update_displayed (self);
			result = 0;
...
void compiled_circuit_update_displayed (CompiledCircuit* self) {
	...
	if (_tmp2__length1 > 0) {
		...
		_tmp6_ = _tmp5_->componentDef;
		_tmp7_ = _component_def_ref0 (CUSTOM_COMPONENT_DEF (_tmp6_));
		_component_def_unref0 (self->viewedComponent);
			...
			for (componentState_it = 0; componentState_it < _tmp10__length1; componentState_it = componentState_it + 1) {
				...
				componentState = _tmp11_;
				{
					...
					if (_tmp14_ == 1) {
						...
						_vala_array_add70 (&displayedComponentStates, &displayedComponentStates_length1, &_displayedComponentStates_size_, _tmp20_);
					} else {
			...
			for (wireState_it = 0; wireState_it < _tmp22__length1; wireState_it = wireState_it + 1) {
				...
				wireState = _tmp23_;
				{
					...
					if (_tmp26_ == 1) {
						...
						_vala_array_add71 (&displayedWireStates, &displayedWireStates_length1, &_displayedWireStates_size_, _tmp32_);
					} else {
						WireState* _tmp33_;
						_tmp33_ = wireState;
