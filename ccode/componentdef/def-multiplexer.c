/* def-multiplexer.c generated by valac 0.16.0, the Vala compiler
...
MultiplexerComponentDef* multiplexer_component_def_construct (GType object_type, GError** error) {
	...
	{
		self = (MultiplexerComponentDef*) component_def_construct_from_file (object_type, MULTIPLEXER_COMPONENT_DEF_infoFilename, &_inner_error_);
