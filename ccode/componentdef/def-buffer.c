/* def-buffer.c generated by valac 0.16.0, the Vala compiler
...
BufferComponentDef* buffer_component_def_construct (GType object_type, GError** error) {
	...
	{
		self = (BufferComponentDef*) component_def_construct_from_file (object_type, BUFFER_COMPONENT_DEF_infoFilename, &_inner_error_);
