/* def-clock.c generated by valac 0.16.0, the Vala compiler
...
ClockComponentDef* clock_component_def_construct (GType object_type, GError** error) {
	...
	{
		self = (ClockComponentDef*) component_def_construct_from_file (object_type, CLOCK_COMPONENT_DEF_infoFilename, &_inner_error_);
