/* def-and.c generated by valac 0.16.0, the Vala compiler
...
AndComponentDef* and_component_def_construct (GType object_type, GError** error) {
	...
	{
		self = (AndComponentDef*) component_def_construct_from_file (object_type, AND_COMPONENT_DEF_infoFilename, &_inner_error_);
