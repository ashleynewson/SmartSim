/* def-and.c generated by valac 0.20.1, the Vala compiler
...
static void and_component_def_real_compile_component (ComponentDef* base, CompiledCircuit* compiledCircuit, ComponentInst* componentInst, Connection** connections, int connections_length1, ComponentInst** ancestry, int ancestry_length1) {
	...
	_tmp51_ = and_component_state_new (_tmp47_, _tmp47__length1, _tmp48_, _tmp49_, _tmp49__length1, _tmp50_);
