/* def-tristate.c generated by valac 0.16.0, the Vala compiler
...
TristateComponentDef* tristate_component_def_construct (GType object_type, GError** error) {
	...
	{
		self = (TristateComponentDef*) component_def_construct_from_file (object_type, TRISTATE_COMPONENT_DEF_infoFilename, &_inner_error_);
