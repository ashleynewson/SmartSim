/* def-pe-d-flipflop.c generated by valac 0.16.0, the Vala compiler
...
PeDFlipflopComponentDef* pe_dflipflop_component_def_construct (GType object_type, GError** error) {
	...
	{
		self = (PeDFlipflopComponentDef*) component_def_construct_from_file (object_type, PE_DFLIPFLOP_COMPONENT_DEF_infoFilename, &_inner_error_);
