/* def-pe-d-flipflop.c generated by valac 0.24.0, the Vala compiler
 * generated from def-pe-d-flipflop.vala, do not modify */
...
typedef struct _PeDFlipflopComponentDefPrivate PeDFlipflopComponentDefPrivate;
...
struct _PeDFlipflopComponentDef {
	ComponentDef parent_instance;
	PeDFlipflopComponentDefPrivate * priv;
};

struct _PeDFlipflopComponentDefClass {
...
static gpointer pe_dflipflop_component_def_parent_class = NULL;
...
enum  {
	PE_DFLIPFLOP_COMPONENT_DEF_DUMMY_PROPERTY
};
#define PE_DFLIPFLOP_COMPONENT_DEF_infoFilename PACKAGE_DATADIR "components/info/pe-d-flipflop.xml"
...
PeDFlipflopComponentDef* pe_dflipflop_component_def_construct (GType object_type, GError** error) {
	PeDFlipflopComponentDef* self = NULL;
	GError * _inner_error_ = NULL;
	self = (PeDFlipflopComponentDef*) component_def_construct (object_type);
	{
		component_def_load_from_file ((ComponentDef*) self, PE_DFLIPFLOP_COMPONENT_DEF_infoFilename, &_inner_error_);
	...
	__catch43_g_error:
	{
		...
		_inner_error_ = NULL;
		_tmp0_ = stdout;
		fprintf (_tmp0_, "Failed to load built in component \"%s\"\n", PE_DFLIPFLOP_COMPONENT_DEF_infoFilename);
		_tmp1_ = g_error_new_literal (COMPONENT_DEF_LOAD_ERROR, COMPONENT_DEF_LOAD_ERROR_LOAD, "Failed to load \"" PE_DFLIPFLOP_COMPONENT_DEF_infoFilename "\"\n");
...
PeDFlipflopComponentDef* pe_dflipflop_component_def_new (GError** error) {
	return pe_dflipflop_component_def_construct (TYPE_PE_DFLIPFLOP_COMPONENT_DEF, error);
}
...
static void pe_dflipflop_component_def_real_compile_component (ComponentDef* base, CompiledCircuit* compiledCircuit, ComponentInst* componentInst, Connection** connections, int connections_length1, ComponentInst** ancestry, int ancestry_length1) {
	...
	Connection* _tmp49_ = NULL;
	ComponentInst** _tmp50_ = NULL;
	gint _tmp50__length1 = 0;
	ComponentInst* _tmp51_ = NULL;
	PeDFlipflopComponentState* _tmp52_ = NULL;
	CompiledCircuit* _tmp53_ = NULL;
	...
	_tmp4__length1 = connections_length1;
	{
		...
		for (connection_it = 0; connection_it < _tmp4__length1; connection_it = connection_it + 1) {
			...
			connection = _tmp5_;
			{
				...
				ComponentInst* _tmp29_ = NULL;
				PinInst** _tmp30_ = NULL;
				gint _tmp30__length1 = 0;
				PinInst* _tmp31_ = NULL;
...
static void pe_dflipflop_component_def_instance_init (PeDFlipflopComponentDef * self) {
}


GType pe_dflipflop_component_def_get_type (void) {
	static volatile gsize pe_dflipflop_component_def_type_id__volatile = 0;
	if (g_once_init_enter (&pe_dflipflop_component_def_type_id__volatile)) {
		static const GTypeInfo g_define_type_info = { sizeof (PeDFlipflopComponentDefClass), (GBaseInitFunc) NULL, (GBaseFinalizeFunc) NULL, (GClassInitFunc) pe_dflipflop_component_def_class_init, (GClassFinalizeFunc) NULL, NULL, sizeof (PeDFlipflopComponentDef), 0, (GInstanceInitFunc) pe_dflipflop_component_def_instance_init, NULL };
		GType pe_dflipflop_component_def_type_id;
		pe_dflipflop_component_def_type_id = g_type_register_static (TYPE_COMPONENT_DEF, "PeDFlipflopComponentDef", &g_define_type_info, 0);
		g_once_init_leave (&pe_dflipflop_component_def_type_id__volatile, pe_dflipflop_component_def_type_id);
	}
	return pe_dflipflop_component_def_type_id__volatile;
}
