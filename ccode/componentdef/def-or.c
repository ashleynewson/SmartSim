/* def-or.c generated by valac 0.16.0, the Vala compiler
...
OrComponentDef* or_component_def_construct (GType object_type, GError** error) {
	...
	{
		self = (OrComponentDef*) component_def_construct_from_file (object_type, OR_COMPONENT_DEF_infoFilename, &_inner_error_);
