/* def-reader.c generated by valac 0.16.0, the Vala compiler
...
ReaderComponentDef* reader_component_def_construct (GType object_type, GError** error) {
	...
	{
		self = (ReaderComponentDef*) component_def_construct_from_file (object_type, READER_COMPONENT_DEF_infoFilename, &_inner_error_);
