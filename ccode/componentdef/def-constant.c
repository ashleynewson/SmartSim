/* def-constant.c generated by valac 0.16.0, the Vala compiler
...
ConstantComponentDef* constant_component_def_construct (GType object_type, GError** error) {
	...
	{
		self = (ConstantComponentDef*) component_def_construct_from_file (object_type, CONSTANT_COMPONENT_DEF_infoFilename, &_inner_error_);
...
static void constant_component_def_real_add_properties (ComponentDef* base, PropertySet* queryProperty, PropertySet* configurationProperty) {
	...
	selection = _tmp4_;
	property_item_selection_add_option (selection, "0 (False)");
	property_item_selection_add_option (selection, "1 (True)");
