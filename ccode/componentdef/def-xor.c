/* def-xor.c generated by valac 0.16.0, the Vala compiler
...
XorComponentDef* xor_component_def_construct (GType object_type, GError** error) {
	...
	{
		self = (XorComponentDef*) component_def_construct_from_file (object_type, XOR_COMPONENT_DEF_infoFilename, &_inner_error_);
