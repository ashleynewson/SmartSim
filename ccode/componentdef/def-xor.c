/* def-xor.c generated by valac 0.24.0, the Vala compiler
...
static void xor_component_def_real_compile_component (ComponentDef* base, CompiledCircuit* compiledCircuit, ComponentInst* componentInst, Connection** connections, int connections_length1, ComponentInst** ancestry, int ancestry_length1) {
	...
	Connection** _tmp41_ = NULL;
	gint _tmp41__length1 = 0;
	Connection* _tmp42_ = NULL;
	ComponentInst** _tmp43_ = NULL;
	gint _tmp43__length1 = 0;
	ComponentInst* _tmp44_ = NULL;
	XorComponentState* _tmp45_ = NULL;
	CompiledCircuit* _tmp46_ = NULL;
	...
	_tmp6__length1 = connections_length1;
	{
		...
		for (connection_it = 0; connection_it < _tmp6__length1; connection_it = connection_it + 1) {
			...
			connection = _tmp7_;
			{
				...
				WireInst* _tmp38_ = NULL;
				{
					...
					i = 0;
					{
						...
						while (TRUE) {
							...
							wireInst = _tmp21_;
							_tmp22_ = connection;
							_tmp23_ = connection_get_wireInst (_tmp22_);
							_tmp24_ = _tmp23_;
							_tmp25_ = wireInst;
							if (_tmp24_ == _tmp25_) {
								...
								_tmp26_ = inputWires;
								_tmp26__length1 = inputWires_length1;
								_tmp27_ = i;
								_tmp28_ = connection;
								_tmp29_ = _connection_ref0 (_tmp28_);
								_connection_unref0 (_tmp26_[_tmp27_]);
				...
				_tmp36_ = _tmp35_[1];
				_tmp37_ = _tmp36_->wireInsts;
				_tmp37__length1 = _tmp36_->wireInsts_length1;
				_tmp38_ = _tmp37_[0];
				if (_tmp33_ == _tmp38_) {
					Connection* _tmp39_ = NULL;
					Connection* _tmp40_ = NULL;
					_tmp39_ = connection;
					_tmp40_ = _connection_ref0 (_tmp39_);
	...
	_tmp41_ = inputWires;
	_tmp41__length1 = inputWires_length1;
	_tmp42_ = outputWire;
	_tmp43_ = ancestry;
	_tmp43__length1 = ancestry_length1;
	_tmp44_ = componentInst;
	_tmp45_ = xor_component_state_new (_tmp41_, _tmp41__length1, _tmp42_, _tmp43_, _tmp43__length1, _tmp44_);
	componentState = (ComponentState*) _tmp45_;
	_tmp46_ = compiledCircuit;
	compiled_circuit_add_component (_tmp46_, componentState);
