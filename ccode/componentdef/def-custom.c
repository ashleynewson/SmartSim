/* def-custom.c generated by valac 0.16.0, the Vala compiler
...
static ComponentInst** _vala_array_dup56 (ComponentInst** self, int length);
static void _vala_array_add90 (ComponentInst*** array, int* length, int* size, ComponentInst* value);
static ComponentInst** _vala_array_dup57 (ComponentInst** self, int length);
...
static Annotation** _vala_array_dup58 (Annotation** self, int length);
static void _vala_array_add91 (Annotation*** array, int* length, int* size, Annotation* value);
static Annotation** _vala_array_dup59 (Annotation** self, int length);
...
static WireInst** _vala_array_dup60 (WireInst** self, int length);
static void _vala_array_add92 (WireInst*** array, int* length, int* size, WireInst* value);
static WireInst** _vala_array_dup61 (WireInst** self, int length);
...
static void _vala_array_add93 (ComponentInst*** array, int* length, int* size, ComponentInst* value);
static ComponentInst** _vala_array_dup62 (ComponentInst** self, int length);
...
static void _vala_array_add94 (WireInst*** array, int* length, int* size, WireInst* value);
static WireInst** _vala_array_dup63 (WireInst** self, int length);
void custom_component_def_delete_selected_annotations (CustomComponentDef* self);
static void _vala_array_add95 (Annotation*** array, int* length, int* size, Annotation* value);
static Annotation** _vala_array_dup64 (Annotation** self, int length);
...
static void _vala_array_add97 (ComponentInst*** array, int* length, int* size, ComponentInst* value);
...
static void _vala_array_add98 (Annotation*** array, int* length, int* size, Annotation* value);
static WireInst** _vala_array_dup65 (WireInst** self, int length);
static ComponentInst** _vala_array_dup66 (ComponentInst** self, int length);
static Annotation** _vala_array_dup67 (Annotation** self, int length);
...
static void _vala_array_add99 (ComponentInst*** array, int* length, int* size, ComponentInst* value);
static void _vala_array_add100 (ComponentInst*** array, int* length, int* size, ComponentInst* value);
...
static void _vala_array_add101 (WireState*** array, int* length, int* size, WireState* value);
...
void custom_component_def_update_immediate_dependencies (CustomComponentDef* self);
...
static void _vala_array_add102 (CustomComponentDef*** array, int* length, int* size, CustomComponentDef* value);
static CustomComponentDef** _vala_array_dup68 (CustomComponentDef** self, int length);
void custom_component_def_remove_immediate_dependency (CustomComponentDef* self, CustomComponentDef* removeComponent);
static void _vala_array_add103 (CustomComponentDef*** array, int* length, int* size, CustomComponentDef* value);
...
CustomComponentDef* custom_component_def_construct_from_file (GType object_type, const gchar* infoFilename, Project* project, GError** error) {
	...
	g_return_val_if_fail (project != NULL, NULL);
	{
		const gchar* _tmp0_;
		_tmp0_ = infoFilename;
		self = (CustomComponentDef*) component_def_construct_from_file (object_type, _tmp0_, &_inner_error_);
		if (_inner_error_ != NULL) {
			if (_inner_error_->domain == COMPONENT_DEF_LOAD_ERROR) {
				goto __catch31_component_def_load_error;
			}
			if (_inner_error_->domain == CUSTOM_COMPONENT_DEF_LOAD_ERROR) {
				goto __catch31_custom_component_def_load_error;
			}
	...
	goto __finally31;
	__catch31_component_def_load_error:
	{
		GError* _error_ = NULL;
		GError* _tmp1_;
		GError* _tmp2_;
	...
	goto __finally31;
	__catch31_custom_component_def_load_error:
	{
		GError* _error_ = NULL;
		GError* _tmp3_;
		GError* _tmp4_;
	...
	_tmp5_ = project;
	_tmp6_ = ((ComponentDef*) self)->name;
	_tmp7_ = project_resolve_def_name (_tmp5_, _tmp6_);
	_tmp8_ = _tmp7_;
	_tmp9_ = _tmp8_ != NULL;
	...
	if (_tmp9_) {
		...
		GError* _tmp15_;
		GError* _tmp16_;
		_tmp10_ = ((ComponentDef*) self)->name;
		_tmp11_ = g_strconcat ("A component with the name \"", _tmp10_, NULL);
		_tmp12_ = _tmp11_;
		_tmp13_ = g_strconcat (_tmp12_, "\" already exists. Rename the component which is already open using th" \
"e customiser dialog, accessible via the component menu.", NULL);
		_tmp14_ = _tmp13_;
		_tmp15_ = g_error_new_literal (CUSTOM_COMPONENT_DEF_LOAD_ERROR, CUSTOM_COMPONENT_DEF_LOAD_ERROR_NAME_CONFLICT, _tmp14_);
		_tmp16_ = _tmp15_;
		_g_free0 (_tmp14_);
		_g_free0 (_tmp12_);
	...
	_tmp17_ = project;
	self->priv->project = _tmp17_;
	{
		const gchar* _tmp18_;
		_tmp18_ = infoFilename;
		custom_component_def_load (self, _tmp18_, &_inner_error_);
		if (_inner_error_ != NULL) {
			if (_inner_error_->domain == CUSTOM_COMPONENT_DEF_LOAD_ERROR) {
				goto __catch32_custom_component_def_load_error;
			}
			g_critical ("file %s: line %d: unexpected error: %s (%s, %d)", __FILE__, __LINE__, _inner_error_->message, g_quark_to_string (_inner_error_->domain), _inner_error_->code);
			g_clear_error (&_inner_error_);
			return NULL;
	...
	goto __finally32;
	__catch32_custom_component_def_load_error:
	{
		GError* _error_ = NULL;
		GError* _tmp19_;
		GError* _tmp20_;
	...
	((ComponentDef*) self)->filename = _tmp22_;
	return self;
}
...
ComponentInst* custom_component_def_add_componentInst (CustomComponentDef* self, ComponentDef* componentDef, gint x, gint y, Direction direction) {
	...
	_tmp5_ = self->componentInsts;
	_tmp5__length1 = self->componentInsts_length1;
	_tmp6_ = (_tmp5_ != NULL) ? _vala_array_dup56 (_tmp5_, _tmp5__length1) : ((gpointer) _tmp5_);
	...
	_vala_array_add90 (&newComponentInsts, &newComponentInsts_length1, &_newComponentInsts_size_, _tmp8_);
	_tmp9_ = newComponentInsts;
	_tmp9__length1 = newComponentInsts_length1;
	_tmp10_ = (_tmp9_ != NULL) ? _vala_array_dup57 (_tmp9_, _tmp9__length1) : ((gpointer) _tmp9_);
...
void custom_component_def_add_annotation (CustomComponentDef* self, gint x, gint y, const gchar* text, gdouble fontSize) {
	...
	_tmp6_ = (_tmp5_ != NULL) ? _vala_array_dup58 (_tmp5_, _tmp5__length1) : ((gpointer) _tmp5_);
	_tmp6__length1 = _tmp5__length1;
	...
	_vala_array_add91 (&newAnnotations, &newAnnotations_length1, &_newAnnotations_size_, _tmp8_);
	_tmp9_ = newAnnotations;
	_tmp9__length1 = newAnnotations_length1;
	_tmp10_ = (_tmp9_ != NULL) ? _vala_array_dup59 (_tmp9_, _tmp9__length1) : ((gpointer) _tmp9_);
	_tmp10__length1 = _tmp9__length1;
...
WireInst* custom_component_def_add_wire (CustomComponentDef* self) {
	...
	_tmp2_ = (_tmp1_ != NULL) ? _vala_array_dup60 (_tmp1_, _tmp1__length1) : ((gpointer) _tmp1_);
	...
	_vala_array_add92 (&newWireInsts, &newWireInsts_length1, &_newWireInsts_size_, _tmp4_);
	_tmp5_ = newWireInsts;
	_tmp5__length1 = newWireInsts_length1;
	_tmp6_ = (_tmp5_ != NULL) ? _vala_array_dup61 (_tmp5_, _tmp5__length1) : ((gpointer) _tmp5_);
	_tmp6__length1 = _tmp5__length1;
...
void custom_component_def_delete_selected_components (CustomComponentDef* self) {
		...
		for (componentInst_it = 0; componentInst_it < _tmp1__length1; componentInst_it = componentInst_it + 1) {
			...
			componentInst = _tmp2_;
			{
				...
				if (_tmp4_) {
					...
					_vala_array_add93 (&newComponentInsts, &newComponentInsts_length1, &_newComponentInsts_size_, _tmp9_);
				}
				_component_inst_unref0 (componentInst);
			}
		}
	...
	_tmp11_ = (_tmp10_ != NULL) ? _vala_array_dup62 (_tmp10_, _tmp10__length1) : ((gpointer) _tmp10_);
...
void custom_component_def_delete_selected_wires (CustomComponentDef* self) {
		...
		for (wireInst_it = 0; wireInst_it < _tmp1__length1; wireInst_it = wireInst_it + 1) {
			...
			wireInst = _tmp2_;
			{
				...
				if (_tmp4_) {
					...
					_vala_array_add94 (&newWireInsts, &newWireInsts_length1, &_newWireInsts_size_, _tmp9_);
				}
				_wire_inst_unref0 (wireInst);
			}
		}
	...
	_tmp11_ = (_tmp10_ != NULL) ? _vala_array_dup63 (_tmp10_, _tmp10__length1) : ((gpointer) _tmp10_);
	_tmp11__length1 = _tmp10__length1;
	self->wireInsts = (_vala_array_free (self->wireInsts, self->wireInsts_length1, (GDestroyNotify) wire_inst_unref), NULL);
...
void custom_component_def_delete_selected_annotations (CustomComponentDef* self) {
		...
		for (annotation_it = 0; annotation_it < _tmp1__length1; annotation_it = annotation_it + 1) {
			...
			annotation = _tmp2_;
			{
				...
				if (_tmp4_) {
					...
					_vala_array_add95 (&newAnnotations, &newAnnotations_length1, &_newAnnotations_size_, _tmp8_);
				}
				_annotation_unref0 (annotation);
			}
		}
	...
	_tmp9_ = newAnnotations;
	_tmp9__length1 = newAnnotations_length1;
	_tmp10_ = (_tmp9_ != NULL) ? _vala_array_dup64 (_tmp9_, _tmp9__length1) : ((gpointer) _tmp9_);
	_tmp10__length1 = _tmp9__length1;
	self->annotations = (_vala_array_free (self->annotations, self->annotations_length1, (GDestroyNotify) annotation_unref), NULL);
	self->annotations = _tmp10_;
	self->annotations_length1 = _tmp10__length1;
	...
	_tmp22__length1 = self->componentInsts_length1;
	{
		...
		for (componentInst_it = 0; componentInst_it < _tmp22__length1; componentInst_it = componentInst_it + 1) {
			...
			componentInst = _tmp23_;
			{
				...
				if (IS_CUSTOM_COMPONENT_DEF (_tmp25_)) {
					...
					_tmp30_ = custom_component_def_validate_dependencies (IS_CUSTOM_COMPONENT_DEF (_tmp27_) ? ((CustomComponentDef*) _tmp27_) : NULL, _tmp28_, _tmp28__length1, &_tmp29_);
...
gint custom_component_def_load (CustomComponentDef* self, const gchar* infoFilename, GError** error) {
					...
					{
						{
							...
							_vala_array_add96 (&newWireInsts, &newWireInsts_length1, &_newWireInsts_size_, _tmp44_);
					...
					{
						{
							ComponentInst* newComponentInst = NULL;
							{
								...
								if (_inner_error_ != NULL) {
									if (g_error_matches (_inner_error_, COMPONENT_INST_LOAD_ERROR, COMPONENT_INST_LOAD_ERROR_INVALID)) {
										goto __catch33_component_inst_load_error_invalid;
									}
									if (g_error_matches (_inner_error_, COMPONENT_INST_LOAD_ERROR, COMPONENT_INST_LOAD_ERROR_MISSING_DEF)) {
										goto __catch33_component_inst_load_error_missing_def;
									}
								...
								_vala_array_add97 (&newComponentInsts, &newComponentInsts_length1, &_newComponentInsts_size_, _tmp52_);
							}
							goto __finally33;
							__catch33_component_inst_load_error_invalid:
							{
								GError* _error_ = NULL;
								FILE* _tmp53_;
								GError* _tmp54_;
							...
							goto __finally33;
							__catch33_component_inst_load_error_missing_def:
							{
								GError* _error_ = NULL;
								FILE* _tmp59_;
								GError* _tmp60_;
							...
							Annotation* newAnnotation = NULL;
							{
								...
								if (_inner_error_ != NULL) {
									if (g_error_matches (_inner_error_, ANNOTATION_LOAD_ERROR, ANNOTATION_LOAD_ERROR_EMPTY)) {
										goto __catch34_annotation_load_error_empty;
									}
								...
								_vala_array_add98 (&newAnnotations, &newAnnotations_length1, &_newAnnotations_size_, _tmp70_);
							}
							goto __finally34;
							__catch34_annotation_load_error_empty:
							{
								GError* _error_ = NULL;
								FILE* _tmp71_;
								GError* _tmp72_;
	...
	_tmp76_ = (_tmp75_ != NULL) ? _vala_array_dup65 (_tmp75_, _tmp75__length1) : ((gpointer) _tmp75_);
	...
	_tmp78_ = (_tmp77_ != NULL) ? _vala_array_dup66 (_tmp77_, _tmp77__length1) : ((gpointer) _tmp77_);
	...
	_tmp80_ = (_tmp79_ != NULL) ? _vala_array_dup67 (_tmp79_, _tmp79__length1) : ((gpointer) _tmp79_);
...
static void custom_component_def_real_compile_component (ComponentDef* base, CompiledCircuit* compiledCircuit, ComponentInst* componentInst, Connection** connections, int connections_length1, ComponentInst** ancestry, int ancestry_length1) {
	...
	if (_tmp2_ != NULL) {
		...
		_tmp3__length1 = ancestry_length1;
		{
			...
			for (prevComponentInst_it = 0; prevComponentInst_it < _tmp3__length1; prevComponentInst_it = prevComponentInst_it + 1) {
				...
				prevComponentInst = _tmp4_;
				{
					...
					_vala_array_add99 (&newAncestry, &newAncestry_length1, &_newAncestry_size_, _tmp7_);
		...
		_vala_array_add100 (&newAncestry, &newAncestry_length1, &_newAncestry_size_, _tmp10_);
	}
	...
	_tmp11__length1 = self->wireInsts_length1;
	{
		...
		for (wireInst_it = 0; wireInst_it < _tmp11__length1; wireInst_it = wireInst_it + 1) {
			...
			wireInst = _tmp12_;
			{
				...
				_vala_array_add101 (&localWireStates, &localWireStates_length1, &_localWireStates_size_, _tmp20_);
...
void custom_component_def_update_immediate_dependencies (CustomComponentDef* self) {
	...
	_tmp1__length1 = self->componentInsts_length1;
	{
		...
		for (componentInst_it = 0; componentInst_it < _tmp1__length1; componentInst_it = componentInst_it + 1) {
			...
			componentInst = _tmp2_;
			{
				...
				_tmp3_ = componentInst;
				_tmp4_ = _tmp3_->componentDef;
				if (IS_CUSTOM_COMPONENT_DEF (_tmp4_)) {
					ComponentInst* _tmp5_;
					ComponentDef* _tmp6_;
					CustomComponentDef* _tmp7_;
					...
					_tmp7_ = _component_def_ref0 (IS_CUSTOM_COMPONENT_DEF (_tmp6_) ? ((CustomComponentDef*) _tmp6_) : NULL);
					customComponentDef = _tmp7_;
					_tmp8_ = customComponentDef;
					_tmp9_ = self->immediateDependencies;
					_tmp9__length1 = self->immediateDependencies_length1;
					if (!_vala_custom_component_def_array_contains (_tmp9_, _tmp9__length1, _tmp8_)) {
						CustomComponentDef** _tmp10_;
						gint _tmp10__length1;
						CustomComponentDef* _tmp11_;
						CustomComponentDef* _tmp12_;
						_tmp10_ = newImmediateDependencies;
						_tmp10__length1 = newImmediateDependencies_length1;
						_tmp11_ = customComponentDef;
						_tmp12_ = _component_def_ref0 (_tmp11_);
						_vala_array_add102 (&newImmediateDependencies, &newImmediateDependencies_length1, &_newImmediateDependencies_size_, _tmp12_);
					}
	...
	_tmp13_ = newImmediateDependencies;
	_tmp13__length1 = newImmediateDependencies_length1;
	_tmp14_ = (_tmp13_ != NULL) ? _vala_array_dup68 (_tmp13_, _tmp13__length1) : ((gpointer) _tmp13_);
	...
	self->immediateDependencies = _tmp14_;
	self->immediateDependencies_length1 = _tmp14__length1;
...
void custom_component_def_remove_immediate_dependency (CustomComponentDef* self, CustomComponentDef* removeComponent) {
		...
		for (customComponentDef_it = 0; customComponentDef_it < _tmp1__length1; customComponentDef_it = customComponentDef_it + 1) {
			...
			customComponentDef = _tmp2_;
			{
				...
				if (_tmp3_ != _tmp4_) {
					...
					_vala_array_add103 (&newImmediateDependencies, &newImmediateDependencies_length1, &_newImmediateDependencies_size_, _tmp7_);
				}
				_component_def_unref0 (customComponentDef);
			}
		}
	...
	_tmp9_ = (_tmp8_ != NULL) ? _vala_array_dup69 (_tmp8_, _tmp8__length1) : ((gpointer) _tmp8_);
