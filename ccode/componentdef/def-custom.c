/* def-custom.c generated by valac 0.18.1, the Vala compiler
...
static void _vala_array_add34 (WireInst*** array, int* length, int* size, WireInst* value);
...
static void _vala_array_add36 (WireInst*** array, int* length, int* size, WireInst* value);
...
static void _vala_array_add37 (Annotation*** array, int* length, int* size, Annotation* value);
...
static void _vala_array_add38 (WireInst*** array, int* length, int* size, WireInst* value);
...
static void _vala_array_add39 (ComponentInst*** array, int* length, int* size, ComponentInst* value);
...
static void _vala_array_add40 (Annotation*** array, int* length, int* size, Annotation* value);
...
static void _vala_array_add41 (ComponentInst*** array, int* length, int* size, ComponentInst* value);
...
static void _vala_array_add43 (WireState*** array, int* length, int* size, WireState* value);
...
static void _vala_array_add44 (ComponentDef*** array, int* length, int* size, ComponentDef* value);
...
ComponentInst* custom_component_def_add_componentInst (CustomComponentDef* self, ComponentDef* componentDef, gint x, gint y, Direction direction) {
	...
	_vala_array_add32 (&newComponentInsts, &newComponentInsts_length1, &_newComponentInsts_size_, _tmp8_);
...
void custom_component_def_add_annotation (CustomComponentDef* self, gint x, gint y, const gchar* text, gdouble fontSize) {
	...
	_vala_array_add33 (&newAnnotations, &newAnnotations_length1, &_newAnnotations_size_, _tmp8_);
...
WireInst* custom_component_def_add_wire (CustomComponentDef* self) {
	...
	_vala_array_add34 (&newWireInsts, &newWireInsts_length1, &_newWireInsts_size_, _tmp4_);
	_tmp5_ = newWireInsts;
		...
		for (componentInst_it = 0; componentInst_it < _tmp1__length1; componentInst_it = componentInst_it + 1) {
			...
			componentInst = _tmp2_;
			{
				...
				if (_tmp4_) {
					...
					_vala_array_add35 (&newComponentInsts, &newComponentInsts_length1, &_newComponentInsts_size_, _tmp9_);
				}
				_component_inst_unref0 (componentInst);
			}
		}
		...
		for (wireInst_it = 0; wireInst_it < _tmp1__length1; wireInst_it = wireInst_it + 1) {
			...
			wireInst = _tmp2_;
			{
				...
				if (_tmp4_) {
					...
					_vala_array_add36 (&newWireInsts, &newWireInsts_length1, &_newWireInsts_size_, _tmp9_);
				}
				_wire_inst_unref0 (wireInst);
			}
		}
		...
		for (annotation_it = 0; annotation_it < _tmp1__length1; annotation_it = annotation_it + 1) {
			...
			annotation = _tmp2_;
			{
				...
				if (_tmp4_) {
					...
					_vala_array_add37 (&newAnnotations, &newAnnotations_length1, &_newAnnotations_size_, _tmp8_);
				}
				_annotation_unref0 (annotation);
			}
		}
					...
					{
						{
							...
							_vala_array_add38 (&newWireInsts, &newWireInsts_length1, &_newWireInsts_size_, _tmp44_);
					...
					{
						{
							ComponentInst* newComponentInst = NULL;
							{
								...
								_vala_array_add39 (&newComponentInsts, &newComponentInsts_length1, &_newComponentInsts_size_, _tmp52_);
							}
							goto __finally28;
					...
					{
						{
							Annotation* newAnnotation = NULL;
							{
								...
								_vala_array_add40 (&newAnnotations, &newAnnotations_length1, &_newAnnotations_size_, _tmp70_);
							}
							goto __finally29;
...
gint custom_component_def_save (CustomComponentDef* self, const gchar* fileName) {
	...
	FILE* _tmp84_;
	FILE* _tmp94_;
	xmlTextWriter* _tmp104_;
	xmlTextWriter* _tmp105_;
	xmlTextWriter* _tmp106_;
	FILE* _tmp107_;
	g_return_val_if_fail (self != NULL, 0);
	...
	_tmp24_ = ((ComponentDef*) self)->graphicReferenceFilename;
	if (_tmp24_ != NULL) {
		xmlTextWriter* _tmp25_;
		const gchar* _tmp26_;
		_tmp25_ = xmlWriter;
		_tmp26_ = ((ComponentDef*) self)->graphicReferenceFilename;
		xmlTextWriterWriteElement (_tmp25_, "graphic", _tmp26_);
	}
	_tmp27_ = xmlWriter;
	xmlTextWriterStartElement (_tmp27_, "bound");
	_tmp28_ = xmlWriter;
	_tmp29_ = ((ComponentDef*) self)->rightBound;
	_tmp30_ = g_strdup_printf ("%i", _tmp29_);
	_tmp31_ = _tmp30_;
	xmlTextWriterWriteAttribute (_tmp28_, "right", _tmp31_);
	_g_free0 (_tmp31_);
	_tmp32_ = xmlWriter;
	_tmp33_ = ((ComponentDef*) self)->downBound;
	_tmp34_ = g_strdup_printf ("%i", _tmp33_);
	_tmp35_ = _tmp34_;
	xmlTextWriterWriteAttribute (_tmp32_, "down", _tmp35_);
	_g_free0 (_tmp35_);
	_tmp36_ = xmlWriter;
	_tmp37_ = ((ComponentDef*) self)->leftBound;
	_tmp38_ = g_strdup_printf ("%i", _tmp37_);
	_tmp39_ = _tmp38_;
	xmlTextWriterWriteAttribute (_tmp36_, "left", _tmp39_);
	_g_free0 (_tmp39_);
	_tmp40_ = xmlWriter;
	_tmp41_ = ((ComponentDef*) self)->upBound;
	_tmp42_ = g_strdup_printf ("%i", _tmp41_);
	_tmp43_ = _tmp42_;
	xmlTextWriterWriteAttribute (_tmp40_, "up", _tmp43_);
	_g_free0 (_tmp43_);
	_tmp44_ = xmlWriter;
	xmlTextWriterEndElement (_tmp44_);
	_tmp45_ = xmlWriter;
	xmlTextWriterStartElement (_tmp45_, "colour");
	_tmp46_ = xmlWriter;
	_tmp47_ = ((ComponentDef*) self)->backgroundAlpha;
	_tmp48_ = g_strdup_printf ("%i", _tmp47_);
	_tmp49_ = _tmp48_;
	xmlTextWriterWriteAttribute (_tmp46_, "a", _tmp49_);
	_g_free0 (_tmp49_);
	_tmp50_ = xmlWriter;
	_tmp51_ = ((ComponentDef*) self)->backgroundRed;
	_tmp52_ = g_strdup_printf ("%i", _tmp51_);
	_tmp53_ = _tmp52_;
	xmlTextWriterWriteAttribute (_tmp50_, "r", _tmp53_);
	_g_free0 (_tmp53_);
	_tmp54_ = xmlWriter;
	_tmp55_ = ((ComponentDef*) self)->backgroundGreen;
	_tmp56_ = g_strdup_printf ("%i", _tmp55_);
	_tmp57_ = _tmp56_;
	xmlTextWriterWriteAttribute (_tmp54_, "g", _tmp57_);
	_g_free0 (_tmp57_);
	_tmp58_ = xmlWriter;
	_tmp59_ = ((ComponentDef*) self)->backgroundBlue;
	_tmp60_ = g_strdup_printf ("%i", _tmp59_);
	_tmp61_ = _tmp60_;
	xmlTextWriterWriteAttribute (_tmp58_, "b", _tmp61_);
	_g_free0 (_tmp61_);
	_tmp62_ = xmlWriter;
	xmlTextWriterEndElement (_tmp62_);
	_tmp63_ = stdout;
	fprintf (_tmp63_, "Saving pin data...\n");
	{
		gint i;
		i = 0;
		{
			...
			while (TRUE) {
				...
				_tmp69_ = ((ComponentDef*) self)->pinDefs;
				_tmp69__length1 = ((ComponentDef*) self)->pinDefs_length1;
				_tmp70_ = i;
				_tmp71_ = _tmp69_[_tmp70_];
				_tmp72_ = xmlWriter;
				_tmp73_ = i;
				pin_def_save (_tmp71_, _tmp72_, _tmp73_);
			}
		}
	}
	_tmp74_ = stdout;
	fprintf (_tmp74_, "Saving wire data...\n");
	{
		gint i;
		i = 0;
		{
			...
			while (TRUE) {
				...
				_tmp75_ = FALSE;
				_tmp78_ = i;
				_tmp79_ = self->wireInsts;
				_tmp79__length1 = self->wireInsts_length1;
				if (!(_tmp78_ < _tmp79__length1)) {
					break;
				}
				_tmp80_ = self->wireInsts;
				_tmp80__length1 = self->wireInsts_length1;
				_tmp81_ = i;
				_tmp82_ = _tmp80_[_tmp81_];
				_tmp83_ = xmlWriter;
				wire_inst_save (_tmp82_, _tmp83_);
			}
		}
	}
	_tmp84_ = stdout;
	fprintf (_tmp84_, "Saving component data...\n");
	{
		gint i;
		i = 0;
		{
			...
			while (TRUE) {
				...
				_tmp85_ = FALSE;
				_tmp88_ = i;
				_tmp89_ = self->componentInsts;
				_tmp89__length1 = self->componentInsts_length1;
				if (!(_tmp88_ < _tmp89__length1)) {
					break;
				}
				_tmp90_ = self->componentInsts;
				_tmp90__length1 = self->componentInsts_length1;
				_tmp91_ = i;
				_tmp92_ = _tmp90_[_tmp91_];
				_tmp93_ = xmlWriter;
				component_inst_save (_tmp92_, _tmp93_);
			}
		}
	}
	_tmp94_ = stdout;
	fprintf (_tmp94_, "Saving annotation data...\n");
	{
		gint i;
		i = 0;
		{
			...
			while (TRUE) {
				...
				_tmp95_ = FALSE;
				_tmp98_ = i;
				_tmp99_ = self->annotations;
				_tmp99__length1 = self->annotations_length1;
				if (!(_tmp98_ < _tmp99__length1)) {
					break;
				}
				_tmp100_ = self->annotations;
				_tmp100__length1 = self->annotations_length1;
				_tmp101_ = i;
				_tmp102_ = _tmp100_[_tmp101_];
				_tmp103_ = xmlWriter;
				annotation_save (_tmp102_, _tmp103_);
			}
		}
	}
	_tmp104_ = xmlWriter;
	xmlTextWriterEndElement (_tmp104_);
	_tmp105_ = xmlWriter;
	xmlTextWriterEndDocument (_tmp105_);
	_tmp106_ = xmlWriter;
	xmlTextWriterFlush (_tmp106_);
	_tmp107_ = stdout;
	fprintf (_tmp107_, "Saving complete...\n");
	result = 0;
...
static void custom_component_def_real_compile_component (ComponentDef* base, CompiledCircuit* compiledCircuit, ComponentInst* componentInst, Connection** connections, int connections_length1, ComponentInst** ancestry, int ancestry_length1) {
	...
	if (_tmp2_ != NULL) {
		...
		_tmp3__length1 = ancestry_length1;
		{
			...
			for (prevComponentInst_it = 0; prevComponentInst_it < _tmp3__length1; prevComponentInst_it = prevComponentInst_it + 1) {
				...
				prevComponentInst = _tmp4_;
				{
					...
					_vala_array_add41 (&newAncestry, &newAncestry_length1, &_newAncestry_size_, _tmp7_);
		...
		_vala_array_add42 (&newAncestry, &newAncestry_length1, &_newAncestry_size_, _tmp10_);
	}
	...
	_tmp11__length1 = self->wireInsts_length1;
	{
		...
		for (wireInst_it = 0; wireInst_it < _tmp11__length1; wireInst_it = wireInst_it + 1) {
			...
			wireInst = _tmp12_;
			{
				...
				_vala_array_add43 (&localWireStates, &localWireStates_length1, &_localWireStates_size_, _tmp20_);
			...
			componentInst = _tmp2_;
			{
				...
				if (_tmp11_) {
					...
					if (!_vala_component_def_array_contains (_tmp16_, _tmp16__length1, _tmp15_)) {
						...
						_vala_array_add44 (&newImmediateDependencies, &newImmediateDependencies_length1, &_newImmediateDependencies_size_, _tmp19_);
					}
		...
		for (componentDef_it = 0; componentDef_it < _tmp1__length1; componentDef_it = componentDef_it + 1) {
			...
			componentDef = _tmp2_;
			{
				...
				if (_tmp3_ != _tmp4_) {
					...
					_vala_array_add45 (&newImmediateDependencies, &newImmediateDependencies_length1, &_newImmediateDependencies_size_, _tmp7_);
				}
				_component_def_unref0 (componentDef);
			}
		}
