					...
					{
						{
							...
							_vala_array_add39 (&newWireInsts, &newWireInsts_length1, &_newWireInsts_size_, _tmp44_);
					...
					{
						{
							Annotation* newAnnotation = NULL;
							{
								...
								_vala_array_add41 (&newAnnotations, &newAnnotations_length1, &_newAnnotations_size_, _tmp70_);
							}
							goto __finally29;
			...
			componentInst = _tmp2_;
			{
				...
				if (_tmp11_) {
					...
					if (!_vala_component_def_array_contains (_tmp16_, _tmp16__length1, _tmp15_)) {
						...
						_vala_array_add45 (&newImmediateDependencies, &newImmediateDependencies_length1, &_newImmediateDependencies_size_, _tmp19_);
					}
