...
static void _vala_array_add92 (PropertyItemSelectionOption** array, int* length, int* size, const PropertyItemSelectionOption* value);
...
static void _vala_array_add94 (GtkRadioButton*** array, int* length, int* size, GtkRadioButton* value);
	...
	_tmp6__length1 = _tmp5_->priv->options_length1;
	{
		...
		for (option_it = 0; option_it < _tmp6__length1; option_it = option_it + 1) {
			...
			option = _tmp7_;
			{
				...
				_vala_array_add92 (&self->priv->options, &self->priv->options_length1, &self->priv->_options_size_, &_tmp10_);
	...
	_radioButtons_size_ = radioButtons_length1;
	{
		...
		i = 0;
		{
			...
			while (TRUE) {
				...
				_vala_array_add94 (&radioButtons, &radioButtons_length1, &_radioButtons_size_, _tmp23_);
				_tmp24_ = vBox;
				_tmp25_ = radioButton;
