...
static void _vala_array_add85 (gchar*** array, int* length, int* size, gchar* value);
...
static void _vala_array_add86 (GtkRadioButton*** array, int* length, int* size, GtkRadioButton* value);
...
void property_item_selection_add_option (PropertyItemSelection* self, const gchar* option) {
	...
	_vala_array_add85 (&newOptions, &newOptions_length1, &_newOptions_size_, _tmp4_);
	_tmp5_ = newOptions;
	...
	_radioButtons_size_ = radioButtons_length1;
	{
		...
		i = 0;
		{
			...
			while (TRUE) {
				...
				_vala_array_add86 (&radioButtons, &radioButtons_length1, &_radioButtons_size_, _tmp21_);
				_tmp22_ = vBox;
				_tmp23_ = radioButton;
