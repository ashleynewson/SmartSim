...
static void __lambda79_ (Block4Data* _data4_);
static void ___lambda79__gtk_button_clicked (GtkButton* _sender, gpointer self);
...
static GtkWidget* property_item_file_real_create_widget (PropertyItem* base) {
	...
	browseButton = _tmp3_;
	g_signal_connect_data (browseButton, "clicked", (GCallback) ___lambda79__gtk_button_clicked, block4_data_ref (_data4_), (GClosureNotify) block4_data_unref, 0);
