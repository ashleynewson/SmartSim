/* propertyitem-file.c generated by valac 0.24.0, the Vala compiler
...
PropertyItemFile* property_item_file_construct_copy (GType object_type, PropertyItemFile* source) {
	PropertyItemFile* self = NULL;
	PropertyItemFile* _tmp0_ = NULL;
	const gchar* _tmp1_ = NULL;
	PropertyItemFile* _tmp2_ = NULL;
	const gchar* _tmp3_ = NULL;
	PropertyItemFile* _tmp4_ = NULL;
...
static GtkWidget* property_item_file_real_create_widget (PropertyItem* base) {
	...
	browseButton = _tmp3_;
	g_signal_connect_data (browseButton, "clicked", (GCallback) ___lambda83__gtk_button_clicked, block4_data_ref (_data4_), (GClosureNotify) block4_data_unref, 0);
