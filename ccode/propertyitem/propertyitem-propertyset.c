/* propertyitem-propertyset.c generated by valac 0.16.0, the Vala compiler
...
static PropertyItem** _vala_array_dup91 (PropertyItem** self, int length);
static void _vala_array_add104 (PropertyItem*** array, int* length, int* size, PropertyItem* value);
static PropertyItem** _vala_array_dup92 (PropertyItem** self, int length);
...
gint property_set_add_item (PropertySet* self, PropertyItem* propertyItem) {
	...
	_tmp4_ = (_tmp3_ != NULL) ? _vala_array_dup91 (_tmp3_, _tmp3__length1) : ((gpointer) _tmp3_);
	...
	_vala_array_add104 (&newPropertyItems, &newPropertyItems_length1, &_newPropertyItems_size_, _tmp7_);
	_tmp8_ = newPropertyItems;
	_tmp8__length1 = newPropertyItems_length1;
	_tmp9_ = (_tmp8_ != NULL) ? _vala_array_dup92 (_tmp8_, _tmp8__length1) : ((gpointer) _tmp8_);
