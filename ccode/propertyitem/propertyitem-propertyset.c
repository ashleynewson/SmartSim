...
static void _vala_array_add84 (PropertyItem*** array, int* length, int* size, PropertyItem* value);
...
gint property_set_add_item (PropertySet* self, PropertyItem* propertyItem) {
	...
	_vala_array_add84 (&newPropertyItems, &newPropertyItems_length1, &_newPropertyItems_size_, _tmp7_);
