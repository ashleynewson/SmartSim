/* propertyitem-double.c generated by valac 0.16.0, the Vala compiler
...
gdouble property_item_double_get_data_throw (PropertySet* propertySet, const gchar* name, GError** error) {
	...
	if (_tmp3_ != NULL) {
		...
		if (IS_PROPERTY_ITEM_DOUBLE (_tmp4_)) {
			...
			gdouble _tmp6_;
			_tmp5_ = propertyItem;
			_tmp6_ = (IS_PROPERTY_ITEM_DOUBLE (_tmp5_) ? ((PropertyItemDouble*) _tmp5_) : NULL)->data;
			result = _tmp6_;
...
static void property_item_double_real_read_widget (PropertyItem* base, GtkWidget* propertyWidget) {
	...
	if (_tmp0_ != NULL) {
		...
		if (GTK_IS_SPIN_BUTTON (_tmp1_)) {
			GtkWidget* _tmp2_;
			gdouble _tmp3_ = 0.0;
			_tmp2_ = propertyWidget;
			_tmp3_ = gtk_spin_button_get_value (GTK_IS_SPIN_BUTTON (_tmp2_) ? ((GtkSpinButton*) _tmp2_) : NULL);
			self->data = _tmp3_;
		}
	}
}
