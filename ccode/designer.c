...
static void _vala_array_add49 (WireInst*** array, int* length, int* size, WireInst* value);
static void _vala_array_add50 (WireInst*** array, int* length, int* size, WireInst* value);
...
gint designer_bind_wire (Designer* self, gint x, gint y) {
		...
		for (wireInst_it = 0; wireInst_it < _tmp3__length1; wireInst_it = wireInst_it + 1) {
			...
			wireInst = _tmp4_;
			{
				...
				if (_tmp10_) {
					...
					_vala_array_add47 (&wireInsts, &wireInsts_length1, &_wireInsts_size_, _tmp16_);
				}
				_wire_inst_unref0 (wireInst);
			}
		}
	...
	if (_tmp24_) {
		...
		_vala_array_add48 (&wireInsts, &wireInsts_length1, &_wireInsts_size_, _tmp27_);
	}
		...
		for (wireInst_it = 0; wireInst_it < _tmp2__length1; wireInst_it = wireInst_it + 1) {
			...
			wireInst = _tmp3_;
			{
				...
				if (_tmp9_) {
					...
					_tmp15__length1 = addWireInsts_length1;
					{
						...
						for (addWireInst_it = 0; addWireInst_it < _tmp15__length1; addWireInst_it = addWireInst_it + 1) {
							...
							addWireInst = _tmp16_;
							{
								...
								_vala_array_add49 (&wireInsts, &wireInsts_length1, &_wireInsts_size_, _tmp19_);
					...
					_vala_array_add50 (&wireInsts, &wireInsts_length1, &_wireInsts_size_, _tmp22_);
				}
				_wire_inst_unref0 (wireInst);
			}
		}
