/* componentinst.c generated by valac 0.16.0, the Vala compiler
...
static PinInst** _vala_array_dup16 (PinInst** self, int length);
...
static PinInst** _vala_array_dup17 (PinInst** self, int length);
...
ComponentInst* component_inst_construct (GType object_type, ComponentDef* componentDef, gint xPosition, gint yPosition, Direction direction, gboolean flipped) {
	...
	_tmp15__length1 = _tmp14_->pinDefs_length1;
	{
		...
		for (pinDef_it = 0; pinDef_it < _tmp15__length1; pinDef_it = pinDef_it + 1) {
			...
			pinDef = _tmp16_;
			{
				...
				_vala_array_add40 (&newPinInsts, &newPinInsts_length1, &_newPinInsts_size_, _tmp27_);
				_pin_inst_unref0 (newPinInst);
	...
	_tmp29_ = (_tmp28_ != NULL) ? _vala_array_dup16 (_tmp28_, _tmp28__length1) : ((gpointer) _tmp28_);
...
ComponentInst* component_inst_construct_load (GType object_type, xmlNode* xmlnode, Project* project, WireInst** newWireInsts, int newWireInsts_length1, GError** error) {
	...
	if (_tmp45_) {
		...
		_tmp48__length1 = _tmp47_->pinDefs_length1;
		{
			...
			for (pinDef_it = 0; pinDef_it < _tmp48__length1; pinDef_it = pinDef_it + 1) {
				...
				pinDef = _tmp49_;
				{
					...
					_vala_array_add41 (&newPinInsts, &newPinInsts_length1, &_newPinInsts_size_, _tmp60_);
					_pin_inst_unref0 (newPinInst);
					_pin_def_unref0 (pinDef);
				}
			}
		...
		_tmp62_ = (_tmp61_ != NULL) ? _vala_array_dup17 (_tmp61_, _tmp61__length1) : ((gpointer) _tmp61_);
					...
					i = 0;
					{
						...
						while (TRUE) {
							...
							if (_tmp14_ == NULL) {
								...
								_vala_array_add42 (&connections, &connections_length1, &_connections_size_, _tmp16_);
								_wire_inst_unref0 (wireInst);
								continue;
							}
								...
								for (wireState_it = 0; wireState_it < _tmp17__length1; wireState_it = wireState_it + 1) {
									...
									wireState = _tmp18_;
									{
										...
										if (_tmp20_ == _tmp21_) {
											...
											_vala_array_add43 (&connections, &connections_length1, &_connections_size_, _tmp28_);
										}
