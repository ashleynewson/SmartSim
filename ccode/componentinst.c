/* componentinst.c generated by valac 0.20.1, the Vala compiler
...
static void _vala_array_add43 (PinInst*** array, int* length, int* size, PinInst* value);
...
static void _vala_array_add44 (PinInst*** array, int* length, int* size, PinInst* value);
...
static void _vala_array_add45 (Connection*** array, int* length, int* size, Connection* value);
...
static void _vala_array_add46 (Connection*** array, int* length, int* size, Connection* value);
	...
	_tmp15__length1 = _tmp14_->pinDefs_length1;
	{
		...
		for (pinDef_it = 0; pinDef_it < _tmp15__length1; pinDef_it = pinDef_it + 1) {
			...
			pinDef = _tmp16_;
			{
				...
				_vala_array_add43 (&newPinInsts, &newPinInsts_length1, &_newPinInsts_size_, _tmp27_);
				_pin_inst_unref0 (newPinInst);
		...
		_tmp48__length1 = _tmp47_->pinDefs_length1;
		{
			...
			for (pinDef_it = 0; pinDef_it < _tmp48__length1; pinDef_it = pinDef_it + 1) {
				...
				pinDef = _tmp49_;
				{
					...
					_vala_array_add44 (&newPinInsts, &newPinInsts_length1, &_newPinInsts_size_, _tmp60_);
					_pin_inst_unref0 (newPinInst);
					_pin_def_unref0 (pinDef);
				}
			}
					...
					i = 0;
					{
						...
						while (TRUE) {
							...
							if (_tmp14_ == NULL) {
								...
								_vala_array_add45 (&connections, &connections_length1, &_connections_size_, _tmp16_);
								_wire_inst_unref0 (wireInst);
								continue;
							}
								...
								for (wireState_it = 0; wireState_it < _tmp17__length1; wireState_it = wireState_it + 1) {
									...
									wireState = _tmp18_;
									{
										...
										if (_tmp20_ == _tmp21_) {
											...
											_vala_array_add46 (&connections, &connections_length1, &_connections_size_, _tmp28_);
										}
