...
static void plugin_component_manager_register (PluginComponentManager* pluginComponentManager) {
	...
	_vala_array_add66 (&plugin_component_manager_pluginComponentManagers, &plugin_component_manager_pluginComponentManagers_length1, &_plugin_component_manager_pluginComponentManagers_size_, _tmp3_);
	_tmp4_ = stdout;
